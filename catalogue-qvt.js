...
(function () {
  ...
  "rps-signaux-faibles": {
    0: [
      {
        type: "choix",
        text: "Votre collègue Lucas, habituellement bavard et réactif, répond à vos messages avec de courts 'ok' depuis une semaine. Ses livrables arrivent à temps.",
        tags: ["signaux faibles", "observation"],
        answers: [
          { text: "Je laisse — tant que le travail est rendu, c'est son affaire.", score: 0 },
          { text: "Je crée une occasion informelle d'échanger pour voir si quelque chose se passe.", score: 2 },
          { text: "Je lui demande directement si tout va bien lors de notre prochain échange.", score: 1.5 },
          { text: "J'attends encore une semaine pour voir si c'est passager.", score: 0.5 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous attendez que les signaux soient évidents avant d'agir", resume: "Votre vigilance se déclenche quand les difficultés sont visibles — les signaux précoces, discrets et progressifs passent encore sans réaction.", desc: "Votre réaction aux signaux de difficulté — chez vous ou chez vos collègues — existe quand la situation est évidente. Ce qui pourrait encore manquer, c'est la vigilance sur les changements discrets et progressifs : le collègue qui se retire légèrement, la légère variation de comportement, vos propres signaux minimisés au nom de 'la période'. Ces signaux précoces sont les plus précieux parce qu'ils permettent d'agir avant que la situation ne soit difficile à inverser." },
          moyen: { label: "Pratiques en développement", titre: "Vous repérez les signaux nets, les changements discrets vous échappent encore", resume: "Vous réagissez aux signaux visibles — les changements progressifs et subtils créent encore des angles morts dans votre vigilance.", desc: "Vous intervenez quand les signaux sont visibles et vous prenez l'initiative d'échanges réguliers. Ce qui pourrait encore vous échapper, c'est le changement progressif et discret — un ton légèrement différent, une participation qui diminue imperceptiblement, vos propres signaux d'alerte attribués au contexte. L'enjeu est d'abaisser votre seuil de vigilance sans tomber dans la surveillance excessive." },
          haut: { label: "Réflexes installés", titre: "Vous créez les occasions pour que les signaux remontent avant qu'ils soient évidents.", resume: "Vous ne vous contentez pas d'observer — vous créez activement les conditions pour détecter les signaux faibles, chez vous comme chez vos collègues.", desc: "Vous créez des occasions d'échange régulières qui permettent aux signaux de remonter. Vous prenez au sérieux les changements discrets, chez vos collègues comme chez vous. Vous ne normalisez pas un stress permanent au motif que tout le monde l'absorbe. Cette vigilance proactive — qui suppose d'aller vers les signaux plutôt d'attendre qu'ils s'imposent — est ce qui permet d'agir quand les situations sont encore simples." },
        },
      },
      {
        type: "choix",
        text: "Toute votre équipe est sous pression depuis un mois. Sofia semble plus affectée que les autres, mais quand vous en parlez à un collègue, il vous répond que 'tout le monde est dans le même état'.",
        tags: ["signaux faibles", "collectif"],
        answers: [
          { text: "Je m'aligne sur cette lecture — si les autres ne s'inquiètent pas, c'est probablement gérable.", score: 0 },
          { text: "Je reste attentif à Sofia indépendamment de ce que vivent les autres.", score: 2 },
          { text: "J'en parle à mon manager pour avoir un avis extérieur.", score: 1 },
          { text: "Je lui allège discrètement sa charge sans lui en parler.", score: 1 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous attendez que les signaux soient évidents avant d'agir", resume: "Votre vigilance se déclenche quand les difficultés sont visibles — les signaux précoces, discrets et progressifs passent encore sans réaction.", desc: "Votre réaction aux signaux de difficulté — chez vous ou chez vos collègues — existe quand la situation est évidente. Ce qui pourrait encore manquer, c'est la vigilance sur les changements discrets et progressifs : le collègue qui se retire légèrement, la légère variation de comportement, vos propres signaux minimisés au nom de 'la période'. Ces signaux précoces sont les plus précieux parce qu'ils permettent d'agir avant que la situation ne soit difficile à inverser." },
          moyen: { label: "Pratiques en développement", titre: "Vous repérez les signaux nets, les changements discrets vous échappent encore", resume: "Vous réagissez aux signaux visibles — les changements progressifs et subtils créent encore des angles morts dans votre vigilance.", desc: "Vous intervenez quand les signaux sont visibles et vous prenez l'initiative d'échanges réguliers. Ce qui pourrait encore vous échapper, c'est le changement progressif et discret — un ton légèrement différent, une participation qui diminue imperceptiblement, vos propres signaux d'alerte attribués au contexte. L'enjeu est d'abaisser votre seuil de vigilance sans tomber dans la surveillance excessive." },
      ...
      {
        type: "likert",
        text: "Vous observez le comportement de vos collègues au-delà des livrables — participation, énergie, qualité des échanges — lors de vos interactions quotidiennes.",
      ...
      {
        type: "choix",
        text: "Vous demandez à Karim comment il va lors d'un échange. Il répond 'très bien' mais son ton est plat, il a raccourci l'échange. C'est inhabituel.",
        tags: ["signaux faibles", "déni"],
        answers: [
          { text: "Je le crois — s'il dit que ça va, je respecte ça.", score: 0 },
          { text: "Je lui dis ce que j'ai observé dans cet échange et je lui laisse la porte ouverte.", score: 2 },
          { text: "Je lui repose la question différemment lors du prochain échange.", score: 1 },
          { text: "J'en parle à un collègue proche de lui pour avoir un autre éclairage.", score: 0.5 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous attendez que les signaux soient évidents avant d'agir", resume: "Votre vigilance se déclenche quand les difficultés sont visibles — les signaux précoces, discrets et progressifs passent encore sans réaction.", desc: "Votre réaction aux signaux de difficulté — chez vous ou chez vos collègues — existe quand la situation est évidente. Ce qui pourrait encore manquer, c'est la vigilance sur les changements discrets et progressifs : le collègue qui se retire légèrement, la légère variation de comportement, vos propres signaux minimisés au nom de 'la période'. Ces signaux précoces sont les plus précieux parce qu'ils permettent d'agir avant que la situation ne soit difficile à inverser." },
          moyen: { label: "Pratiques en développement", titre: "Vous repérez les signaux nets, les changements discrets vous échappent encore", resume: "Vous réagissez aux signaux visibles — les changements progressifs et subtils créent encore des angles morts dans votre vigilance.", desc: "Vous intervenez quand les signaux sont visibles et vous prenez l'initiative d'échanges réguliers. Ce qui pourrait encore vous échapper, c'est le changement progressif et discret — un ton légèrement différent, une participation qui diminue imperceptiblement, vos propres signaux d'alerte attribués au contexte. L'enjeu est d'abaisser votre seuil de vigilance sans tomber dans la surveillance excessive." },
      ...
      {
        type: "choix",
        text: "Une collègue a pris trois arrêts courts en six semaines. À chaque retour, elle dit que tout va bien. Ses livrables sont rendus dans les délais.",
        ...
        answers: [
          ...
          { text: "Je crée une occasion d'échange à son retour, même courte, pour maintenir le contact.", score: 2 },
          { text: "Je note la tendance et en parle à mon manager si ça continue.", score: 0.5 },
      ...
      {
        type: "likert",
        text: "Vous faites la différence entre une mauvaise journée et un changement qui s'installe dans la durée chez l'un de vos collègues.",
      ...
      {
        type: "choix",
        text: "Dans votre équipe, un certain niveau de stress permanent est devenu la norme. Personne ne le questionne.",
        tags: ["signaux faibles", "normes"],
        answers: [
          { text: "Je laisse — si tout le monde fonctionne ainsi, c'est que c'est gérable.", score: 0 },
          { text: "Je reste attentif aux variations individuelles même si la norme collective est haute.", score: 2 },
          { text: "J'en parle à mon manager pour qu'il adresse le sujet.", score: 1 },
          { text: "Je m'adapte à la norme tout en préservant mes propres limites.", score: 1 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous attendez que les signaux soient évidents avant d'agir", resume: "Votre vigilance se déclenche quand les difficultés sont visibles — les signaux précoces, discrets et progressifs passent encore sans réaction.", desc: "Votre réaction aux signaux de difficulté — chez vous ou chez vos collègues — existe quand la situation est évidente. Ce qui pourrait encore manquer, c'est la vigilance sur les changements discrets et progressifs : le collègue qui se retire légèrement, la légère variation de comportement, vos propres signaux minimisés au nom de 'la période'. Ces signaux précoces sont les plus précieux parce qu'ils permettent d'agir avant que la situation ne soit difficile à inverser." },
          moyen: { label: "Pratiques en développement", titre: "Vous repérez les signaux nets, les changements discrets vous échappent encore", resume: "Vous réagissez aux signaux visibles — les changements progressifs et subtils créent encore des angles morts dans votre vigilance.", desc: "Vous intervenez quand les signaux sont visibles et vous prenez l'initiative d'échanges réguliers. Ce qui pourrait encore vous échapper, c'est le changement progressif et discret — un ton légèrement différent, une participation qui diminue imperceptiblement, vos propres signaux d'alerte attribués au contexte. L'enjeu est d'abaisser votre seuil de vigilance sans tomber dans la surveillance excessive." },
      ...
      {
        type: "choix",
        text: "Rayan participe de moins en moins aux échanges informels de l'équipe. Il est présent mais à l'écart. Personne ne semble le remarquer.",
        tags: ["signaux faibles", "isolement"],
        answers: [
          { text: "Je laisse — il a peut-être besoin de calme.", score: 0 },
          { text: "Je crée une occasion de lui parler seul à seul pour vérifier que tout va bien.", score: 2 },
          { text: "Je le réintègre naturellement dans les échanges collectifs.", score: 1.5 },
          { text: "J'en parle à notre manager commun.", score: 1 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous attendez que les signaux soient évidents avant d'agir", resume: "Votre vigilance se déclenche quand les difficultés sont visibles — les signaux précoces, discrets et progressifs passent encore sans réaction.", desc: "Votre réaction aux signaux de difficulté — chez vous ou chez vos collègues — existe quand la situation est évidente. Ce qui pourrait encore manquer, c'est la vigilance sur les changements discrets et progressifs : le collègue qui se retire légèrement, la légère variation de comportement, vos propres signaux minimisés au nom de 'la période'. Ces signaux précoces sont les plus précieux parce qu'ils permettent d'agir avant que la situation ne soit difficile à inverser." },
          moyen: { label: "Pratiques en développement", titre: "Vous repérez les signaux nets, les changements discrets vous échappent encore", resume: "Vous réagissez aux signaux visibles — les changements progressifs et subtils créent encore des angles morts dans votre vigilance.", desc: "Vous intervenez quand les signaux sont visibles et vous prenez l'initiative d'échanges réguliers. Ce qui pourrait encore vous échapper, c'est le changement progressif et discret — un ton légèrement différent, une participation qui diminue imperceptiblement, vos propres signaux d'alerte attribués au contexte. L'enjeu est d'abaisser votre seuil de vigilance sans tomber dans la surveillance excessive." },
      ...
      {
        type: "likert",
        text: "Vous prenez l'initiative de créer des occasions d'échange avec vos collègues, sans attendre qu'ils viennent vous voir.",
        tags: ["signaux faibles", "proactivité"],
        answers: [
          { text: "Jamais", score: 0 },
          { text: "Rarement", score: 0.5 },
          { text: "Parfois", score: 1 },
      ...
      {
        type: "choix",
        text: "Vous remarquez que vous-même êtes moins disponible, plus irritable et dormez moins bien depuis deux semaines. Vous l'attribuez à la charge du moment.",
        tags: ["signaux faibles", "soi-même"],
        answers: [
          { text: "Je laisse — c'est la période, ça va passer.", score: 0 },
          { text: "Je prends ces signaux au sérieux et j'identifie ce qui peut être ajusté.", score: 2 },
          { text: "Je compense en organisant mieux mon temps.", score: 1 },
          { text: "J'en parle à mon manager ou à un proche pour avoir un regard extérieur.", score: 1.5 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous attendez que les signaux soient évidents avant d'agir", resume: "Votre vigilance se déclenche quand les difficultés sont visibles — les signaux précoces, discrets et progressifs passent encore sans réaction.", desc: "Votre réaction aux signaux de difficulté — chez vous ou chez vos collègues — existe quand la situation est évidente. Ce qui pourrait encore manquer, c'est la vigilance sur les changements discrets et progressifs : le collègue qui se retire légèrement, la légère variation de comportement, vos propres signaux minimisés au nom de 'la période'. Ces signaux précoces sont les plus précieux parce qu'ils permettent d'agir avant que la situation ne soit difficile à inverser." },
          moyen: { label: "Pratiques en développement", titre: "Vous repérez les signaux nets, les changements discrets vous échappent encore", resume: "Vous réagissez aux signaux visibles — les changements progressifs et subtils créent encore des angles morts dans votre vigilance.", desc: "Vous intervenez quand les signaux sont visibles et vous prenez l'initiative d'échanges réguliers. Ce qui pourrait encore vous échapper, c'est le changement progressif et discret — un ton légèrement différent, une participation qui diminue imperceptiblement, vos propres signaux d'alerte attribués au contexte. L'enjeu est d'abaisser votre seuil de vigilance sans tomber dans la surveillance excessive." },
    ...
    1: [
      {
        type: "choix",
        text: "Vous avez cinq tâches urgentes à traiter aujourd'hui. Votre journée ne peut en absorber que trois correctement.",
        tags: ["charge", "priorisation"],
        answers: [
          { text: "Je traite tout dans l'ordre d'arrivée, quitte à faire du travail bâclé.", score: 0 },
          { text: "Je hiérarchise en qualifiant vraiment l'urgence de chaque demande avant de commencer.", score: 2 },
          { text: "Je traite les trois plus importantes et je préviens pour les deux autres.", score: 2 },
          { text: "Je reste plus longtemps pour tout finir.", score: 0 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous absorbez la surcharge sans la rendre visible ni réguler", resume: "Votre réflexe est encore d'absorber la surcharge seul·e plutôt que de la qualifier, la signaler ou la négocier.", desc: "Votre gestion de la charge pourrait encore reposer sur l'absorption — traiter dans l'ordre d'arrivée, rester plus longtemps, différer les congés, accepter des engagements que votre agenda ne peut pas tenir. Ces comportements semblent nécessaires dans l'urgence mais créent progressivement des conditions d'épuisement. Qualifier les urgences, signaler la surcharge et négocier les délais sur les faits sont les réflexes qui font la différence." },
          moyen: { label: "Pratiques en développement", titre: "Vous réglez les pics, les mécanismes profonds de la surcharge restent encore en place", resume: "Vous signalez les surcharges aigues et prenez des pauses — les tensions structurelles et les engagements difficiles à tenir créent encore des compromis silencieux.", desc: "Vous prenez des pauses, vous signalez les surcharges quand elles sont aigues, vous négociez des délais dans les situations raisonnables. Ce qui pourrait encore créer des compromis silencieux, c'est la surcharge plus lente et plus structurelle — les engagements pris par crainte de décevoir, les priorités contradictoires gérées seul·e, les délais annoncés qui ne tiendront pas. Ces tensions structurelles ont besoin d'être rendues visibles pour être traitées." },
          haut: { label: "Réflexes installés", titre: "Vous hiérarchisez activement votre charge et vous la rendez visible avant d'être à bout", resume: "Vous qualifiez les urgences, négociez sur les faits et signalez les contradictions — votre charge est pilotée plutôt que subie.", desc: "Vous qualifiez les urgences avant de les traiter. Vous annoncez des délais réalistes et vous les renégociez quand les conditions changent. Vous signalez votre surcharge à votre manager ou à votre équipe avec des éléments factuels. Vous prenez vos congés même quand le contexte n'est pas idéal. Cette régulation active — qui suppose d'accepter de ne pas tout absorber — est ce qui protège votre énergie dans la durée." },
        },
      },
      {
        type: "choix",
        text: "Vous êtes en surcharge depuis deux semaines. Vous pourriez demander du soutien à votre manager mais vous hésitez à le faire.",
        tags: ["charge", "demander de l'aide"],
        answers: [
          { text: "Je gère seul·e — demander de l'aide pourrait être perçu comme un signe de faiblesse.", score: 0 },
          { text: "Je signale ma charge à mon manager avec des éléments factuels.", score: 2 },
          { text: "J'attends de voir si la situation se régule d'elle-même.", score: 0 },
          { text: "Je parle à un collègue de confiance pour trouver comment soulager la situation.", score: 1 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous absorbez la surcharge sans la rendre visible ni réguler", resume: "Votre réflexe est encore d'absorber la surcharge seul·e plutôt que de la qualifier, la signaler ou la négocier.", desc: "Votre gestion de la charge pourrait encore reposer sur l'absorption — traiter dans l'ordre d'arrivée, rester plus longtemps, différer les congés, accepter des engagements que votre agenda ne peut pas tenir. Ces comportements semblent nécessaires dans l'urgence mais créent progressivement des conditions d'épuisement. Qualifier les urgences, signaler la surcharge et négocier les délais sur les faits sont les réflexes qui font la différence." },
          moyen: { label: "Pratiques en développement", titre: "Vous réglez les pics, les mécanismes profonds de la surcharge restent encore en place", resume: "Vous signalez les surcharges aigues et prenez des pauses — les tensions structurelles et les engagements difficiles à tenir créent encore des compromis silencieux.", desc: "Vous prenez des pauses, vous signalez les surcharges quand elles sont aigues, vous négociez des délais dans les situations raisonnables. Ce qui pourrait encore créer des compromis silencieux, c'est la surcharge plus lente et plus structurelle — les engagements pris par crainte de décevoir, les priorités contradictoires gérées seul·e, les délais annoncés qui ne tiendront pas. Ces tensions structurelles ont besoin d'être rendues visibles pour être traitées." },
      ...
      {
        type: "likert",
        text: "Quand votre charge dépasse ce que vous pouvez absorber de façon durable, vous le signalez à votre manager ou à votre équipe.",
      ...
      {
        type: "choix",
        text: "On vous demande de prendre en charge un projet supplémentaire. Votre agenda est déjà plein.",
        tags: ["charge", "engagements"],
        answers: [
          { text: "J'accepte — on trouvera bien comment s'organiser.", score: 0 },
          { text: "Je négocie en rendant visible ma charge actuelle et en demandant un arbitrage.", score: 2 },
          { text: "J'accepte mais je préviens que la qualité pourrait en pâtir.", score: 1 },
      ...
      {
        type: "choix",
        text: "Vous travaillez sans véritable pause depuis une semaine. Vous pensez ne pas pouvoir vous arrêter avant la fin du projet.",
        tags: ["charge", "pauses"],
        answers: [
          { text: "Je continue — le projet est prioritaire, les pauses peuvent attendre.", score: 0 },
          { text: "Je m'impose des pauses même courtes — la qualité de travail en dépend.", score: 2 },
          { text: "Je prends des pauses uniquement si j'ai terminé ce que je devais faire.", score: 0 },
          { text: "Je réduis les pauses sans les supprimer complètement.", score: 1 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous absorbez la surcharge sans la rendre visible ni réguler", resume: "Votre réflexe est encore d'absorber la surcharge seul·e plutôt que de la qualifier, la signaler ou la négocier.", desc: "Votre gestion de la charge pourrait encore reposer sur l'absorption — traiter dans l'ordre d'arrivée, rester plus longtemps, différer les congés, accepter des engagements que votre agenda ne peut pas tenir. Ces comportements semblent nécessaires dans l'urgence mais créent progressivement des conditions d'épuisement. Qualifier les urgences, signaler la surcharge et négocier les délais sur les faits sont les réflexes qui font la différence." },
          moyen: { label: "Pratiques en développement", titre: "Vous réglez les pics, les mécanismes profonds de la surcharge restent encore en place", resume: "Vous signalez les surcharges aigues et prenez des pauses — les tensions structurelles et les engagements difficiles à tenir créent encore des compromis silencieux.", desc: "Vous prenez des pauses, vous signalez les surcharges quand elles sont aigues, vous négociez des délais dans les situations raisonnables. Ce qui pourrait encore créer des compromis silencieux, c'est la surcharge plus lente et plus structurelle — les engagements pris par crainte de décevoir, les priorités contradictoires gérées seul·e, les délais annoncés qui ne tiendront pas. Ces tensions structurelles ont besoin d'être rendues visibles pour être traitées." },
      ...
      {
        type: "likert",
        text: "Vous prenez des pauses régulières même en période de forte charge, en sachant que votre efficacité en dépend.",
        tags: ["charge", "pauses"],
        answers: [
          { text: "Jamais", score: 0 },
          { text: "Rarement", score: 0.5 },
      ...
      {
        type: "choix",
        text: "Un délai que vous avez annoncé ne pourra pas être tenu en raison d'un imprévu. Vous le savez depuis deux jours.",
        tags: ["charge", "délais"],
        answers: [
          { text: "Je rattrape le retard en travaillant plus longtemps pour tenir le délai.", score: 0 },
          { text: "Je préviens dès maintenant avec les éléments factuels et je propose un nouveau délai.", score: 2 },
          { text: "J'attends d'être sûr de ne pas pouvoir tenir avant de prévenir.", score: 0 },
          { text: "Je préviens au dernier moment pour éviter une conversation difficile.", score: 0 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous absorbez la surcharge sans la rendre visible ni réguler", resume: "Votre réflexe est encore d'absorber la surcharge seul·e plutôt que de la qualifier, la signaler ou la négocier.", desc: "Votre gestion de la charge pourrait encore reposer sur l'absorption — traiter dans l'ordre d'arrivée, rester plus longtemps, différer les congés, accepter des engagements que votre agenda ne peut pas tenir. Ces comportements semblent nécessaires dans l'urgence mais créent progressivement des conditions d'épuisement. Qualifier les urgences, signaler la surcharge et négocier les délais sur les faits sont les réflexes qui font la différence." },
          moyen: { label: "Pratiques en développement", titre: "Vous réglez les pics, les mécanismes profonds de la surcharge restent encore en place", resume: "Vous signalez les surcharges aigues et prenez des pauses — les tensions structurelles et les engagements difficiles à tenir créent encore des compromis silencieux.", desc: "Vous prenez des pauses, vous signalez les surcharges quand elles sont aigues, vous négociez des délais dans les situations raisonnables. Ce qui pourrait encore créer des compromis silencieux, c'est la surcharge plus lente et plus structurelle — les engagements pris par crainte de décevoir, les priorités contradictoires gérées seul·e, les délais annoncés qui ne tiendront pas. Ces tensions structurelles ont besoin d'être rendues visibles pour être traitées." },
      ...
      {
        type: "choix",
        text: "Vous avez des congés prévus la semaine prochaine. Le contexte professionnel est tendu et vous envisagez de les décaler.",
        tags: ["charge", "congés"],
        answers: [
          { text: "Je les décale — le contexte ne me permet pas de partir sereinement.", score: 0 },
          { text: "Je pars — mes congés sont nécessaires pour tenir dans la durée.", score: 2 },
          { text: "Je pars mais je reste joignable pour les urgences.", score: 0.5 },
          { text: "Je réduis leur durée pour rester disponible une partie du temps.", score: 0.5 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous absorbez la surcharge sans la rendre visible ni réguler", resume: "Votre réflexe est encore d'absorber la surcharge seul·e plutôt que de la qualifier, la signaler ou la négocier.", desc: "Votre gestion de la charge pourrait encore reposer sur l'absorption — traiter dans l'ordre d'arrivée, rester plus longtemps, différer les congés, accepter des engagements que votre agenda ne peut pas tenir. Ces comportements semblent nécessaires dans l'urgence mais créent progressivement des conditions d'épuisement. Qualifier les urgences, signaler la surcharge et négocier les délais sur les faits sont les réflexes qui font la différence." },
          moyen: { label: "Pratiques en développement", titre: "Vous réglez les pics, les mécanismes profonds de la surcharge restent encore en place", resume: "Vous signalez les surcharges aigues et prenez des pauses — les tensions structurelles et les engagements difficiles à tenir créent encore des compromis silencieux.", desc: "Vous prenez des pauses, vous signalez les surcharges quand elles sont aigues, vous négociez des délais dans les situations raisonnables. Ce qui pourrait encore créer des compromis silencieux, c'est la surcharge plus lente et plus structurelle — les engagements pris par crainte de décevoir, les priorités contradictoires gérées seul·e, les délais annoncés qui ne tiendront pas. Ces tensions structurelles ont besoin d'être rendues visibles pour être traitées." },
      ...
      {
        type: "likert",
        text: "Vous ajustez votre charge avant d'être à bout, sans attendre que la situation soit critique.",
        tags: ["charge", "régulation"],
        answers: [
          { text: "Jamais", score: 0 },
          { text: "Rarement", score: 0.5 },
          { text: "Parfois", score: 1 },
      ...
      {
        type: "choix",
        text: "Deux responsables vous demandent deux choses incompatibles pour la même journée. Vous ne pouvez faire qu'une seule des deux.",
        tags: ["charge", "contradictions"],
        answers: [
          { text: "Je choisis seul·e et j'informe après.", score: 0 },
          { text: "Je rends la contradiction visible aux deux parties pour qu'elles arbitrent.", score: 2 },
          { text: "Je fais les deux à moitié.", score: 0 },
          { text: "Je préviens l'un des deux que je ne pourrai pas tenir.", score: 1 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous absorbez la surcharge sans la rendre visible ni réguler", resume: "Votre réflexe est encore d'absorber la surcharge seul·e plutôt que de la qualifier, la signaler ou la négocier.", desc: "Votre gestion de la charge pourrait encore reposer sur l'absorption — traiter dans l'ordre d'arrivée, rester plus longtemps, différer les congés, accepter des engagements que votre agenda ne peut pas tenir. Ces comportements semblent nécessaires dans l'urgence mais créent progressivement des conditions d'épuisement. Qualifier les urgences, signaler la surcharge et négocier les délais sur les faits sont les réflexes qui font la différence." },
          moyen: { label: "Pratiques en développement", titre: "Vous réglez les pics, les mécanismes profonds de la surcharge restent encore en place", resume: "Vous signalez les surcharges aigues et prenez des pauses — les tensions structurelles et les engagements difficiles à tenir créent encore des compromis silencieux.", desc: "Vous prenez des pauses, vous signalez les surcharges quand elles sont aigues, vous négociez des délais dans les situations raisonnables. Ce qui pourrait encore créer des compromis silencieux, c'est la surcharge plus lente et plus structurelle — les engagements pris par crainte de décevoir, les priorités contradictoires gérées seul·e, les délais annoncés qui ne tiendront pas. Ces tensions structurelles ont besoin d'être rendues visibles pour être traitées." },
    ...
    2: [
      {
        type: "choix",
        text: "Votre collègue Nadia ne répond jamais à vos mails dans les délais. Ça crée régulièrement des blocages. Vous en êtes à la quatrième fois ce mois-ci.",
        tags: ["relations", "irritants"],
        answers: [
          { text: "Je m'adapte en prévoyant plus de délais dans mes demandes.", score: 0.5 },
          { text: "J'en parle directement à Nadia avec des exemples concrets et l'impact sur mon travail.", score: 2 },
          { text: "J'en parle à notre manager commun.", score: 1 },
          { text: "Je laisse — aborder ce sujet créerait des tensions inutiles.", score: 0 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous contournez les irritants plutôt que de les traiter, laissant les tensions s'installer", resume: "Votre réflexe est encore de contourner ou laisser traîner les irritants relationnels plutôt que de les aborder directement.", desc: "Votre gestion des tensions relationnelles pourrait encore passer par l'évitement — s'adapter pour ne plus dépendre de la personne, taire un désaccord en réunion, attendre que la tension se dissipe. Ces stratégies évitent l'inconfort immédiat mais laissent les irritants s'installer progressivement et peser sur la qualité du travail collectif. Traiter tôt et directement — sur les faits — est plus protecteur que d'attendre." },
          moyen: { label: "Pratiques en développement", titre: "Vous traitez les irritants clairement problématiques — les plus discrets s'accumulent encore.", resume: "Vous abordez les tensions clairement problématiques — les irritants discrets et les désaccords sous pression forte créent encore des silences.", desc: "Vous abordez les irritants relationnels quand ils sont clairement problématiques. Vous maintenez la qualité de vos échanges dans la plupart des situations. Ce qui pourrait encore créer des silences, c'est l'irritant discret qui ne semble pas mériter une conversation, le désaccord sous pression forte, la tension que vous attendez de voir se résorber seule. Ces situations non traitées s'installent progressivement et dégradent la qualité des relations dans la durée." },
          haut: { label: "Réflexes installés", titre: "Vous traitez les irritants tôt et directement, et vous réparez quand vous avez mal géré", resume: "Vous abordez ce qui dégrade les relations professionnelles avec les faits, tôt — et vous revenez sur vos propres écarts quand ils se produisent.", desc: "Vous abordez les irritants relationnels directement avec la personne concernée, avec des faits et l'impact concret sur votre travail. Vous exprimez vos désaccords en réunion même quand vous êtes seul·e à le penser. Quand vous avez mal géré un échange sous pression, vous revenez vers la personne pour le reconnaître. Cette combinaison de traitement précoce et de réparation — qui suppose d'accepter l'inconfort d'une conversation directe — est ce qui maintient des relations professionnelles de qualité dans la durée." },
        },
      },
      {
        type: "choix",
        text: "En réunion, une décision est prise à laquelle vous n'adhérez pas. Vous êtes le seul à ne pas être d'accord.",
        tags: ["relations", "désaccord"],
        answers: [
          { text: "Je me tais — si tout le monde est d'accord, je dois probablement manquer quelque chose.", score: 0 },
          { text: "J'exprime mon désaccord clairement, sur les faits, sans chercher à convaincre tout le monde.", score: 2 },
          { text: "J'en parle en coulisses après la réunion à quelqu'un de confiance.", score: 0.5 },
          { text: "Je valide formellement mais je reviens sur le sujet lors du prochain échange.", score: 1 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous contournez les irritants plutôt que de les traiter, laissant les tensions s'installer", resume: "Votre réflexe est encore de contourner ou laisser traîner les irritants relationnels plutôt que de les aborder directement.", desc: "Votre gestion des tensions relationnelles pourrait encore passer par l'évitement — s'adapter pour ne plus dépendre de la personne, taire un désaccord en réunion, attendre que la tension se dissipe. Ces stratégies évitent l'inconfort immédiat mais laissent les irritants s'installer progressivement et peser sur la qualité du travail collectif. Traiter tôt et directement — sur les faits — est plus protecteur que d'attendre." },
          moyen: { label: "Pratiques en développement", titre: "Vous traitez les irritants clairement problématiques — les plus discrets s'accumulent encore.", resume: "Vous abordez les tensions clairement problématiques — les irritants discrets et les désaccords sous pression forte créent encore des silences.", desc: "Vous abordez les irritants relationnels quand ils sont clairement problématiques. Vous maintenez la qualité de vos échanges dans la plupart des situations. Ce qui pourrait encore créer des silences, c'est l'irritant discret qui ne semble pas mériter une conversation, le désaccord sous pression forte, la tension que vous attendez de voir se résorber seule. Ces situations non traitées s'installent progressivement et dégradent la qualité des relations dans la durée." },
      ...
      {
        type: "likert",
        text: "Vous exprimez vos désaccords directement à la personne concernée, avec des faits, plutôt que de les laisser traîner.",
        tags: ["relations", "directness"],
        answers: [
          { text: "Jamais", score: 0 },
          { text: "Rarement", score: 0.5 },
          { text: "Parfois", score: 1 },
      ...
      {
        type: "choix",
        text: "Une tension persiste entre vous et un collègue depuis deux semaines. Personne n'a rien dit. Le malaise est palpable.",
        tags: ["relations", "tension"],
        answers: [
          { text: "J'attends que ça se dissipe — les tensions finissent généralement par passer.", score: 0 },
          { text: "Je prends l'initiative d'un échange en tête-à-tête pour nommer ce que j'ai observé.", score: 2 },
          { text: "Je m'en accommode et je limite nos interactions au strict professionnel.", score: 0 },
          { text: "J'en parle à un tiers de confiance pour voir comment l'aborder.", score: 1 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous contournez les irritants plutôt que de les traiter, laissant les tensions s'installer", resume: "Votre réflexe est encore de contourner ou laisser traîner les irritants relationnels plutôt que de les aborder directement.", desc: "Votre gestion des tensions relationnelles pourrait encore passer par l'évitement — s'adapter pour ne plus dépendre de la personne, taire un désaccord en réunion, attendre que la tension se dissipe. Ces stratégies évitent l'inconfort immédiat mais laissent les irritants s'installer progressivement et peser sur la qualité du travail collectif. Traiter tôt et directement — sur les faits — est plus protecteur que d'attendre." },
          moyen: { label: "Pratiques en développement", titre: "Vous traitez les irritants clairement problématiques — les plus discrets s'accumulent encore.", resume: "Vous abordez les tensions clairement problématiques — les irritants discrets et les désaccords sous pression forte créent encore des silences.", desc: "Vous abordez les irritants relationnels quand ils sont clairement problématiques. Vous maintenez la qualité de vos échanges dans la plupart des situations. Ce qui pourrait encore créer des silences, c'est l'irritant discret qui ne semble pas mériter une conversation, le désaccord sous pression forte, la tension que vous attendez de voir se résorber seule. Ces situations non traitées s'installent progressivement et dégradent la qualité des relations dans la durée." },
      ...
      {
        type: "choix",
        text: "Sous forte pression, vous avez répondu de façon sèche à un collègue. Vous le réalisez après coup.",
        tags: ["relations", "pression"],
        answers: [
          { text: "Je laisse — tout le monde fait des écarts sous pression, il comprendra.", score: 0 },
          { text: "Je reviens vers lui pour reconnaître l'écart et réparer.", score: 2 },
          { text: "Je suis plus agréable au prochain échange sans revenir sur l'incident.", score: 0.5 },
          { text: "Je lui explique que j'étais sous pression pour contextualiser ma réaction.", score: 1 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous contournez les irritants plutôt que de les traiter, laissant les tensions s'installer", resume: "Votre réflexe est encore de contourner ou laisser traîner les irritants relationnels plutôt que de les aborder directement.", desc: "Votre gestion des tensions relationnelles pourrait encore passer par l'évitement — s'adapter pour ne plus dépendre de la personne, taire un désaccord en réunion, attendre que la tension se dissipe. Ces stratégies évitent l'inconfort immédiat mais laissent les irritants s'installer progressivement et peser sur la qualité du travail collectif. Traiter tôt et directement — sur les faits — est plus protecteur que d'attendre." },
          moyen: { label: "Pratiques en développement", titre: "Vous traitez les irritants clairement problématiques — les plus discrets s'accumulent encore.", resume: "Vous abordez les tensions clairement problématiques — les irritants discrets et les désaccords sous pression forte créent encore des silences.", desc: "Vous abordez les irritants relationnels quand ils sont clairement problématiques. Vous maintenez la qualité de vos échanges dans la plupart des situations. Ce qui pourrait encore créer des silences, c'est l'irritant discret qui ne semble pas mériter une conversation, le désaccord sous pression forte, la tension que vous attendez de voir se résorber seule. Ces situations non traitées s'installent progressivement et dégradent la qualité des relations dans la durée." },
      ...
      {
        type: "likert",
        text: "Quand vous avez mal géré un échange sous pression, vous revenez vers la personne pour le reconnaître.",
        tags: ["relations", "réparation"],
        answers: [
          { text: "Jamais", score: 0 },
          { text: "Rarement", score: 0.5 },
          { text: "Parfois", score: 1 },
      ...
      {
        type: "choix",
        text: "Un collègue d'une autre équipe vous demande de l'aide sur quelque chose qui n'est pas dans vos attributions mais où vous pourriez contribuer.",
        tags: ["relations", "coopération"],
        answers: [
          { text: "Je refuse poliment — c'est hors de mon périmètre.", score: 0 },
          { text: "Je l'aide si ça ne compromet pas mes propres priorités.", score: 2 },
          { text: "J'aide sans condition — la solidarité est importante.", score: 1 },
          { text: "J'oriente vers la bonne personne si je ne peux pas aider moi-même.", score: 1.5 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous contournez les irritants plutôt que de les traiter, laissant les tensions s'installer", resume: "Votre réflexe est encore de contourner ou laisser traîner les irritants relationnels plutôt que de les aborder directement.", desc: "Votre gestion des tensions relationnelles pourrait encore passer par l'évitement — s'adapter pour ne plus dépendre de la personne, taire un désaccord en réunion, attendre que la tension se dissipe. Ces stratégies évitent l'inconfort immédiat mais laissent les irritants s'installer progressivement et peser sur la qualité du travail collectif. Traiter tôt et directement — sur les faits — est plus protecteur que d'attendre." },
          moyen: { label: "Pratiques en développement", titre: "Vous traitez les irritants clairement problématiques — les plus discrets s'accumulent encore.", resume: "Vous abordez les tensions clairement problématiques — les irritants discrets et les désaccords sous pression forte créent encore des silences.", desc: "Vous abordez les irritants relationnels quand ils sont clairement problématiques. Vous maintenez la qualité de vos échanges dans la plupart des situations. Ce qui pourrait encore créer des silences, c'est l'irritant discret qui ne semble pas mériter une conversation, le désaccord sous pression forte, la tension que vous attendez de voir se résorber seule. Ces situations non traitées s'installent progressivement et dégradent la qualité des relations dans la durée." },
      ...
      {
        type: "choix",
        text: "Un collègue vous demande un retour honnête sur son travail. La vérité risque de l'affecter.",
        tags: ["relations", "feedback"],
        answers: [
          { text: "Je lui dis ce qu'il veut entendre pour ménager sa sensibilité.", score: 0 },
          { text: "Je lui donne un retour honnête sur les faits, avec bienveillance.", score: 2 },
          { text: "Je lui donne un retour partiel en insistant sur les points positifs.", score: 0.5 },
          { text: "Je lui dis que ce n'est pas mon rôle de lui donner ce type de retour.", score: 0 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous contournez les irritants plutôt que de les traiter, laissant les tensions s'installer", resume: "Votre réflexe est encore de contourner ou laisser traîner les irritants relationnels plutôt que de les aborder directement.", desc: "Votre gestion des tensions relationnelles pourrait encore passer par l'évitement — s'adapter pour ne plus dépendre de la personne, taire un désaccord en réunion, attendre que la tension se dissipe. Ces stratégies évitent l'inconfort immédiat mais laissent les irritants s'installer progressivement et peser sur la qualité du travail collectif. Traiter tôt et directement — sur les faits — est plus protecteur que d'attendre." },
          moyen: { label: "Pratiques en développement", titre: "Vous traitez les irritants clairement problématiques — les plus discrets s'accumulent encore.", resume: "Vous abordez les tensions clairement problématiques — les irritants discrets et les désaccords sous pression forte créent encore des silences.", desc: "Vous abordez les irritants relationnels quand ils sont clairement problématiques. Vous maintenez la qualité de vos échanges dans la plupart des situations. Ce qui pourrait encore créer des silences, c'est l'irritant discret qui ne semble pas mériter une conversation, le désaccord sous pression forte, la tension que vous attendez de voir se résorber seule. Ces situations non traitées s'installent progressivement et dégradent la qualité des relations dans la durée." },
      ...
      {
        type: "likert",
        text: "Vous maintenez la qualité de vos échanges même dans les périodes de forte pression.",
        tags: ["relations", "qualité"],
        answers: [
          { text: "Jamais", score: 0 },
          { text: "Rarement", score: 0.5 },
          { text: "Parfois", score: 1 },
      ...
      {
        type: "choix",
        text: "Vous comprenez qu'un malentendu avec un collègue dure depuis plusieurs semaines à cause d'une information mal transmise.",
        tags: ["relations", "malentendu"],
        answers: [
          { text: "Je laisse se résorber — les malentendus finissent par se clarifier.", score: 0 },
          { text: "Je prends l'initiative de clarifier directement avec lui.", score: 2 },
          { text: "J'envoie un email de clarification pour garder une trace.", score: 1 },
          { text: "J'en parle à notre manager pour qu'il facilite la clarification.", score: 0.5 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous contournez les irritants plutôt que de les traiter, laissant les tensions s'installer", resume: "Votre réflexe est encore de contourner ou laisser traîner les irritants relationnels plutôt que de les aborder directement.", desc: "Votre gestion des tensions relationnelles pourrait encore passer par l'évitement — s'adapter pour ne plus dépendre de la personne, taire un désaccord en réunion, attendre que la tension se dissipe. Ces stratégies évitent l'inconfort immédiat mais laissent les irritants s'installer progressivement et peser sur la qualité du travail collectif. Traiter tôt et directement — sur les faits — est plus protecteur que d'attendre." },
          moyen: { label: "Pratiques en développement", titre: "Vous traitez les irritants clairement problématiques — les plus discrets s'accumulent encore.", resume: "Vous abordez les tensions clairement problématiques — les irritants discrets et les désaccords sous pression forte créent encore des silences.", desc: "Vous abordez les irritants relationnels quand ils sont clairement problématiques. Vous maintenez la qualité de vos échanges dans la plupart des situations. Ce qui pourrait encore créer des silences, c'est l'irritant discret qui ne semble pas mériter une conversation, le désaccord sous pression forte, la tension que vous attendez de voir se résorber seule. Ces situations non traitées s'installent progressivement et dégradent la qualité des relations dans la durée." },
    ...
    3: [
      {
        type: "choix",
        text: "Vous traversez une période difficile au travail. Votre manager vous a demandé comment vous alliez, mais vous avez répondu que tout allait bien.",
        tags: ["relais", "orientation"],
        answers: [
          { text: "Je laisse — gérer seul·e est plus simple et je ne veux pas inquiéter.", score: 0 },
          { text: "Je reviens vers mon manager pour être honnête sur ce que je vis.", score: 2 },
          { text: "J'en parle à un collègue de confiance plutôt qu'à mon manager.", score: 1 },
          { text: "Je consulte le service de santé au travail.", score: 1.5 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous gérez seul·e et n'orientez que tardivement, pour vous comme pour vos collègues", resume: "Votre réflexe est encore de gérer seul·e les difficultés sans chercher de relais — pour vous-même comme pour vos collègues en difficulté.", desc: "Votre réflexe pourrait encore être de ne pas chercher de relais — par crainte d'être perçu·e comme quelqu'un qui ne tient pas, par méconnaissance des ressources disponibles, ou parce que 'ce n'est pas encore assez grave'. Ces comportements font que les difficultés se prolongent inutilement. Les relais disponibles — médecin du travail, RH, manager, pair — existent précisément pour être mobilisés avant la crise, pas après." },
          moyen: { label: "Pratiques en développement", titre: "Vous connaissez les relais et les mobilisez dans les cas évidents — la mobilisation précoce est encore insuffisante", resume: "Vous orientez vous-même et vos collègues dans les situations claires — vous attendez encore que les difficultés soient sérieuses avant de chercher de l'aide.", desc: "Vous connaissez les relais disponibles et vous les mobilisez dans les situations clairement sérieuses. Ce qui pourrait encore manquer, c'est la mobilisation précoce — chercher un appui avant d'être en crise, orienter un collègue avant que la situation soit visible de tous, faire un suivi après une orientation pour vérifier qu'elle a abouti. Ces réflexes précoces font que l'aide arrive quand elle est encore efficace." },
          haut: { label: "Réflexes installés", titre: "Vous mobilisez les relais tôt — pour vous-même et pour vos collègues — et vous faites le suivi", resume: "Vous cherchez de l'aide avant d'être en crise, vous orientez vos collègues tôt et vous vérifiez que l'orientation a abouti.", desc: "Vous vous renseignez sur les ressources disponibles avant d'en avoir besoin. Vous cherchez un appui pour vous-même avant d'être en crise. Vous orientez vos collègues en difficulté vers les relais adaptés sans attendre que la situation soit évidente. Vous faites un suivi après une orientation pour vérifier qu'elle a abouti. Cette mobilisation précoce et active — qui suppose d'accepter que chercher de l'aide est un réflexe de santé, pas de faiblesse — est ce qui protège dans la durée." },
        },
      },
      {
        type: "choix",
        text: "Vous ne savez pas quels sont les dispositifs disponibles dans votre organisation pour les personnes en difficulté.",
        tags: ["relais", "ressources"],
        answers: [
          { text: "Je laisse — si j'en ai besoin, je me renseignerai le moment venu.", score: 0 },
          { text: "Je me renseigne maintenant pour savoir ce qui existe avant d'en avoir besoin.", score: 2 },
          { text: "Je suppose que le médecin du travail est le seul recours.", score: 0 },
          { text: "Je demande à un collègue ou aux RH ce qui existe.", score: 1.5 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous gérez seul·e et n'orientez que tardivement, pour vous comme pour vos collègues", resume: "Votre réflexe est encore de gérer seul·e les difficultés sans chercher de relais — pour vous-même comme pour vos collègues en difficulté.", desc: "Votre réflexe pourrait encore être de ne pas chercher de relais — par crainte d'être perçu·e comme quelqu'un qui ne tient pas, par méconnaissance des ressources disponibles, ou parce que 'ce n'est pas encore assez grave'. Ces comportements font que les difficultés se prolongent inutilement. Les relais disponibles — médecin du travail, RH, manager, pair — existent précisément pour être mobilisés avant la crise, pas après." },
          moyen: { label: "Pratiques en développement", titre: "Vous connaissez les relais et les mobilisez dans les cas évidents — la mobilisation précoce est encore insuffisante", resume: "Vous orientez vous-même et vos collègues dans les situations claires — vous attendez encore que les difficultés soient sérieuses avant de chercher de l'aide.", desc: "Vous connaissez les relais disponibles et vous les mobilisez dans les situations clairement sérieuses. Ce qui pourrait encore manquer, c'est la mobilisation précoce — chercher un appui avant d'être en crise, orienter un collègue avant que la situation soit visible de tous, faire un suivi après une orientation pour vérifier qu'elle a abouti. Ces réflexes précoces font que l'aide arrive quand elle est encore efficace." },
      ...
      {
        type: "likert",
        text: "Vous vous renseignez sur les ressources disponibles dans votre organisation avant d'en avoir besoin.",
        tags: ["relais", "proactivité"],
        answers: [
          { text: "Jamais", score: 0 },
          { text: "Rarement", score: 0.5 },
          { text: "Parfois", score: 1 },
      ...
      {
        type: "choix",
        text: "Vous vous sentez épuisé·e depuis plusieurs semaines mais vous n'avez pas consulté le médecin du travail car vous pensez que 'ce n'est pas encore assez grave'.",
        tags: ["relais", "médecin travail"],
        answers: [
          { text: "Je continue à attendre — la consultation se justifiera quand la situation sera vraiment sérieuse.", score: 0 },
          { text: "Je consulte maintenant — le médecin du travail existe précisément pour les situations avant la crise.", score: 2 },
          { text: "Je prends rendez-vous avec mon médecin traitant à la place.", score: 1 },
          { text: "J'en parle d'abord à mon manager pour valider que c'est justifié.", score: 0.5 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous gérez seul·e et n'orientez que tardivement, pour vous comme pour vos collègues", resume: "Votre réflexe est encore de gérer seul·e les difficultés sans chercher de relais — pour vous-même comme pour vos collègues en difficulté.", desc: "Votre réflexe pourrait encore être de ne pas chercher de relais — par crainte d'être perçu·e comme quelqu'un qui ne tient pas, par méconnaissance des ressources disponibles, ou parce que 'ce n'est pas encore assez grave'. Ces comportements font que les difficultés se prolongent inutilement. Les relais disponibles — médecin du travail, RH, manager, pair — existent précisément pour être mobilisés avant la crise, pas après." },
          moyen: { label: "Pratiques en développement", titre: "Vous connaissez les relais et les mobilisez dans les cas évidents — la mobilisation précoce est encore insuffisante", resume: "Vous orientez vous-même et vos collègues dans les situations claires — vous attendez encore que les difficultés soient sérieuses avant de chercher de l'aide.", desc: "Vous connaissez les relais disponibles et vous les mobilisez dans les situations clairement sérieuses. Ce qui pourrait encore manquer, c'est la mobilisation précoce — chercher un appui avant d'être en crise, orienter un collègue avant que la situation soit visible de tous, faire un suivi après une orientation pour vérifier qu'elle a abouti. Ces réflexes précoces font que l'aide arrive quand elle est encore efficace." },
      ...
      {
        type: "choix",
        text: "Un collègue vous confie être en grande difficulté et vous demande de garder ça pour vous.",
        tags: ["relais", "collègue"],
        answers: [
          { text: "Je respecte sa confidence et je garde ça pour moi.", score: 0 },
          { text: "Je l'écoute, je l'oriente vers les relais adaptés et je lui explique pourquoi je ne peux pas rester seul·e avec cette information.", score: 2 },
          { text: "J'en parle à notre manager commun sans lui dire que je l'ai fait.", score: 0 },
          { text: "Je le soutiens du mieux possible sans en parler à personne.", score: 0.5 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous gérez seul·e et n'orientez que tardivement, pour vous comme pour vos collègues", resume: "Votre réflexe est encore de gérer seul·e les difficultés sans chercher de relais — pour vous-même comme pour vos collègues en difficulté.", desc: "Votre réflexe pourrait encore être de ne pas chercher de relais — par crainte d'être perçu·e comme quelqu'un qui ne tient pas, par méconnaissance des ressources disponibles, ou parce que 'ce n'est pas encore assez grave'. Ces comportements font que les difficultés se prolongent inutilement. Les relais disponibles — médecin du travail, RH, manager, pair — existent précisément pour être mobilisés avant la crise, pas après." },
          moyen: { label: "Pratiques en développement", titre: "Vous connaissez les relais et les mobilisez dans les cas évidents — la mobilisation précoce est encore insuffisante", resume: "Vous orientez vous-même et vos collègues dans les situations claires — vous attendez encore que les difficultés soient sérieuses avant de chercher de l'aide.", desc: "Vous connaissez les relais disponibles et vous les mobilisez dans les situations clairement sérieuses. Ce qui pourrait encore manquer, c'est la mobilisation précoce — chercher un appui avant d'être en crise, orienter un collègue avant que la situation soit visible de tous, faire un suivi après une orientation pour vérifier qu'elle a abouti. Ces réflexes précoces font que l'aide arrive quand elle est encore efficace." },
      ...
      {
        type: "likert",
        text: "Quand un collègue est en difficulté, vous l'orientez vers les ressources adaptées plutôt que de tout gérer vous-même.",
        tags: ["relais", "orientation collègues"],
        answers: [
          { text: "Jamais", score: 0 },
          { text: "Rarement", score: 0.5 },
          { text: "Parfois", score: 1 },
      ...
      {
        type: "choix",
        text: "Vous avez attendu d'être en crise avant de chercher de l'aide. La situation a été plus difficile à résoudre qu'elle ne l'aurait été plus tôt.",
        tags: ["relais", "timing"],
        answers: [
          { text: "C'était inévitable — je ne savais pas que la situation était si sérieuse.", score: 0 },
          { text: "Je retiens cet enseignement et je cherche de l'aide plus tôt la prochaine fois.", score: 2 },
          { text: "Je préfère gérer seul·e tant que c'est possible.", score: 0 },
          { text: "Je note de mieux surveiller mes signaux à l'avenir.", score: 1.5 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous gérez seul·e et n'orientez que tardivement, pour vous comme pour vos collègues", resume: "Votre réflexe est encore de gérer seul·e les difficultés sans chercher de relais — pour vous-même comme pour vos collègues en difficulté.", desc: "Votre réflexe pourrait encore être de ne pas chercher de relais — par crainte d'être perçu·e comme quelqu'un qui ne tient pas, par méconnaissance des ressources disponibles, ou parce que 'ce n'est pas encore assez grave'. Ces comportements font que les difficultés se prolongent inutilement. Les relais disponibles — médecin du travail, RH, manager, pair — existent précisément pour être mobilisés avant la crise, pas après." },
          moyen: { label: "Pratiques en développement", titre: "Vous connaissez les relais et les mobilisez dans les cas évidents — la mobilisation précoce est encore insuffisante", resume: "Vous orientez vous-même et vos collègues dans les situations claires — vous attendez encore que les difficultés soient sérieuses avant de chercher de l'aide.", desc: "Vous connaissez les relais disponibles et vous les mobilisez dans les situations clairement sérieuses. Ce qui pourrait encore manquer, c'est la mobilisation précoce — chercher un appui avant d'être en crise, orienter un collègue avant que la situation soit visible de tous, faire un suivi après une orientation pour vérifier qu'elle a abouti. Ces réflexes précoces font que l'aide arrive quand elle est encore efficace." },
      ...
      {
        type: "choix",
        text: "Dans votre équipe, chercher de l'aide ou exprimer une difficulté est perçu comme un signe de faiblesse.",
        tags: ["relais", "normalité"],
        answers: [
          { text: "Je m'adapte à cette culture — je gère seul·e pour ne pas être perçu·e négativement.", score: 0 },
          { text: "Je maintiens mon propre réflexe de demander de l'aide indépendamment de la norme collective.", score: 2 },
          { text: "J'exprime ma difficulté discrètement à mon manager uniquement.", score: 1 },
          { text: "Je cherche à faire évoluer cette culture progressivement.", score: 1.5 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous gérez seul·e et n'orientez que tardivement, pour vous comme pour vos collègues", resume: "Votre réflexe est encore de gérer seul·e les difficultés sans chercher de relais — pour vous-même comme pour vos collègues en difficulté.", desc: "Votre réflexe pourrait encore être de ne pas chercher de relais — par crainte d'être perçu·e comme quelqu'un qui ne tient pas, par méconnaissance des ressources disponibles, ou parce que 'ce n'est pas encore assez grave'. Ces comportements font que les difficultés se prolongent inutilement. Les relais disponibles — médecin du travail, RH, manager, pair — existent précisément pour être mobilisés avant la crise, pas après." },
          moyen: { label: "Pratiques en développement", titre: "Vous connaissez les relais et les mobilisez dans les cas évidents — la mobilisation précoce est encore insuffisante", resume: "Vous orientez vous-même et vos collègues dans les situations claires — vous attendez encore que les difficultés soient sérieuses avant de chercher de l'aide.", desc: "Vous connaissez les relais disponibles et vous les mobilisez dans les situations clairement sérieuses. Ce qui pourrait encore manquer, c'est la mobilisation précoce — chercher un appui avant d'être en crise, orienter un collègue avant que la situation soit visible de tous, faire un suivi après une orientation pour vérifier qu'elle a abouti. Ces réflexes précoces font que l'aide arrive quand elle est encore efficace." },
      ...
      {
        type: "likert",
        text: "Vous cherchez de l'aide pour vous-même avant d'être en situation de crise.",
        tags: ["relais", "soi-même"],
        answers: [
          { text: "Jamais", score: 0 },
          { text: "Rarement", score: 0.5 },
          { text: "Parfois", score: 1 },
      ...
      {
        type: "choix",
        text: "Vous avez orienté un collègue vers un relais il y a deux semaines. Vous n'avez pas de nouvelles.",
        tags: ["relais", "suivi"],
        answers: [
          { text: "Je laisse — si il avait besoin de moi, il reviendrait.", score: 0 },
          { text: "Je prends des nouvelles discrètement pour m'assurer qu'il a bien accédé à l'aide.", score: 2 },
          { text: "Je lui redemande comment il va lors de notre prochain échange.", score: 1.5 },
          { text: "Je contacte le relais directement pour savoir si mon collègue s'est manifesté.", score: 0.5 },
        ],
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous gérez seul·e et n'orientez que tardivement, pour vous comme pour vos collègues", resume: "Votre réflexe est encore de gérer seul·e les difficultés sans chercher de relais — pour vous-même comme pour vos collègues en difficulté.", desc: "Votre réflexe pourrait encore être de ne pas chercher de relais — par crainte d'être perçu·e comme quelqu'un qui ne tient pas, par méconnaissance des ressources disponibles, ou parce que 'ce n'est pas encore assez grave'. Ces comportements font que les difficultés se prolongent inutilement. Les relais disponibles — médecin du travail, RH, manager, pair — existent précisément pour être mobilisés avant la crise, pas après." },
          moyen: { label: "Pratiques en développement", titre: "Vous connaissez les relais et les mobilisez dans les cas évidents — la mobilisation précoce est encore insuffisante", resume: "Vous orientez vous-même et vos collègues dans les situations claires — vous attendez encore que les difficultés soient sérieuses avant de chercher de l'aide.", desc: "Vous connaissez les relais disponibles et vous les mobilisez dans les situations clairement sérieuses. Ce qui pourrait encore manquer, c'est la mobilisation précoce — chercher un appui avant d'être en crise, orienter un collègue avant que la situation soit visible de tous, faire un suivi après une orientation pour vérifier qu'elle a abouti. Ces réflexes précoces font que l'aide arrive quand elle est encore efficace." },
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Votre radar s'active quand c'est visible — pas avant.", resume: "Votre détection des signaux RPS attend encore que les difficultés soient visibles — les signaux précoces passent sans réaction.", desc: "Votre réaction aux signaux de difficulté existe quand la situation est évidente. Ce qui pourrait encore manquer, c'est la création active des occasions qui permettent aux signaux de remonter — un collaborateur ne viendra pas toujours vous voir spontanément. Votre rôle ne se limite pas à observer : il consiste à créer les conditions dans lesquelles les signaux peuvent vous parvenir avant qu'ils soient impossibles à ignorer." },
          moyen: { label: "Pratiques en développement", titre: "Les signaux forts vous atteignent — les changements progressifs restent dans l'angle mort.", resume: "Vous repérez les signaux nets et faites des points réguliers — les changements discrets et progressifs créent encore des angles morts.", desc: "Vous intervenez quand les signaux sont visibles et vous maintenez des points individuels réguliers. Ce qui pourrait encore vous échapper, c'est le changement progressif et discret — la personne qui se referme légèrement, l'engagement qui diminue imperceptiblement. Ces signaux faibles sont précisément les plus précieux parce qu'ils permettent d'intervenir avant que la situation ne se soit dégradée." },
          haut: { label: "Réflexes installés", titre: "Vous créez les conditions pour détecter avant que ce soit visible.", resume: "Vous créez les occasions pour que les signaux remontent et vous intervenez tôt, avant que les difficultés ne soient visibles.", desc: "Vous ne vous contentez pas d'observer — vous créez des occasions d'échange régulières qui permettent aux signaux de remonter avant qu'ils soient évidents. Vous intervenez sur des changements comportementaux discrets, vous revenez sur des réponses de façade. Cette posture proactive — qui suppose d'aller vers les personnes plutôt d'attendre qu'elles viennent — est ce qui permet de prévenir plutôt que de réagir." },
        },
      }, 
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "La crainte d'être maladroit·e vous retient encore d'intervenir.", resume: "L'hésitation à intervenir par peur d'être maladroit·e ou de dépasser votre rôle retarde encore vos réactions.", desc: "Votre réticence à intervenir pourrait encore venir de la crainte d'être maladroit·e, de mélanger les sujets ou de dépasser votre rôle. Ces hésitations sont compréhensibles — elles retardent précisément les interventions qui auraient le plus d'effet. Votre rôle managérial inclut l'intervention sur les faits observés — pas le diagnostic, pas le soin, mais la conversation factuelle sur ce que vous avez observé dans le travail." },
          moyen: { label: "Pratiques en développement", titre: "Les situations claires déclenchent votre intervention — les zones grises vous font encore hésiter.", resume: "Vous intervenez dans les situations claires — les zones grises et la peur de dépasser votre rôle créent encore des hésitations.", desc: "Vous intervenez sur les faits observés dans les situations claires. Ce qui pourrait encore créer des hésitations, c'est la zone grise — ne pas savoir si c'est votre rôle, craindre de mettre des mots sur ce que vous observez si la personne ne le verbalise pas. Ces hésitations font précisément que les situations se dégradent entre deux décisions d'intervenir." },
          haut: { label: "Réflexes installés", titre: "Vous intervenez sur les faits — ni diagnostic, ni jugement.", resume: "Vous intervenez sur les faits, vous laissez la personne interpréter, vous séparez les sujets — sans dépasser votre rôle.", desc: "Vous vous appuyez sur des comportements observés dans le travail, vous posez des questions ouvertes, vous laissez la personne interpréter ce qu'elle vit. Vous séparez clairement l'entretien de soutien de l'entretien de performance. Cette façon d'intervenir — factuelle, calibrée, respectueuse du rôle — est ce qui permet d'aborder les situations difficiles sans créer d'inconfort supplémentaire." },
        },
      }, 
      {
        type: "likert",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous gérez seul·e trop longtemps ce qui demande un relais.", resume: "Vous orientez tard et gérez seul·e des situations qui gagneraient à être partagées avec les relais disponibles.", desc: "Votre réflexe pourrait encore être de gérer seul·e avant d'orienter — attendre que la demande soit explicite, ne pas faire de suivi après une orientation. Ces comportements retardent l'accès à des ressources qui existent et font peser sur vous des responsabilités qui dépassent votre périmètre. Orienter tôt et faire le suivi font partie de votre rôle." },
          moyen: { label: "Pratiques en développement", titre: "Vous orientez quand c'est évident — le suivi et votre propre appui sont encore insuffisants.", resume: "Vous orientez quand c'est évident — le suivi après orientation et votre propre recherche de soutien sont encore insuffisants.", desc: "Vous orientez quand la situation est clairement au-delà de votre périmètre. Ce qui pourrait encore être insuffisant, c'est le suivi après l'orientation — vérifier que la personne a bien accédé au relais, relancer si ce n'est pas le cas — et votre propre recherche de soutien quand les situations sont lourdes à porter seul·e." },
          haut: { label: "Réflexes installés", titre: "Vous orientez tôt, suivez et cherchez votre propre appui quand nécessaire.", resume: "Vous orientez au bon moment, vous faites le suivi et vous cherchez vous-même un appui quand les situations sont lourdes.", desc: "Vous orientez avant la crise, vous faites un suivi après l'orientation, vous relancez quand la personne n'a pas donné suite. Vous cherchez vous-même un appui — pair, RH, manager de niveau supérieur — quand les situations sont lourdes à porter seul·e. Cette combinaison d'orientation proactive et de recherche de soutien personnel est ce qui fait tenir la posture dans la durée." },
        },
      }, 
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous traitez les situations — sans agir sur ce qui les produit.", resume: "Vous gérez les situations quand elles remontent sans agir sur les conditions qui les produisent.", desc: "Votre gestion des difficultés RPS pourrait encore se concentrer sur les situations déclarées plutôt que sur leurs causes. Traiter la tension quand elle remonte, distribuer toujours les missions aux mêmes, ne pas clarifier les rôles en amont : ces comportements laissent les conditions qui produisent les difficultés intactes. Votre levier le plus puissant est d'agir sur ces conditions avant que les situations n'apparaissent." },
          moyen: { label: "Pratiques en développement", titre: "Vous ajustez les conditions quand les situations remontent — pas en amont.", resume: "Vous ajustez les conditions sur les situations déclarées — la prévention structurelle en amont est encore partielle.", desc: "Vous ajustez les conditions de travail quand des tensions remontent. Ce qui pourrait encore être plus proactif, c'est la prévention en amont — clarifier les rôles avant que les frictions apparaissent, rééquilibrer les charges avant qu'elles ne soient déclarées insoutenables, traiter les irritants organisationnels avant qu'ils ne s'installent." },
          haut: { label: "Réflexes installés", titre: "Vous intervenez sur les causes avant que les situations n'émergent.", resume: "Vous agissez sur les conditions de travail en amont, avant que les situations difficiles n'apparaissent.", desc: "Vous clarifiez les rôles avant que les frictions apparaissent. Vous aménagez du temps pour que les signaux puissent remonter. Vous traitez les irritants organisationnels dès qu'ils émergent. Cette action préventive sur les conditions — qui suppose d'anticiper plutôt que de réagir — est ce qui réduit la fréquence et la gravité des situations difficiles dans votre équipe." },
        },
      }, 
      {
        type: "likert",
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous attendez que les difficultés viennent à vous.", resume: "Vous attendez encore que vos collaborateurs viennent à vous plutôt que de créer les occasions d'observer et d'entendre.", desc: "Votre posture pourrait encore être d'attendre que les collaborateurs signalent eux-mêmes leurs difficultés. Ce qui pourrait manquer, c'est la création active des occasions d'échange — des points qui vont au-delà des livrables, une posture qui signale que vous êtes disponible pour entendre plus que la performance. Les collaborateurs ne viennent pas toujours spontanément : c'est votre posture qui crée ou non l'espace pour qu'ils le fassent." },
          moyen: { label: "Pratiques en développement", titre: "Les difficultés visibles sont détectées — les progressives et discrètes restent dans l'angle mort.", resume: "Vous repérez les signaux évidents — les changements discrets et progressifs créent encore des angles morts.", desc: "Vous faites des points individuels réguliers et vous intervenez quand les signaux sont visibles. Ce qui pourrait encore vous échapper, c'est le changement discret — la personne qui répond un peu plus court, l'engagement qui fluctue légèrement. Ces signaux faibles sont ceux que les occasions d'échange régulières permettent de capter, si elles vont au-delà des livrables." },
          haut: { label: "Réflexes installés", titre: "Vous allez chercher les signaux — vous ne les attendez pas.", resume: "Vous créez les conditions pour que les signaux remontent, sans attendre qu'ils vous soient signalés.", desc: "Vous faites des points réguliers qui vont au-delà des livrables. Vous creusez quand quelque chose vous semble décalé, même sans signal évident. Vous créez des espaces où la difficulté peut être nommée sans être liée à la performance. Cette posture proactive — qui suppose d'aller chercher les signaux plutôt d'attendre qu'ils viennent — est ce qui permet de prévenir avant de devoir réagir." },
        },
      }, 
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "La limite floue de votre rôle vous retient encore d'intervenir.", resume: "L'hésitation à intervenir par peur d'être maladroit·e ou de dépasser votre rôle retarde encore vos réactions.", desc: "Votre réticence à intervenir pourrait encore venir de la crainte d'être maladroit·e, de mélanger soutien et performance, ou de dépasser votre rôle. Ces hésitations sont compréhensibles — elles font que les situations se dégradent entre deux décisions d'intervenir. Votre rôle managérial inclut l'intervention factuelle sur ce que vous observez dans le travail — sans diagnostic, sans jugement sur la vie privée." },
          moyen: { label: "Pratiques en développement", titre: "Vous intervenez dans les situations claires — les zones grises créent encore des hésitations.", resume: "Vous intervenez dans les situations claires — les zones grises créent encore des hésitations sur la conduite à tenir.", desc: "Vous intervenez quand la situation est claire. Ce qui pourrait encore créer des hésitations, c'est la zone grise — ne pas savoir si c'est votre rôle, ne pas trouver les mots justes, craindre de nommer ce que vous observez si la personne ne le verbalise pas. Ces hésitations font que des situations qui auraient pu être abordées tôt se dégradent." },
          haut: { label: "Réflexes installés", titre: "Vous intervenez sur les faits, pas sur les causes — c'est votre rôle.", resume: "Vous intervenez de façon factuelle et calibrée, en séparant les sujets et en laissant la personne interpréter.", desc: "Vous vous appuyez sur des faits observés dans le travail, vous posez des questions ouvertes, vous laissez la personne interpréter ce qu'elle vit. Vous séparez clairement l'échange de soutien de l'échange sur la performance. Cette façon d'intervenir — factuelle, calibrée, respectueuse de votre périmètre — est ce qui permet d'aborder les situations difficiles sans créer d'inconfort ou de confusion supplémentaire." },
        },
      }, 
      {
        type: "likert",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "La pression de la hiérarchie traverse encore jusqu'à votre équipe sans filtre.", resume: "Vous absorbez les demandes extérieures sans les filtrer, laissant votre équipe subir la charge sans arbitrage.", desc: "Votre posture pourrait encore être de répercuter la pression sur votre équipe sans la filtrer — laisser une personne absorber systématiquement ce que les autres refusent, ne pas rendre visible la charge réelle à votre hiérarchie. Ces comportements laissent les mécanismes de surcharge se renforcer, sans que personne ne soit en mesure de les traiter à un niveau où l'arbitrage est possible." },
          moyen: { label: "Pratiques en développement", titre: "Les surcharges visibles sont protégées — les mécanismes profonds restent encore en place.", resume: "Vous protégez votre équipe des surcharges visibles — les mécanismes profonds de distribution et de visibilité restent encore en place.", desc: "Vous défendez votre équipe dans les situations de surcharge visibles. Ce qui pourrait encore rester en place, c'est la distribution inégale des charges non déclarée, la surcharge qui ne remonte pas à votre propre hiérarchie. Ces mécanismes profonds sont ceux qui créent l'épuisement progressif que personne n'a vu venir." },
          haut: { label: "Réflexes installés", titre: "Vous filtrez la pression entrante et rendez visible ce que vous ne pouvez pas absorber.", resume: "Vous filtrez et arbitrez la charge de votre équipe, et vous la rendez visible à votre hiérarchie quand elle dépasse.", desc: "Vous arbitrez ce qui arrive à votre équipe, vous rééquilibrez proactivement les charges déséquilibrées, vous rendez visible à votre propre hiérarchie ce qui dépasse ce que votre équipe peut absorber. Cette combinaison de filtrage et de remontée — qui suppose d'accepter d'être en désaccord avec les demandes de la hiérarchie — est ce qui protège réellement votre équipe dans la durée." },
        },
      }, 
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous portez seul·e des situations qui demanderaient un relais.", resume: "Vous gardez les situations difficiles pour vous sans mobiliser les relais disponibles — au détriment des personnes et de vous-même.", desc: "Votre réflexe pourrait encore être de gérer seul·e des situations qui dépassent votre périmètre — ne pas savoir quand orienter, ne pas chercher vous-même un appui quand les situations sont lourdes à porter. Ces comportements font peser sur vous des responsabilités qui ne vous appartiennent pas seul·e et privent les personnes concernées d'une aide plus adaptée." },
          moyen: { label: "Pratiques en développement", titre: "Vous mobilisez les relais dans les cas évidents — tardivement ou jamais pour vous-même.", resume: "Vous connaissez les relais et vous les mobilisez dans les cas évidents — vous tardez encore à les utiliser précocement ou pour vous-même.", desc: "Vous connaissez les relais et vous les mobilisez quand la situation est clairement au-delà de votre périmètre. Ce qui pourrait encore manquer, c'est la mobilisation précoce — avant la crise — et votre propre recherche de soutien quand les situations sont lourdes à porter seul·e. Ces deux dimensions sont celles qui font tenir la posture managériale dans la durée." },
          haut: { label: "Réflexes installés", titre: "Vous mobilisez les relais au bon moment — pour les autres ET pour vous.", resume: "Vous mobilisez les relais au bon moment et vous vous appuyez vous-même sur un soutien quand les situations sont lourdes.", desc: "Vous orientez vers les relais avant que les situations soient en crise. Vous faites un suivi après l'orientation. Vous cherchez vous-même un appui — pair, RH, manager de niveau supérieur — quand les situations sont lourdes à porter seul·e. Cette double mobilisation — pour les autres et pour soi — est ce qui permet de tenir une posture de soutien dans la durée sans s'épuiser." },
        },
      }, 
      {
        type: "likert",
    ...
    0: [
      {
        ...
        profiles: {
          bas:   { label: "Repères à consolider", titre: "Votre agenda obéit encore aux urgences déclarées — pas aux priorités réelles.", resume: "Vous traitez les urgences dans l'ordre où elles arrivent sans les hiérarchiser ni questionner leur qualification.", desc: "Votre gestion de la charge pourrait encore consister à absorber les demandes au fur et à mesure — traiter dans l'ordre d'arrivée, rester plus longtemps pour tenir. Ce qui pourrait manquer, c'est la hiérarchisation active des priorités et la qualification des urgences avant de les traiter. Ces deux réflexes sont ce qui permet de sortir du mode réactif permanent." },
          moyen: { label: "Pratiques en développement", titre: "Vous priorisez dans les situations stables — la pression forte fait encore céder votre organisation.", resume: "Vous priorisez dans les situations simples — les urgences non qualifiées et les pics vous rattrapent encore dans les situations complexes.", desc: "Vous faites la différence entre l'urgent et l'important dans la plupart des cas. Ce qui pourrait encore vous rattraper, c'est la situation complexe — quand les demandes s'accumulent, les urgences non qualifiées prennent le dessus sur les priorités réelles. L'enjeu est de maintenir la hiérarchisation active dans les périodes de pic, précisément quand la pression pousse à tout traiter." },
          haut:  { label: "Réflexes installés", titre: "Vous protégez vos priorités même quand les urgences s'accumulent.", resume: "Vous hiérarchisez activement votre charge et vous protégez votre organisation des urgences non qualifiées.", desc: "Vous qualifiez les urgences avant de les traiter. Vous signalez les charges insoutenables plutôt que de les absorber. Vous protégez votre organisation des interruptions non prioritaires. Cette gestion active de la charge — qui suppose d'accepter parfois de ne pas répondre immédiatement — est ce qui permet de tenir un niveau de qualité durable sur les vrais sujets." },
        },
      }, 
      {
        type: "likert",
    ...
    1: [
      {
        ...
        profiles: {
          bas:   { label: "Repères à consolider", titre: "Vous dites oui pour ne pas décevoir — et créez ainsi les déceptions suivantes.", resume: "Vous acceptez plus que vous ne pouvez tenir, par crainte de décevoir ou de paraître peu impliqué·e.", desc: "Votre gestion des engagements pourrait encore être influencée par la crainte de décevoir ou de paraître peu impliqué·e — dire oui quand votre charge est déjà pleine, annoncer des délais que vous savez irréalistes. Ces comportements créent des engagements que vous ne pourrez pas tenir, ce qui déçoit précisément les personnes que vous essayiez de ne pas décevoir." },
          moyen: { label: "Pratiques en développement", titre: "Vous négociez dans les situations raisonnables — la pression forte vous fait encore accepter trop.", resume: "Vous négociez les délais dans les situations évidentes — la pression hiérarchique ou relationnelle forte crée encore des acceptations difficiles.", desc: "Vous savez demander un délai supplémentaire quand c'est raisonnable. Ce qui pourrait encore créer des acceptations difficiles, c'est la pression forte — hiérarchique ou relationnelle. Dans ces situations, la négociation sur les faits — charge réelle, priorités existantes — est plus protectrice que l'acceptation qui mène à un engagement non tenu." },
          haut:  { label: "Réflexes installés", titre: "Vous annoncez ce que vous pouvez tenir — pas ce que vous voulez entendre.", resume: "Vous négociez les délais sur les faits — charge réelle, priorités existantes — pas sur votre envie de tenir ou de ne pas décevoir.", desc: "Vous annoncez des délais réalistes. Vous les renégociez quand les conditions changent. Vous ne surcompensez pas pour éviter une conversation difficile. Cette façon de gérer les engagements — qui suppose d'accepter parfois de décevoir dans le moment pour être fiable dans la durée — est ce qui crée une réputation de fiabilité réelle." },
        },
      }, 
      {
        type: "likert",
    ...
    2: [
      {
        ...
        profiles: {
          bas:   { label: "Repères à consolider", titre: "Vous déléguez la tâche mais pas la responsabilité du résultat.", resume: "Vous gardez la main sur ce que vous pourriez déléguer, souvent pour de bonnes raisons qui fragilisent l'autonomie de l'équipe.", desc: "Votre réflexe pourrait encore être de reprendre les dossiers délégués, de corriger discrètement plutôt que de donner du feedback, de déléguer sans résultat défini. Ces comportements ont souvent de bonnes raisons — qualité, délais, crédibilité. Mais ils privent votre équipe de l'autonomie qu'elle pourrait développer et concentrent sur vous une charge que vous pourriez distribuer." },
          moyen: { label: "Pratiques en développement", titre: "Vous déléguez — vous reprenez encore la main quand le résultat diverge de votre façon de faire.", resume: "Vous déléguez — vous reprenez encore la main quand le résultat s'éloigne de ce que vous auriez fait.", desc: "Vous déléguez régulièrement. Ce qui pourrait encore créer des reprises de contrôle, c'est le moment où le résultat s'éloigne de ce que vous auriez fait. La différence entre le suivi et le contrôle se joue précisément là : faire confiance au résultat attendu plutôt qu'à la méthode choisie." },
          haut:  { label: "Réflexes installés", titre: "Vous confiez un résultat à atteindre — pas une méthode à reproduire.", resume: "Vous déléguez en faisant confiance au résultat attendu, pas à la méthode — ce qui crée une autonomie réelle dans l'équipe.", desc: "Vous confiez un résultat à atteindre plutôt qu'une façon de faire à reproduire. Vous faites un suivi sans faire de contrôle. Vous donnez du feedback sur l'écart sans reprendre le dossier. Cette façon de déléguer — qui suppose d'accepter que le résultat soit atteint autrement que vous ne l'auriez fait — est ce qui développe réellement l'autonomie de votre équipe." },
        },
      }, 
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas:   { label: "Repères à consolider", titre: "Vous choisissez seul·e entre des priorités contradictoires — sans que ça remonte.", resume: "Vous absorbez les contradictions de priorité sans les rendre visibles à ceux qui pourraient les arbitrer.", desc: "Votre réflexe pourrait encore être de choisir seul·e entre des priorités contradictoires quand ce n'est pas votre rôle de le faire — s'exécuter sans dire que c'est incompatible, absorber en silence la surcharge structurelle. Ces comportements font que les contradictions réelles ne remontent jamais au niveau où l'arbitrage est possible et où les ressources supplémentaires pourraient être allouées." },
          moyen: { label: "Pratiques en développement", titre: "Les surcharges aiguës remontent — les tensions structurelles restent encore silencieuses.", resume: "Vous signalez les surcharges ponctuelles — les tensions structurelles plus lentes et plus profondes restent encore silencieuses.", desc: "Vous nommez les problèmes de charge quand ils sont aigus. Ce qui pourrait encore rester silencieux, c'est la tension plus lente et plus profonde — la charge structurelle qui s'installe progressivement, la contradiction de priorité qui ne crée pas d'urgence mais qui use sur la durée. Ces tensions profondes ont besoin d'être nommées pour être traitées." },
          haut:  { label: "Réflexes installés", titre: "Vous rendez visibles les contradictions pour qu'elles soient traitées au bon niveau.", resume: "Vous rendez visibles les contradictions de priorité pour que ceux qui peuvent arbitrer le fassent — pas pour vous y soustraire.", desc: "Vous ne choisissez pas seul·e entre des priorités contradictoires quand ce n'est pas votre rôle. Vous nommez la contradiction et vous la remontez. Vous documentez la surcharge structurelle pour qu'elle puisse être traitée. Cette visibilité active — qui suppose d'accepter d'être parfois perçu·e comme quelqu'un qui ne veut pas tout prendre en charge — est ce qui permet que les tensions réelles soient traitées à leur bon niveau." },
        },
      }, 
      {
        type: "likert",
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous préférez contourner les irritants plutôt que les aborder.", resume: "Les irritants s'accumulent parce que vous préférez encore les contourner plutôt que de les aborder directement.", desc: "Votre gestion des irritants pourrait encore passer par le contournement — adapter votre organisation pour ne plus dépendre de la personne, attendre que ça se tasse, en parler à quelqu'un d'autre. Ces stratégies évitent la conversation difficile mais laissent l'irritant en place, où il continue à s'installer et à peser sur la relation professionnelle." },
          moyen: { label: "Pratiques en développement", titre: "Vous traitez les frictions évidentes — les irritants discrets s'accumulent encore.", resume: "Vous traitez les irritants clairement problématiques — les irritants discrets et progressifs s'accumulent encore sans être abordés.", desc: "Vous abordez les irritants quand ils sont clairement problématiques. Ce qui pourrait encore s'accumuler, c'est le petit agacement récurrent qui ne semble pas mériter une conversation formelle — le décalage dans les réponses, la façon de formuler qui irrite, le mode de travail qui ne convient pas vraiment. Ces irritants discrets sont souvent ceux qui dégradent le plus les relations dans la durée, précisément parce qu'ils ne sont jamais abordés." },
          haut: { label: "Réflexes installés", titre: "Vous traitez les irritants tôt — avant qu'ils ne deviennent des frictions.", resume: "Vous traitez les irritants tôt et directement, avec des faits, avant qu'ils ne deviennent des conflits.", desc: "Vous abordez ce qui vous dérange avec la personne concernée, directement, avec des exemples concrets. Vous le faites tôt, avant que l'irritant ne se soit transformé en ressentiment. Vous présentez l'impact sur votre travail plutôt qu'un jugement sur la personne. Cette façon de traiter les irritants tôt — qui suppose d'accepter l'inconfort d'une conversation directe — est ce qui maintient des relations professionnelles saines dans la durée." },
        },
      },
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Votre coopération s'arrête aux frontières de votre périmètre officiel.", resume: "Vous coopérez dans votre périmètre et vous vous défaussez sur les contraintes dès que ça dépasse.", desc: "Votre coopération pourrait encore s'arrêter aux frontières de votre périmètre officiel — attendre la demande formelle avant d'aider, rester dans votre rôle défini même quand vous voyez que votre voisin aurait besoin d'un signal. Ces comportements sont souvent justifiés par des contraintes réelles, mais ils créent une coopération conditionnelle qui fragilise le collectif dans les situations difficiles." },
          moyen: { label: "Pratiques en développement", titre: "Votre périmètre formel est bien couvert — au-delà vous hésitez encore.", resume: "Vous coopérez bien dans votre périmètre — vous hésitez encore à contribuer au-delà quand ce n'est pas formellement attendu.", desc: "Vous êtes fiable dans votre périmètre et vous coopérez bien avec vos interlocuteurs directs. Ce qui pourrait encore créer des hésitations, c'est la contribution au-delà — signaler un blocage qui va impacter un autre service, proposer un ajustement non demandé. Ces contributions proactives sont ce qui fait passer d'une coopération formelle à une coopération réelle." },
          haut: { label: "Réflexes installés", titre: "Votre coopération dépasse naturellement les frontières formelles.", resume: "Votre coopération ne s'arrête pas aux frontières de votre périmètre officiel.", desc: "Vous tenez vos engagements. Vous signalez vos blocages avant qu'ils n'impactent les autres. Vous anticipez les impacts de vos décisions sur les autres services. Vous contribuez au-delà de votre périmètre quand c'est utile. Cette coopération proactive — qui suppose d'aller au-delà de ce qui est formellement attendu — est ce qui crée une fiabilité collective qui tient dans les situations difficiles." },
        },
      },
      {
        type: "likert",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous taisez vos désaccords plutôt que de les exposer.", resume: "Vous évitez les désaccords en public et les laissez traîner en privé — les tensions s'installent sans être résolues.", desc: "Votre gestion des désaccords pourrait encore passer par l'évitement — se taire en réunion pour ne pas être le seul à ne pas être d'accord, parler en coulisses plutôt qu'en face, laisser le désaccord traîner plutôt que de l'adresser. Ces stratégies évitent l'inconfort immédiat mais laissent les désaccords non résolus, où ils continuent à peser sur les décisions et les relations." },
          moyen: { label: "Pratiques en développement", titre: "Vous exprimez vos désaccords dans les conditions favorables — la pression vous fait encore reculer.", resume: "Vous exprimez vos désaccords dans les situations simples — la pression forte ou l'isolement peuvent encore vous faire reculer.", desc: "Vous dites ce que vous pensez quand l'enjeu est limité. Ce qui pourrait encore vous faire reculer, c'est la situation où vous êtes le seul à ne pas être d'accord face à un groupe, ou la pression forte. L'enjeu est de maintenir votre position sur les faits dans ces situations — pas par entêtement, mais parce que les désaccords non exprimés ne protègent personne." },
          haut: { label: "Réflexes installés", titre: "Vous exprimez vos désaccords en face, même quand vous êtes seul·e à le penser.", resume: "Vous exprimez vos désaccords en face, au bon moment, sur les faits — même quand vous êtes seul·e à le penser.", desc: "Vous dites ce que vous pensez en réunion même quand vous êtes seul·e à le penser. Vous revenez sur un désaccord exprimé mollement plutôt que de le laisser traîner. Vous exprimez votre position sur les faits, pas sur les intentions. Cette façon d'exprimer les désaccords — directe, factuelle, au bon moment — est ce qui fait que les décisions collectives intègrent vraiment les perspectives disponibles." },
        },
      },
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "La pression révèle encore la fragilité de la qualité de vos échanges.", resume: "La pression détériore rapidement la qualité de vos échanges sans que vous le réguliiez.", desc: "La pression pourrait encore dégrader vos échanges sans que vous le réguliiez — des réponses plus sèches, des remerciements qui disparaissent, une humeur difficile qui déteint sur les interactions. Ces glissements semblent mineurs mais s'installent progressivement et dégradent la qualité des relations professionnelles dans la durée." },
          moyen: { label: "Pratiques en développement", titre: "La pression ordinaire ne vous affecte plus — les pics intenses peuvent encore vous faire glisser.", resume: "Vous maintenez la qualité relationnelle dans les pressions modérées — les pics intenses peuvent encore vous déstabiliser.", desc: "Vous gérez correctement la plupart des situations. Ce qui pourrait encore vous déstabiliser, c'est le pic d'intensité — plusieurs tensions simultanées, une situation personnellement difficile. Dans ces moments, la qualité de vos échanges pourrait se dégrader. L'enjeu est de le reconnaître quand ça se produit et de réparer plutôt que de minimiser." },
          haut: { label: "Réflexes installés", titre: "Vous maintenez la qualité de vos échanges sous pression — et réparez quand vous avez glissé.", resume: "Vous maintenez la qualité de vos échanges même sous pression, et vous réparez quand vous avez mal géré.", desc: "Vous maintenez la qualité de vos échanges même sous forte pression. Quand vous avez mal géré un échange, vous le nommez et vous réparez — pas en vous flagellant, mais en reconnaissant l'impact. Cette combinaison de maintien sous pression et de réparation quand nécessaire est ce qui maintient des relations professionnelles de qualité dans la durée." },
        },
      },
      {
        type: "likert",
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Votre mode hybride s'est installé par défaut — pas par conception.", resume: "Vous subissez votre organisation hybride plutôt que de la piloter — connexion prolongée, conditions inadaptées, frontières floues.", desc: "Votre organisation hybride pourrait encore se construire par défaut — rester connecté bien au-delà des horaires normaux, accepter des conditions de travail à domicile inadaptées, ne pas planifier vos jours de présence selon vos besoins réels. Ces comportements font que le mode hybride vous est imposé plutôt que choisi, ce qui alimente progressivement la fatigue et l'insatisfaction." },
          moyen: { label: "Pratiques en développement", titre: "Un fonctionnement hybride s'est construit — il n'est pas encore pleinement piloté.", resume: "Vous avez trouvé un fonctionnement hybride qui tient — quelques ajustements fins sur les frontières et la présence vous échappent encore.", desc: "Vous avez trouvé un fonctionnement hybride qui tient dans l'ensemble. Ce qui pourrait encore vous échapper, c'est quelques ajustements fins — protéger certains moments de la connexion à distance, planifier vos jours de présence en fonction des enjeux relationnels, ajuster votre organisation quand elle commence à glisser. Ces ajustements fins sont ce qui fait la différence entre un mode hybride qui tient et un mode hybride qui s'use." },
          haut: { label: "Réflexes installés", titre: "Vous pilotez votre hybridation — vous ne la subissez pas.", resume: "Vous pilotez activement votre organisation hybride — structure, présence stratégique, frontières — sans la subir.", desc: "Vous structurez vos journées de télétravail. Vous planifiez vos jours de présence selon les enjeux relationnels et professionnels du moment. Vous protégez vos frontières entre connexion et déconnexion. Vous ajustez quand quelque chose ne tient plus. Ce pilotage actif — qui suppose de remettre en question régulièrement son organisation — est ce qui fait que le mode hybride reste soutenable dans la durée." },
        },
      }, 
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "La proximité physique détermine encore vos liens — pas votre intention.", resume: "Le lien avec vos collègues se maintient par défaut et non par intention — les personnes éloignées disparaissent progressivement.", desc: "Le lien informel avec vos collègues pourrait s'être réduit progressivement avec la distance, sans que vous ayez créé d'occasions délibérées pour le maintenir. Ce qui pourrait encore manquer, c'est l'intention — synchroniser des jours de présence, inclure activement les personnes à distance dans les échanges, créer des occasions de lien qui ne dépendent pas de la proximité physique." },
          moyen: { label: "Pratiques en développement", titre: "Le lien avec les proches est entretenu — les plus éloignés restent dans l'angle mort.", resume: "Vous maintenez le lien avec vos collègues proches — les personnes plus éloignées ou moins visibles restent dans l'angle mort.", desc: "Vous êtes attentif·ve aux collègues avec qui vous travaillez régulièrement. Ce qui pourrait encore rester dans l'angle mort, c'est la personne plus éloignée — dans une autre équipe, dans un autre fuseau horaire, moins visible dans les échanges quotidiens. Maintenir le lien avec ces personnes requiert une intention délibérée que la proximité ordinaire ne crée pas naturellement." },
          haut: { label: "Réflexes installés", titre: "Vous créez du lien délibérément — quelle que soit la proximité physique.", resume: "Vous créez délibérément les conditions du lien collectif, quel que soit le mode de présence de chacun.", desc: "Vous synchronisez vos jours de présence avec ceux qui comptent. Vous incluez activement les personnes à distance dans les échanges collectifs. Vous créez des occasions de lien qui ne dépendent pas de la coprésence physique. Cette intention délibérée — qui suppose de ne pas laisser le lien se construire seulement par la proximité — est ce qui fait qu'une équipe hybride reste une équipe." },
        },
      }, 
      {
        type: "likert",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Les irritants hybrides s'accumulent parce qu'ils sont normalisés.", resume: "Les irritants de l'hybridation s'accumulent sans être nommés — mauvaise qualité audio, asymétrie d'information, outils inadaptés.", desc: "Les irritants liés à votre mode de travail hybride pourraient encore s'accumuler sans être nommés — la mauvaise qualité audio en réunion, l'information qui circule d'abord au bureau avant d'arriver à distance, les outils qui fonctionnent différemment selon le contexte. Ces irritants semblent secondaires pris isolément — leur accumulation sans traitement crée une fatigue de fond qui s'installe progressivement." },
          moyen: { label: "Pratiques en développement", titre: "Les irritants visibles sont traités — les plus discrets s'installent encore.", resume: "Vous traitez les irritants visibles — les dysfonctionnements plus discrets de l'hybridation s'installent encore sans être abordés.", desc: "Vous abordez les irritants quand ils sont clairement problématiques. Ce qui pourrait encore s'installer sans être traité, c'est le dysfonctionnement plus discret — la réunion qui crée une asymétrie entre présents et distants sans que personne ne le nomme, l'outil qui ralentit sans que l'adaptation soit demandée. Ces dysfonctionnements discrets sont ceux qui dégradent progressivement la qualité du travail hybride." },
          haut: { label: "Réflexes installés", titre: "Vous traitez les irritants hybrides à la source — pas autour.", resume: "Vous traitez les irritants de l'hybridation à la source, sans les normaliser.", desc: "Vous signalez quand la qualité audio vous empêche de suivre. Vous proposez de traiter certains sujets en mode différent quand le format actuel crée une asymétrie. Vous nommez les dysfonctionnements dès qu'ils apparaissent plutôt que de vous y adapter. Ce réflexe de traitement à la source — qui suppose de ne pas normaliser les irritants hybrides — est ce qui maintient la qualité du travail dans la durée." },
        },
      }, 
      {
        type: "choix",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Les inégalités de l'hybridation sont acceptées comme des données fixes.", resume: "Vous acceptez les inégalités créées par le mode de travail comme une fatalité, sans les nommer ni chercher à les corriger.", desc: "Votre perception des inégalités liées au mode de travail pourrait encore rester sans réaction — percevoir que le présentiel favorise la progression de carrière et s'y adapter sans le nommer, observer que certains ont plus accès à l'information et s'en accommoder. Ces inégalités ne sont pas des fatalités — elles peuvent être corrigées à votre niveau dès lors qu'elles sont nommées." },
          moyen: { label: "Pratiques en développement", titre: "Vous percevez les inégalités hybrides — vous hésitez encore à en faire un sujet.", resume: "Vous remarquez les inégalités créées par le mode de travail — vous hésitez encore à les nommer ou à agir.", desc: "Vous percevez les inégalités liées au mode de travail et vous les comprenez. Ce qui pourrait encore manquer, c'est le passage à l'action — nommer l'inégalité que vous observez, corriger ce qui est dans votre périmètre, remonter ce qui ne l'est pas. Ces inégalités ne se résolvent pas par la seule conscience qu'elles existent." },
          haut: { label: "Réflexes installés", titre: "Vous nommez et corrigez les inégalités créées par le mode de travail.", resume: "Vous nommez et corrigez les inégalités créées par le mode de travail à votre niveau de responsabilité.", desc: "Vous nommez les inégalités que vous observez — accès à l'information, visibilité des contributions, opportunités selon le mode de présence. Vous corrigez ce qui est dans votre périmètre. Vous remontez ce qui ne l'est pas. Cette action sur les inégalités — qui suppose de ne pas les normaliser au motif qu'elles sont structurelles — est ce qui maintient une équité réelle dans le travail hybride." },
        },
      }, 
      {
        type: "likert",
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous attendez que vos propres signaux soient impossibles à ignorer.", resume: "Vous ignorez ou minimisez vos propres signaux d'alerte jusqu'à ce qu'ils soient impossibles à contourner.", desc: "Vos propres signaux d'alerte pourraient encore être minimisés ou attribués à la période — mettre la fatigue sur le compte du contexte, attendre que ça passe, relativiser ce que les proches observent. Ces comportements retardent la prise en compte jusqu'à ce que les signaux soient trop forts pour être ignorés. C'est précisément à ce stade que la récupération prend le plus de temps." },
          moyen: { label: "Pratiques en développement", titre: "Les signaux forts vous atteignent — les signaux doux et progressifs restent encore dans l'angle mort.", resume: "Vous repérez vos signaux quand ils sont forts — les signaux subtils et progressifs créent encore des angles morts.", desc: "Vous réagissez quand les signaux sont clairs — fatigue intense, irritabilité forte, baisse de concentration évidente. Ce qui pourrait encore vous échapper, c'est le signal subtil et progressif — la légère perte d'enthousiasme, le sommeil qui se dégrade doucement, les petites satisfactions qui disparaissent une à une. Ces signaux précoces sont les plus précieux parce qu'ils permettent d'agir avant que la situation ne soit difficile à inverser." },
          haut: { label: "Réflexes installés", titre: "Vous prenez vos signaux au sérieux dès qu'ils apparaissent — pas quand ils crient.", resume: "Vous prenez vos propres signaux au sérieux dès qu'ils apparaissent, sans attendre qu'ils s'imposent.", desc: "Vous prenez au sérieux les observations de vos proches. Vous notez les changements durables dans votre énergie, votre humeur ou votre rapport au travail. Vous ne minimisez pas ce que vous ressentez au motif que 'c'est la période'. Cette prise au sérieux précoce — qui suppose d'accepter de ralentir avant d'y être contraint — est ce qui protège réellement contre l'épuisement." },
        },
      }, 
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous compensez jusqu'à la rupture plutôt que de réguler en amont.", resume: "Vous attendez le point de rupture pour réguler votre énergie, au lieu d'intervenir en amont.", desc: "Votre régulation de l'énergie pourrait encore intervenir trop tard — continuer à compenser, différer les congés, travailler le week-end pour récupérer du retard. Ces comportements semblent nécessaires dans l'urgence mais aggravent progressivement l'épuisement. La régulation efficace intervient en amont, pas une fois que les réserves sont épuisées." },
          moyen: { label: "Pratiques en développement", titre: "Vous intervenez sur les pics — les mécanismes de fond qui les produisent restent encore en place.", resume: "Vous réglez les pics — les mécanismes profonds de la surcharge restent encore en place entre les épisodes.", desc: "Vous prenez des congés, vous faites des pauses, vous réduisez votre charge pendant les périodes les plus intenses. Ce qui pourrait encore rester en place, c'est le mécanisme profond — la tendance à surcompenser, le refus de déléguer, la difficulté à couper vraiment. Ces mécanismes font que la surcharge se reconstitue rapidement après chaque régulation." },
          haut: { label: "Réflexes installés", titre: "Vous réglez votre énergie en amont — pas au bord du gouffre.", resume: "Vous intervenez sur votre énergie de façon préventive, sans attendre d'être à bout.", desc: "Vous prenez vos congés même quand le contexte n'est pas idéal. Vous coupez vraiment pendant les pauses. Vous signalez votre état avant d'être en crise. Cette régulation préventive — qui suppose d'accepter de ne pas être toujours disponible — est ce qui préserve l'énergie sur la durée et protège contre les épisodes d'épuisement prolongés." },
        },
      }, 
      {
        type: "likert",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "La peur du jugement prime encore sur le réflexe de chercher de l'aide.", resume: "Vous gérez seul·e par crainte d'être perçu·e comme quelqu'un qui ne tient pas — au détriment de votre santé.", desc: "Votre réflexe pourrait encore être de ne pas en parler par peur d'être jugé·e, de gérer seul·e alors que des ressources existent, de relativiser pour ne pas inquiéter. Ces comportements sont souvent protecteurs dans l'intention — ils retardent l'accès à une aide qui existe et qui serait utile bien avant que la situation soit sérieuse." },
          moyen: { label: "Pratiques en développement", titre: "Vous cherchez de l'aide dans les cas évidents — la zone grise vous retient encore.", resume: "Vous cherchez un appui dans les cas évidents — les zones grises et la crainte du jugement créent encore des hésitations.", desc: "Vous consultez votre médecin, vous parlez à votre responsable de votre charge, vous utilisez les ressources disponibles dans les cas clairement sérieux. Ce qui pourrait encore créer des hésitations, c'est la zone grise — 'ce n'est pas encore grave', 'je vais m'en sortir', 'je ne veux pas inquiéter'. Ces hésitations font que vous attendez que la situation soit sérieuse avant de chercher un appui." },
          haut: { label: "Réflexes installés", titre: "Vous cherchez de l'aide avant d'en avoir besoin de façon urgente.", resume: "Vous cherchez un appui tôt, sans attendre d'être en situation de crise.", desc: "Vous parlez de votre état à votre responsable avant d'être en crise. Vous utilisez les ressources disponibles — médecin du travail, psychologue, pair — sans attendre que la situation soit sérieuse. Vous ne gérez pas seul·e ce qui bénéficierait d'un appui extérieur. Cette recherche précoce de soutien — qui suppose d'accepter d'être perçu·e comme quelqu'un qui sait demander de l'aide — est plus protectrice que la gestion solitaire." },
        },
      }, 
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous repérez les signaux chez les autres — vous n'intervenez pas encore assez tôt.", resume: "Vous observez les signaux chez les autres mais vous n'intervenez pas avant que la situation soit très visible.", desc: "Votre observation des difficultés de vos collègues existe. Ce qui pourrait encore vous retenir d'intervenir, c'est l'hésitation à dépasser votre rôle, l'attente que quelqu'un d'autre réagisse en premier, l'espoir que la personne vienne d'elle-même. Ces hésitations font que les situations se dégradent entre le moment où vous repérez quelque chose et le moment où vous créez l'occasion d'en parler." },
          moyen: { label: "Pratiques en développement", titre: "Vous intervenez quand les signaux sont visibles — les changements discrets et progressifs moins.", resume: "Vous intervenez quand les signaux sont visibles — les signaux discrets et progressifs restent encore dans l'angle mort.", desc: "Vous intervenez quand un collègue montre des signes évidents de difficulté. Ce qui pourrait encore rester dans l'angle mort, c'est le signal discret — le retrait progressif, la légère variation de comportement, le collègue qui 'ne dit rien' mais dont quelque chose a changé. Ces signaux discrets sont ceux qui permettent d'intervenir le plus tôt, précisément parce qu'ils précèdent les signaux évidents." },
          haut: { label: "Réflexes installés", titre: "Vous créez les conditions pour que les difficultés puissent être nommées avant d'être criantes.", resume: "Vous créez des occasions de parler pour vos collègues en difficulté, avant que la situation ne soit visible de tous.", desc: "Vous repérez les changements discrets chez vos collègues et vous créez des occasions de leur parler — pas pour faire un diagnostic, mais pour signaler que vous avez remarqué et que vous êtes disponible. Cette intervention précoce — qui suppose d'aller vers la personne plutôt d'attendre qu'elle vienne — est ce qui permet d'aborder les difficultés avant qu'elles ne soient visibles de tous et difficiles à gérer." },
        },
      }, 
      {
        type: "likert",
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous arrivez à votre retour sans avoir travaillé les conditions.", resume: "Vous arrivez à votre retour sans avoir préparé le terrain — ce qui amplifie le choc de la reprise.", desc: "Votre retour pourrait encore se faire sans préparation — arriver sans avoir pris d'initiative le premier matin, attendre que le responsable vienne vous voir, ne pas avoir anticipé les zones d'ombre sur votre périmètre. Ces comportements amplifient le choc de la reprise en vous plongeant dans une situation que vous auriez pu partiellement préparer. La préparation du retour appartient aussi à la personne qui revient." },
          moyen: { label: "Pratiques en développement", titre: "Vous anticipez les grandes lignes — les sujets inconfortables restent encore non préparés.", resume: "Vous préparez votre retour dans les grandes lignes — les zones d'ombre et les points inconfortables restent encore en suspens.", desc: "Vous prenez contact avant de reprendre et vous anticipez les grandes lignes. Ce qui pourrait encore rester en suspens, ce sont les zones d'ombre et les points inconfortables — ce qui a changé pendant votre absence, votre état réel, les ajustements dont vous aurez besoin. Ces points non préparés créent des surprises lors des premiers jours que vous auriez pu anticiper." },
          haut: { label: "Réflexes installés", titre: "Vous préparez votre retour y compris sur les sujets les plus inconfortables.", resume: "Vous préparez votre retour activement, y compris sur les points inconfortables — état réel, changements, ajustements nécessaires.", desc: "Vous contactez votre responsable avant de reprendre. Vous clarifiez votre état réel et les ajustements dont vous aurez besoin. Vous anticipez ce qui a changé pendant votre absence. Cette préparation active — y compris sur les points inconfortables — est ce qui réduit le choc de la reprise et permet de définir des conditions réalistes dès le retour." },
        },
      }, 
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous attendez que le collectif fasse le premier pas.", resume: "Vous attendez que le collectif vienne à vous plutôt que de prendre l'initiative du réancrage.", desc: "Votre réancrage collectif pourrait encore reposer sur l'attente — que les collègues fassent le premier pas, que le malaise se dissipe de lui-même, que les choses reprennent naturellement. Ces comportements font que le réancrage se fait plus lentement et plus difficilement qu'il ne pourrait l'être. L'initiative du réancrage vous appartient autant qu'elle appartient à vos collègues." },
          moyen: { label: "Pratiques en développement", titre: "Vous vous réintégrez — mais négocier le rythme qui vous convient vraiment reste encore difficile.", resume: "Vous vous réintégrez correctement — vous peinez encore à négocier le rythme et les ajustements dont vous avez besoin.", desc: "Vous prenez l'initiative de réancrage et vous acceptez que les choses aient évolué. Ce qui pourrait encore être difficile, c'est la négociation du rythme qui vous convient vraiment — accepter ce qui vous convient plutôt que ce qui est attendu, nommer les ajustements dont vous avez besoin sans les minimiser. Ces négociations sont celles qui font que la reprise est durable." },
          haut: { label: "Réflexes installés", titre: "Vous prenez l'initiative du réancrage ET négociez les conditions réelles de la reprise.", resume: "Vous prenez l'initiative du réancrage collectif et vous négociez le rythme et les ajustements qui vous permettront de tenir.", desc: "Vous prenez l'initiative de remettre du lien avec vos collègues. Vous acceptez que les choses aient évolué sans vous y opposer. Vous négociez le rythme et les ajustements dont vous avez besoin pour que la reprise soit durable. Cette combinaison d'initiative relationnelle et de négociation réaliste est ce qui fait que la réintégration tient dans la durée." },
        },
      }, 
      {
        type: "likert",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "La volonté de prouver que vous êtes de retour prime encore sur le sens de la mesure.", resume: "Vous reprenez à pleine charge trop vite, par volonté de prouver que vous êtes de retour.", desc: "Votre reprise pourrait encore être influencée par la volonté de prouver que vous êtes de retour — accepter trop d'engagements dès la première semaine, vouloir tout rattraper d'un coup, tendre vers votre rythme habituel avant d'y être prêt·e. Ces comportements créent des conditions de surcharge dès la reprise qui fragilisent la durabilité du retour." },
          moyen: { label: "Pratiques en développement", titre: "Vous évitez la surcompensation brutale — les glissements progressifs vers la surcharge vous échappent encore.", resume: "Vous évitez la surcompensation évidente — les glissements progressifs vers une charge trop lourde vous échappent encore.", desc: "Vous ne vous lancez pas dans une reprise héroïque dès le premier jour. Ce qui pourrait encore vous échapper, c'est le glissement progressif — l'engagement qui s'ajoute progressivement, la charge qui remonte graduellement au-delà de ce que votre état permet. Ces glissements progressifs sont plus difficiles à détecter que la surcompensation évidente, mais leurs effets sont comparables." },
          haut: { label: "Réflexes installés", titre: "Vous calibrez votre reprise sur votre capacité — pas sur l'image que vous voulez donner.", resume: "Vous calibrez votre reprise sur votre capacité réelle et vous signalez quand ça ne tient pas.", desc: "Vous résistez au réflexe de surcompensation. Vous signalez quand la reprise est plus lourde que prévu. Vous calibrez vos engagements sur votre capacité réelle plutôt que sur ce que vous pensez devoir montrer. Cette calibration réaliste — qui suppose d'accepter de revenir progressivement plutôt qu'immédiatement — est ce qui fait que la reprise tient dans la durée." },
        },
      }, 
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Une fois que ça va mieux, la vigilance s'arrête.", resume: "Vous ignorez les signaux qui persistent après le retour en espérant qu'ils disparaissent seuls.", desc: "Les signaux persistants après votre retour pourraient encore être attribués à la fatigue normale de la reprise, sans surveillance particulière. Ce qui pourrait manquer, c'est la vigilance active — ne pas honorer le suivi médical une fois que vous vous sentez mieux, ne pas agir sur les signaux qui persistent au-delà de la période normale de réadaptation. Ces signaux persistants ont souvent une signification que l'espoir qu'ils disparaissent ne peut pas effacer." },
          moyen: { label: "Pratiques en développement", titre: "La vigilance tient les premières semaines — elle se relâche dès que vous vous sentez mieux.", resume: "Vous maintenez la vigilance les premières semaines — vous vous relâchez une fois que vous vous sentez suffisamment bien.", desc: "Vous faites le point sur votre état avec soin les premières semaines. Ce qui pourrait encore manquer, c'est la persistance de cette vigilance au-delà de la période initiale — continuer le suivi médical même quand vous vous sentez suffisamment bien, maintenir l'attention sur les signaux qui subsistent discrètement. Ces signaux discrets persistants sont précisément ceux qui méritent d'être surveillés dans la durée." },
          haut: { label: "Réflexes installés", titre: "Vous maintenez la vigilance dans la durée — pas seulement pendant le retour.", resume: "Vous maintenez la vigilance dans la durée et vous agissez sur les signaux qui persistent au-delà de la reprise.", desc: "Vous maintenez le suivi médical même quand vous vous sentez suffisamment bien. Vous prenez au sérieux les signaux qui persistent au-delà de la période normale de réadaptation. Vous ajustez les conditions de travail si quelque chose ne tient pas. Cette vigilance durable — qui suppose de ne pas considérer que 'ça va' dès que les premiers jours sont passés — est ce qui protège sur le long terme." },
        },
      }, 
      {
        type: "likert",
