    ...
    0: [
      {
        ...
        profiles: {
          ...
          haut: { label: "Réflexes installés", titre: "Vous créez les occasions pour que les signaux remontent et vous intervenez tôt", resume: "Vous ne vous contentez pas d'observer — vous créez activement les conditions pour détecter les signaux faibles, chez vous comme chez vos collègues.", desc: "Vous créez des occasions d'échange régulières qui permettent aux signaux de remonter. Vous prenez au sérieux les changements discrets, chez vos collègues comme chez vous. Vous ne normalisez pas un stress permanent au motif que tout le monde l'absorbe. Cette vigilance proactive — qui suppose d'aller vers les signaux plutôt d'attendre qu'ils s'imposent — est ce qui permet d'agir quand les situations sont encore simples." },
        },
      },
      {
        type: "choix",
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous attendez que les signaux soient évidents avant d'intervenir", resume: "Votre détection des signaux RPS attend encore que les difficultés soient visibles — les signaux précoces passent sans réaction.", desc: "Votre réaction aux signaux de difficulté existe quand la situation est évidente. Ce qui pourrait encore manquer, c'est la création active des occasions qui permettent aux signaux de remonter — un collaborateur ne viendra pas toujours vous voir spontanément. Votre rôle ne se limite pas à observer : il consiste à créer les conditions dans lesquelles les signaux peuvent vous parvenir avant qu'ils soient impossibles à ignorer." },
          moyen: { label: "Pratiques en développement", titre: "Vous repérez les signaux nets, les changements discrets vous échappent encore parfois", resume: "Vous repérez les signaux nets et faites des points réguliers — les changements discrets et progressifs créent encore des angles morts.", desc: "Vous intervenez quand les signaux sont visibles et vous maintenez des points individuels réguliers. Ce qui pourrait encore vous échapper, c'est le changement progressif et discret — la personne qui se referme légèrement, l'engagement qui diminue imperceptiblement. Ces signaux faibles sont précisément les plus précieux parce qu'ils permettent d'intervenir avant que la situation ne se soit dégradée." },
          haut: { label: "Réflexes installés", titre: "Vous créez les occasions pour que les signaux remontent et vous intervenez tôt", resume: "Vous créez les occasions pour que les signaux remontent et vous intervenez tôt, avant que les difficultés ne soient visibles.", desc: "Vous ne vous contentez pas d'observer — vous créez des occasions d'échange régulières qui permettent aux signaux de remonter avant qu'ils soient évidents. Vous intervenez sur des changements comportementaux discrets, vous revenez sur des réponses de façade. Cette posture proactive — qui suppose d'aller vers les personnes plutôt d'attendre qu'elles viennent — est ce qui permet de prévenir plutôt que de réagir." },
        },
      }, 
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas:   { label: "Repères à consolider", titre: "Vous acceptez plus que vous ne pouvez tenir, par crainte de décevoir ou de paraître peu impliqué·e", resume: "Vous acceptez plus que vous ne pouvez tenir, par crainte de décevoir ou de paraître peu impliqué·e.", desc: "Votre gestion des engagements pourrait encore être influencée par la crainte de décevoir ou de paraître peu impliqué·e — dire oui quand votre charge est déjà pleine, annoncer des délais que vous savez irréalistes. Ces comportements créent des engagements que vous ne pourrez pas tenir, ce qui déçoit précisément les personnes que vous essayiez de ne pas décevoir." },
          moyen: { label: "Pratiques en développement", titre: "Vous négociez les délais quand c'est évident, vous acceptez encore quand la pression est forte", resume: "Vous négociez les délais dans les situations évidentes — la pression hiérarchique ou relationnelle forte crée encore des acceptations difficiles.", desc: "Vous savez demander un délai supplémentaire quand c'est raisonnable. Ce qui pourrait encore créer des acceptations difficiles, c'est la pression forte — hiérarchique ou relationnelle. Dans ces situations, la négociation sur les faits — charge réelle, priorités existantes — est plus protectrice que l'acceptation qui mène à un engagement non tenu." },
          haut:  { label: "Réflexes installés", titre: "Vous négociez les délais sur les faits, pas sur votre envie de tenir ou de décevoir", resume: "Vous négociez les délais sur les faits — charge réelle, priorités existantes — pas sur votre envie de tenir ou de ne pas décevoir.", desc: "Vous annoncez des délais réalistes. Vous les renégociez quand les conditions changent. Vous ne surcompensez pas pour éviter une conversation difficile. Cette façon de gérer les engagements — qui suppose d'accepter parfois de décevoir dans le moment pour être fiable dans la durée — est ce qui crée une réputation de fiabilité réelle." },
        },
      }, 
      {
        type: "likert",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Les irritants de l'hybridation s'accumulent sans être nommés ni traités", resume: "Les irritants de l'hybridation s'accumulent sans être nommés — mauvaise qualité audio, asymétrie d'information, outils inadaptés.", desc: "Les irritants liés à votre mode de travail hybride pourraient encore s'accumuler sans être nommés — la mauvaise qualité audio en réunion, l'information qui circule d'abord au bureau avant d'arriver à distance, les outils qui fonctionnent différemment selon le contexte. Ces irritants semblent secondaires pris isolément — leur accumulation sans traitement crée une fatigue de fond qui s'installe progressivement." },
          moyen: { label: "Pratiques en développement", titre: "Vous traitez les irritants visibles, les plus discrets s'installent sans être abordés", resume: "Vous traitez les irritants visibles — les dysfonctionnements plus discrets de l'hybridation s'installent encore sans être abordés.", desc: "Vous abordez les irritants quand ils sont clairement problématiques. Ce qui pourrait encore s'installer sans être traité, c'est le dysfonctionnement plus discret — la réunion qui crée une asymétrie entre présents et distants sans que personne ne le nomme, l'outil qui ralentit sans que l'adaptation soit demandée. Ces dysfonctionnements discrets sont ceux qui dégradent progressivement la qualité du travail hybride." },
          haut: { label: "Réflexes installés", titre: "Vous traitez les irritants de l'hybridation à la source, sans les normaliser", resume: "Vous traitez les irritants de l'hybridation à la source, sans les normaliser.", desc: "Vous signalez quand la qualité audio vous empêche de suivre. Vous proposez de traiter certains sujets en mode différent quand le format actuel crée une asymétrie. Vous nommez les dysfonctionnements dès qu'ils apparaissent plutôt que de vous y adapter. Ce réflexe de traitement à la source — qui suppose de ne pas normaliser les irritants hybrides — est ce qui maintient la qualité du travail dans la durée." },
        },
      }, 
      {
        type: "choix",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous acceptez les inégalités créées par le mode de travail comme une fatalité", resume: "Vous acceptez les inégalités créées par le mode de travail comme une fatalité, sans les nommer ni chercher à les corriger.", desc: "Votre perception des inégalités liées au mode de travail pourrait encore rester sans réaction — percevoir que le présentiel favorise la progression de carrière et s'y adapter sans le nommer, observer que certains ont plus accès à l'information et s'en accommoder. Ces inégalités ne sont pas des fatalités — elles peuvent être corrigées à votre niveau dès lors qu'elles sont nommées." },
          moyen: { label: "Pratiques en développement", titre: "Vous remarquez les inégalités mais vous hésitez encore à les nommer ou à agir", resume: "Vous remarquez les inégalités créées par le mode de travail — vous hésitez encore à les nommer ou à agir.", desc: "Vous percevez les inégalités liées au mode de travail et vous les comprenez. Ce qui pourrait encore manquer, c'est le passage à l'action — nommer l'inégalité que vous observez, corriger ce qui est dans votre périmètre, remonter ce qui ne l'est pas. Ces inégalités ne se résolvent pas par la seule conscience qu'elles existent." },
          haut: { label: "Réflexes installés", titre: "Vous nommez et corrigez les inégalités créées par le mode de travail à votre niveau", resume: "Vous nommez et corrigez les inégalités créées par le mode de travail à votre niveau de responsabilité.", desc: "Vous nommez les inégalités que vous observez — accès à l'information, visibilité des contributions, opportunités selon le mode de présence. Vous corrigez ce qui est dans votre périmètre. Vous remontez ce qui ne l'est pas. Cette action sur les inégalités — qui suppose de ne pas les normaliser au motif qu'elles sont structurelles — est ce qui maintient une équité réelle dans le travail hybride." },
        },
      }, 
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous observez les signaux chez les autres mais vous n'intervenez pas avant que ce soit très visible", resume: "Vous observez les signaux chez les autres mais vous n'intervenez pas avant que la situation soit très visible.", desc: "Votre observation des difficultés de vos collègues existe. Ce qui pourrait encore vous retenir d'intervenir, c'est l'hésitation à dépasser votre rôle, l'attente que quelqu'un d'autre réagisse en premier, l'espoir que la personne vienne d'elle-même. Ces hésitations font que les situations se dégradent entre le moment où vous repérez quelque chose et le moment où vous créez l'occasion d'en parler." },
          moyen: { label: "Pratiques en développement", titre: "Vous intervenez quand les signaux sont visibles, les situations plus discrètes restent dans l'angle mort", resume: "Vous intervenez quand les signaux sont visibles — les signaux discrets et progressifs restent encore dans l'angle mort.", desc: "Vous intervenez quand un collègue montre des signes évidents de difficulté. Ce qui pourrait encore rester dans l'angle mort, c'est le signal discret — le retrait progressif, la légère variation de comportement, le collègue qui 'ne dit rien' mais dont quelque chose a changé. Ces signaux discrets sont ceux qui permettent d'intervenir le plus tôt, précisément parce qu'ils précèdent les signaux évidents." },
          haut: { label: "Réflexes installés", titre: "Vous créez des occasions de parler pour vos collègues en difficulté, avant que la situation ne soit visible de tous", resume: "Vous créez des occasions de parler pour vos collègues en difficulté, avant que la situation ne soit visible de tous.", desc: "Vous repérez les changements discrets chez vos collègues et vous créez des occasions de leur parler — pas pour faire un diagnostic, mais pour signaler que vous avez remarqué et que vous êtes disponible. Cette intervention précoce — qui suppose d'aller vers la personne plutôt d'attendre qu'elle vienne — est ce qui permet d'aborder les difficultés avant qu'elles ne soient visibles de tous et difficiles à gérer." },
        },
      }, 
      {
        type: "likert",
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous arrivez à votre retour sans avoir préparé le terrain, ce qui amplifie le choc de la reprise", resume: "Vous arrivez à votre retour sans avoir préparé le terrain — ce qui amplifie le choc de la reprise.", desc: "Votre retour pourrait encore se faire sans préparation — arriver sans avoir pris d'initiative le premier matin, attendre que le responsable vienne vous voir, ne pas avoir anticipé les zones d'ombre sur votre périmètre. Ces comportements amplifient le choc de la reprise en vous plongeant dans une situation que vous auriez pu partiellement préparer. La préparation du retour appartient aussi à la personne qui revient." },
          moyen: { label: "Pratiques en développement", titre: "Vous préparez votre retour dans les grandes lignes mais les zones d'ombre restent nombreuses", resume: "Vous préparez votre retour dans les grandes lignes — les zones d'ombre et les points inconfortables restent encore en suspens.", desc: "Vous prenez contact avant de reprendre et vous anticipez les grandes lignes. Ce qui pourrait encore rester en suspens, ce sont les zones d'ombre et les points inconfortables — ce qui a changé pendant votre absence, votre état réel, les ajustements dont vous aurez besoin. Ces points non préparés créent des surprises lors des premiers jours que vous auriez pu anticiper." },
          haut: { label: "Réflexes installés", titre: "Vous préparez votre retour activement, y compris sur les points inconfortables", resume: "Vous préparez votre retour activement, y compris sur les points inconfortables — état réel, changements, ajustements nécessaires.", desc: "Vous contactez votre responsable avant de reprendre. Vous clarifiez votre état réel et les ajustements dont vous aurez besoin. Vous anticipez ce qui a changé pendant votre absence. Cette préparation active — y compris sur les points inconfortables — est ce qui réduit le choc de la reprise et permet de définir des conditions réalistes dès le retour." },
        },
      }, 
      {
        type: "choix",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous reprenez à pleine charge trop vite, par volonté de prouver que vous êtes de retour", resume: "Vous reprenez à pleine charge trop vite, par volonté de prouver que vous êtes de retour.", desc: "Votre reprise pourrait encore être influencée par la volonté de prouver que vous êtes de retour — accepter trop d'engagements dès la première semaine, vouloir tout rattraper d'un coup, tendre vers votre rythme habituel avant d'y être prêt·e. Ces comportements créent des conditions de surcharge dès la reprise qui fragilisent la durabilité du retour." },
