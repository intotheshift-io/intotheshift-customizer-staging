    ...
    1: [
      {
        ...
        profiles: {
          ...
          moyen: { label: "Pratiques en développement", titre: "Vous préservez les ressources matérielles mais la mutualisation et les données numériques sont encore insuffisantes", resume: "Vous préservez les ressources matérielles — la mutualisation et les données numériques sont encore insuffisantes.", desc: "Vous prolongez la durée de vie de vos équipements matériels. Ce qui pourrait encore être insuffisant, c'est la mutualisation — des équipements ou ressources qui pourraient être partagés mais ne le sont pas — et la gestion des données numériques — des archives qui s'accumulent sans purge régulière." },
          haut: { label: "Réflexes installés", titre: "Vous préservez activement les ressources — mutualisation, commandes groupées, données, maintenance", resume: "Vous préservez activement les ressources — mutualisation, commandes groupées, données, maintenance.", desc: "Vous prolongez la durée de vie de vos équipements et signalez les pannes avant remplacement. Vous mutualisez ce qui peut l'être. Vous purgez régulièrement vos données inutiles. Vous participez aux commandes groupées quand c'est possible. Cette préservation active des ressources — qui suppose d'aller au-delà de la facilité du remplacement — est ce qui réduit la consommation réelle de ressources." },
        },
      },
      {
        type: "likert",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "La transition environnementale reste un sujet périphérique dans le management de votre équipe", resume: "La transition environnementale reste un sujet périphérique dans le management de votre équipe.", desc: "La transition environnementale pourrait encore rester périphérique dans votre management — traitée dans des espaces dédiés séparés du travail ordinaire, sans lien avec les objectifs de l'équipe, absente des décisions quotidiennes. Ces comportements font que la démarche est perçue comme un sujet ajouté plutôt que comme une dimension intégrée au cœur du travail." },
          moyen: { label: "Pratiques en développement", titre: "Vous intégrez l'environnement dans la gestion mais le cœur de métier et le reporting restent des angles morts", resume: "Vous intégrez l'environnement dans la gestion — le cœur de métier et le reporting restent des angles morts.", desc: "Vous intégrez l'environnement dans la gestion quotidienne de votre équipe. Ce qui pourrait encore rester des angles morts, c'est l'intégration dans le cœur de métier — adapter les pratiques métier elles-mêmes, pas seulement les comportements périphériques — et le reporting — rendre compte de l'impact environnemental avec la même rigueur que les autres indicateurs." },
          haut: { label: "Réflexes installés", titre: "L'environnement est pleinement intégré dans votre gestion — cœur de métier, reporting, innovation, objectifs", resume: "L'environnement est pleinement intégré dans votre gestion — cœur de métier, reporting, innovation, objectifs.", desc: "L'environnement est intégré dans les objectifs individuels et collectifs, dans le reporting, dans les processus du cœur de métier. Vous cherchez des opportunités d'innovation qui réduisent l'impact tout en créant de la valeur. Cette intégration pleine dans le management — qui va au-delà des programmes RSE dédiés — est ce qui crée une dynamique de transformation réelle." },
        },
      },
      {
        type: "likert",
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vos usages numériques ne tiennent pas encore compte de leur empreinte environnementale", resume: "Vos usages numériques ne tiennent pas encore compte de leur empreinte environnementale.", desc: "Vos usages numériques pourraient encore ignorer leur empreinte environnementale — streaming en haute définition par défaut, emails avec pièces jointes lourdes envoyés à des listes larges, stockage cloud sans purge régulière. Ces comportements reflètent une intégration encore partielle de l'impact numérique comme réalité environnementale concrète." },
          moyen: { label: "Pratiques en développement", titre: "Vous avez réduit les usages les plus visibles mais le streaming, l'IA et le stockage sont encore des angles morts", resume: "Vous avez réduit les usages les plus visibles — streaming, IA et stockage sont encore des angles morts.", desc: "Vous avez modifié les usages numériques les plus évidents. Ce qui pourrait encore rester des angles morts, c'est le streaming — la résolution par défaut, la mise en arrière-plan — l'IA générative — dont l'impact énergétique est significatif — et le stockage — des données accumulées sans purge régulière. Ces domaines ont souvent un impact plus important que les gestes déjà intégrés." },
          haut: { label: "Réflexes installés", titre: "Vos usages numériques intègrent systématiquement des critères de sobriété — streaming, mails, visio, stockage, IA", resume: "Vos usages numériques intègrent systématiquement des critères de sobriété — streaming, mails, visio, stockage, IA.", desc: "Votre intégration de la sobriété numérique couvre les usages visibles et ceux moins évidents. Vous limitez le streaming inutile. Vous dimensionnez vos emails et pièces jointes. Vous purgez régulièrement votre stockage. Vous questionnez l'usage de l'IA générative pour les usages non essentiels. Cette sobriété numérique systématique est ce qui crée un impact réel sur votre empreinte numérique." },
        },
      },
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vos équipements numériques sont renouvelés trop tôt et vos paramètres non optimisés", resume: "Vos équipements numériques sont renouvelés trop tôt et vos paramètres non optimisés.", desc: "Vos équipements numériques pourraient encore être renouvelés selon les cycles commerciaux plutôt que selon leur état réel — remplacer un équipement encore fonctionnel parce qu'un nouveau modèle est disponible. Ces comportements font que la consommation de ressources pour la fabrication de nouveaux équipements dépasse ce qui serait nécessaire avec une gestion sobre." },
          moyen: { label: "Pratiques en développement", titre: "Vous prolongez la durée de vie de vos équipements mais les paramètres et les choix d'outils sont encore perfectibles", resume: "Vous prolongez la durée de vie de vos équipements — les paramètres et les choix d'outils sont encore perfectibles.", desc: "Vous prolongez la durée de vie de vos équipements. Ce qui pourrait encore être perfectible, c'est l'optimisation des paramètres — luminosité, mise en veille, résolution — et les choix d'outils — préférer l'outil sobre à l'outil le plus puissant pour les usages qui ne le nécessitent pas." },
          haut: { label: "Réflexes installés", titre: "Vos équipements sont prolongés, vos paramètres optimisés et vos choix d'outils proportionnés", resume: "Vos équipements sont prolongés, vos paramètres optimisés et vos choix d'outils proportionnés.", desc: "Vous prolongez la durée de vie de vos équipements et signalez les pannes avant de remplacer. Vous optimisez les paramètres de mise en veille et de luminosité. Vous choisissez des outils proportionnés à vos besoins réels. Cette gestion sobre des équipements — qui suppose d'avoir évalué l'impact réel du renouvellement anticipé — est ce qui réduit significativement l'impact de vos équipements." },
        },
      },
      {
        type: "likert",
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vos décisions de déplacement sont guidées par la commodité sans critères environnementaux", resume: "Vos décisions de déplacement sont guidées par la commodité sans critères environnementaux.", desc: "Vos décisions de déplacement pourraient encore être guidées principalement par la commodité et les habitudes — prendre l'avion pour des trajets faisables en train, ne pas regrouper les déplacements, ne pas questionner la nécessité réelle d'un déplacement par rapport à une alternative à distance. Ces comportements font que l'impact de vos déplacements dépasse ce qui serait nécessaire." },
          moyen: { label: "Pratiques en développement", titre: "Vous privilégiez le train sur l'avion mais d'autres critères — regroupement, dernier kilomètre — sont encore insuffisants", resume: "Vous privilégiez le train sur l'avion — d'autres critères comme le regroupement et le dernier kilomètre sont encore insuffisants.", desc: "Vous choisissez le train sur l'avion pour les trajets où c'est possible. Ce qui pourrait encore être insuffisant, c'est le regroupement des déplacements — optimiser les tournées pour éviter les allers-retours — et le dernier kilomètre — choisir des modes sobres pour les trajets locaux lors de déplacements." },
          haut: { label: "Réflexes installés", titre: "Vos décisions de déplacement intègrent systématiquement les critères environnementaux — mode, regroupement, dernier kilomètre", resume: "Vos décisions de déplacement intègrent systématiquement les critères environnementaux — mode, regroupement, dernier kilomètre.", desc: "Vos décisions de déplacement évaluent systématiquement la nécessité du déplacement, le mode le moins impactant, le regroupement possible avec d'autres besoins, le dernier kilomètre. Cette intégration systématique des critères environnementaux dans les décisions de déplacement — qui suppose parfois d'accepter des contraintes supplémentaires — est ce qui crée un impact significatif sur l'un des postes les plus importants de l'empreinte professionnelle." },
        },
      },
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Votre mobilité domicile-bureau n'a pas encore été réévaluée avec des critères environnementaux", resume: "Votre mobilité domicile-bureau n'a pas encore été réévaluée avec des critères environnementaux.", desc: "Votre mobilité domicile-bureau pourrait encore reposer sur des habitudes non réévaluées — continuer à utiliser la voiture individuelle sans avoir évalué les alternatives réelles disponibles. Ces comportements reflètent une intégration encore partielle des critères environnementaux dans les choix de mobilité quotidienne, qui représente pourtant une part significative de l'empreinte carbone totale." },
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Les critères RSE sont absents ou marginaux dans vos décisions d'achat", resume: "Les critères RSE sont absents ou marginaux dans vos décisions d'achat.", desc: "Vos décisions d'achat pourraient encore ignorer les critères RSE — évaluer les fournisseurs uniquement sur le prix, la qualité et les délais, sans questionner leurs pratiques environnementales et sociales. Ces comportements font que votre organisation contribue involontairement à des pratiques qu'elle souhaite ne pas soutenir." },
          moyen: { label: "Pratiques en développement", titre: "Vous intégrez des critères RSE dans vos achats mais leur poids et l'évaluation scope 3 sont encore insuffisants", resume: "Vous intégrez des critères RSE dans vos achats — leur poids et l'évaluation scope 3 sont encore insuffisants.", desc: "Vous intégrez des critères RSE dans vos décisions d'achat. Ce qui pourrait encore être insuffisant, c'est le poids réel de ces critères dans les arbitrages finaux — accepter de choisir un fournisseur RSE plus cher, exclure des fournisseurs non conformes — et l'évaluation du scope 3 — les émissions indirectes liées à votre chaîne d'approvisionnement." },
          haut: { label: "Réflexes installés", titre: "Les critères RSE ont un poids réel dans vos décisions d'achat — scope 3, clauses contractuelles, due diligence", resume: "Les critères RSE ont un poids réel dans vos décisions d'achat — scope 3, clauses contractuelles, due diligence.", desc: "Les critères RSE influencent réellement vos décisions d'achat, y compris quand cela implique un surcoût ou l'exclusion d'un fournisseur. Vous intégrez le scope 3 dans votre évaluation. Vous incluez des clauses RSE dans vos contrats. Vous réalisez une due diligence sur les pratiques de vos fournisseurs. Cette intégration substantielle des critères RSE dans les achats est ce qui crée un impact réel sur toute la chaîne de valeur." },
        },
      },
      {
        type: "choix",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous êtes facilement découragé·e par les obstacles, le scepticisme de vos collègues ou la pression", resume: "Vous êtes facilement découragé·e par les obstacles, le scepticisme de vos collègues ou la pression.", desc: "Votre engagement pourrait encore être fragilisé par les obstacles externes — le scepticisme de collègues, les périodes de forte pression professionnelle, les situations où les efforts semblent inutiles face à l'ampleur des enjeux. Ces comportements font que l'engagement est intermittent plutôt que durable." },
          moyen: { label: "Pratiques en développement", titre: "Vous résistez au scepticisme ordinaire mais la gestion des periods difficiles et de la pression sont encore des angles morts", resume: "Vous résistez au scepticisme ordinaire — la gestion des périodes difficiles et de la pression sont encore des angles morts.", desc: "Vous résistez au scepticisme ordinaire sans vous laisser déstabiliser. Ce qui pourrait encore créer des angles morts, c'est la gestion des périodes difficiles — les moments où la charge professionnelle est très forte — et la pression plus intense — le supérieur sceptique, l'environnement qui ne soutient pas la démarche." },
          haut: { label: "Réflexes installés", titre: "Vous résistez à tous les freins — scepticisme, périodes difficiles, pression — sans vous épuiser", resume: "Vous résistez à tous les freins — scepticisme, périodes difficiles, pression — sans vous épuiser.", desc: "Vous résistez au scepticisme, aux périodes de forte pression et aux environnements peu soutenants sans vous épuiser. Vous avez développé des ressources pour maintenir votre engagement dans les conditions difficiles. Cette résilience de l'engagement — qui suppose d'avoir traité la question de la motivation personnelle et de la gestion des obstacles — est ce qui fait que votre engagement est durable." },
        },
      },
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "La dynamique RSE de votre équipe est fragile — dépend des moments forts et de votre présence", resume: "La dynamique RSE de votre équipe est fragile — dépend des moments forts et de votre présence.", desc: "La dynamique RSE de votre équipe pourrait encore être fragile — s'essouffler entre les moments collectifs forts, dépendre de votre présence et de votre énergie pour exister. Ces comportements font que la dynamique n'est pas encore autonome et ne peut pas progresser par elle-même." },
          moyen: { label: "Pratiques en développement", titre: "Votre dynamique est relativement stable mais l'ancrage, les pairs et l'ambition progressive sont encore insuffisants", resume: "Votre dynamique est relativement stable — l'ancrage, les pairs et l'ambition progressive sont encore insuffisants.", desc: "La dynamique RSE de votre équipe est relativement stable. Ce qui pourrait encore être insuffisant, c'est l'ancrage dans les pratiques quotidiennes — que la démarche continue entre les moments collectifs — la création de pairs relais — des membres de l'équipe qui portent la dynamique avec vous — et l'ambition progressive — se fixer des objectifs de progrès au-delà des acquis." },
          haut: { label: "Réflexes installés", titre: "Votre dynamique RSE est ancrée, ambitieuse et vous la faites progresser avec vos pairs", resume: "Votre dynamique RSE est ancrée, ambitieuse et vous la faites progresser avec vos pairs.", desc: "La dynamique RSE de votre équipe est ancrée dans les pratiques quotidiennes. Elle progresse vers des objectifs ambitieux. Vous la faites progresser avec vos pairs managers. Vous avez créé des relais dans l'équipe. Cette dynamique ancrée et ambitieuse — qui ne dépend plus uniquement de votre présence — est ce qui fait qu'une culture RSE d'équipe est réelle et durable." },
        },
      },
      {
        type: "likert",
