    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "L'impact environnemental de vos gestes quotidiens reste encore invisible à vos yeux.", resume: "Vos arbitrages quotidiens ne tiennent pas encore compte de leur impact environnemental.", desc: "Vos décisions quotidiennes pourraient encore être guidées principalement par la commodité et l'habitude — laisser les équipements en veille, ne pas questionner la température de chauffage, ne pas intégrer l'impact des petits gestes répétés. Ces comportements ne sont pas des erreurs — ils reflètent une intégration encore partielle de l'impact environnemental comme critère réel dans les arbitrages du quotidien." },
          moyen: { label: "Pratiques en développement", titre: "Vous faites les gestes les plus évidents — les arbitrages moins visibles restent encore peu intégrés.", resume: "Vous faites les gestes de sobriété les plus évidents — les arbitrages moins visibles sont encore peu intégrés.", desc: "Vous avez intégré les gestes les plus évidents dans votre quotidien professionnel. Ce qui pourrait encore manquer, c'est l'intégration des arbitrages moins visibles — la température de chauffage dans les espaces communs, l'impact d'une réunion en visio versus en présentiel, les équipements laissés en veille la nuit. Ces gestes moins visibles représentent souvent une part significative de l'impact quotidien." },
          haut: { label: "Réflexes installés", titre: "L'impact environnemental est un critère ordinaire dans vos arbitrages quotidiens.", resume: "Vous intégrez l'impact environnemental dans vos arbitrages quotidiens — énergie, déchets, achats, comportements.", desc: "Votre intégration de l'impact environnemental couvre les gestes évidents et les arbitrages moins visibles. Vous questionnez les habitudes installées. Vous signalez les dysfonctionnements — chauffage excessif, équipements allumés inutilement. Vous adaptez vos comportements sans attendre que les conditions soient parfaites. Cette attention quotidienne et systématique est ce qui crée un impact réel au-delà des déclarations d'intention." },
        },
      },
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "La commodité prime encore sur la sobriété dans vos choix de mobilité.", resume: "Vos choix de mobilité et de consommation sont guidés par la commodité plutôt que par la sobriété.", desc: "Vos choix de mobilité et de consommation pourraient encore être guidés principalement par la commodité et les habitudes — prendre la voiture pour des trajets courts, ne pas questionner la fréquence des voyages professionnels, ne pas intégrer les critères environnementaux dans vos choix d'alimentation. Ces comportements reflètent une intégration encore partielle de la sobriété comme critère dans les choix de vie quotidienne." },
          moyen: { label: "Pratiques en développement", titre: "Les usages simples ont été revus — mobilité et équipements restent des angles morts.", resume: "Vous avez réduit votre impact sur les usages simples — mobilité et équipements restent des angles morts.", desc: "Vous avez modifié vos comportements sur les usages les plus simples. Ce qui pourrait encore rester des angles morts, c'est la mobilité — les trajets de moyenne distance où le train est possible mais moins commode — et les équipements — le renouvellement anticipé d'appareils encore fonctionnels. Ces domaines ont souvent un impact plus important que les gestes quotidiens déjà intégrés." },
          haut: { label: "Réflexes installés", titre: "L'impact environnemental informe vos choix de mobilité, d'alimentation et d'équipements.", resume: "Vos choix de mobilité, d'alimentation et d'équipements intègrent systématiquement les critères environnementaux.", desc: "Vos choix de mobilité, d'alimentation et d'équipements tiennent compte des critères environnementaux de façon systématique. Vous prolongez la durée de vie de vos équipements. Vous choisissez le mode de transport le moins impactant quand c'est possible. Cette intégration systématique dans les choix de vie quotidienne — qui suppose d'avoir évalué l'impact réel des différentes options — est ce qui crée un impact significatif dans la durée." },
        },
      },
      {
        type: "choix",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous gérez vos déchets sans encore contribuer à améliorer les pratiques autour de vous.", resume: "Vos comportements de réduction des déchets et de signalement sont encore peu développés.", desc: "Votre contribution à la réduction des déchets et à l'amélioration des pratiques collectives pourrait encore être limitée — un tri approximatif, aucun signalement de dysfonctionnement, aucune remontée des pratiques qui pourraient être améliorées. Ces comportements font que les conditions qui permettraient de réduire l'impact collectif ne s'améliorent pas." },
          moyen: { label: "Pratiques en développement", titre: "Vous triez et signalez les problèmes évidents — les améliorations moins visibles ne remontent pas encore.", resume: "Vous triez et signalez — vous n'allez pas encore chercher les améliorations moins visibles.", desc: "Vous triez correctement et vous signalez les problèmes évidents. Ce qui pourrait encore manquer, c'est la remontée proactive des améliorations moins visibles — les consommables dont l'usage pourrait être réduit, les pratiques qui créent des déchets évitables, les alternatives qui n'ont pas encore été explorées par votre organisation." },
          haut: { label: "Réflexes installés", titre: "Vous contribuez à améliorer les pratiques autour de vous — sans attendre que les conditions soient parfaites.", resume: "Vous contribuez activement — signalement, remontées, partage de pratiques — sans attendre que les conditions soient parfaites.", desc: "Vous signalez les dysfonctionnements, vous remontez les améliorations possibles, vous partagez vos pratiques avec vos collègues. Vous ne conditionnez pas votre engagement à des conditions parfaites — infrastructure adéquate, politique organisationnelle, comportement de vos collègues. Cette contribution active et inconditionnelle est ce qui fait progresser les pratiques collectives au-delà des seuls gestes individuels." },
        },
      },
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vos gestes verts sont ponctuels — ils n'ont pas encore produit d'habitudes durables.", resume: "Vos gestes de sobriété sont ponctuels et ne s'inscrivent pas dans une démarche durable.", desc: "Vos gestes de sobriété pourraient encore être ponctuels — liés à une période de sensibilisation, à un contexte particulier — plutôt qu'inscrits dans des habitudes durables. Ces comportements font que l'impact réel reste limité : des gestes ponctuels dans un cadre de vie globalement inchangé ont un effet marginal par rapport à des habitudes ancrées dans la durée." },
          moyen: { label: "Pratiques en développement", titre: "Vos gestes sont durables sur les plus accessibles — les plus challengeants restent encore inexplorés.", resume: "Vos gestes sont relativement durables — leur périmètre reste limité aux plus faciles.", desc: "Vos gestes sont relativement durables sur les domaines que vous avez intégrés. Ce qui pourrait encore manquer, c'est l'élargissement progressif à des domaines plus challengeants — ceux qui demandent plus d'effort, qui touchent à des habitudes plus ancrées ou qui ont un impact plus important que les gestes déjà intégrés." },
          haut: { label: "Réflexes installés", titre: "Vos gestes sont durables ET vous élargissez progressivement leur périmètre.", resume: "Vos gestes sont durables, cohérents et vous les élargissez progressivement aux domaines plus challengeants.", desc: "Vos gestes de sobriété sont ancrés dans des habitudes durables. Vous les élargissez progressivement aux domaines qui demandent plus d'effort ou qui touchent à des habitudes plus profondes. Vous maintient la cohérence entre vos comportements et vos convictions. Cette progression continue — qui suppose d'accepter une inconfort croissant à mesure qu'on s'attaque aux habitudes les plus ancrées — est ce qui crée un impact cumulatif réel dans la durée." },
        },
      },
      {
        type: "likert",
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "La réduction des déchets n'est pas encore intégrée comme un critère de décision.", resume: "La réduction des déchets n'est pas encore un critère dans vos décisions et comportements quotidiens.", desc: "La réduction des déchets pourrait encore ne pas être intégrée comme critère dans vos décisions quotidiennes — imprimer par défaut, utiliser des consommables jetables par commodité, ne pas questionner l'accumulation de déchets numériques. Ces comportements reflètent une intégration encore partielle de la réduction des déchets comme critère réel dans les comportements professionnels." },
          moyen: { label: "Pratiques en développement", titre: "Les déchets évidents sont traités — le numérique et les achats restent des angles morts.", resume: "Vous réduisez les déchets évidents — les déchets numériques et les achats restent des angles morts.", desc: "Vous avez intégré la réduction des déchets sur les usages les plus visibles. Ce qui pourrait encore rester des angles morts, c'est la dimension numérique — la masse de données stockées inutilement, les emails archivés par défaut sans purge régulière — et les décisions d'achat — choisir le produit jetable parce qu'il est moins cher à l'achat." },
          haut: { label: "Réflexes installés", titre: "Vous évaluez l'impact déchet avant de décider — pas après.", resume: "La réduction des déchets est intégrée dans vos décisions quotidiennes — réemploi, numérique, achats, consommables.", desc: "Votre intégration de la réduction des déchets couvre les usages visibles et les dimensions moins évidentes — déchets numériques, durée de vie des équipements, choix de consommables. Vous privilégiez le réemploi sur le remplacement quand c'est possible. Vous questionnez les achats dont la fin de vie créera des déchets évitables. Cette approche systématique est ce qui crée un impact réel au-delà des gestes symboliques." },
        },
      },
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vos ressources sont consommées sans évaluation de la nécessité.", resume: "La préservation des ressources matérielles et numériques n'est pas encore intégrée dans vos pratiques.", desc: "La préservation des ressources pourrait encore ne pas être intégrée dans vos pratiques — renouveler les équipements dès les premiers signes de ralentissement, ne pas mutualiser ce qui pourrait l'être, accumuler des données sans purge régulière. Ces comportements font que des ressources sont consommées au-delà du nécessaire." },
          moyen: { label: "Pratiques en développement", titre: "Les ressources matérielles sont préservées — mutualisation et données numériques sont encore insuffisantes.", resume: "Vous préservez les ressources matérielles — la mutualisation et les données numériques sont encore insuffisantes.", desc: "Vous prolongez la durée de vie de vos équipements matériels. Ce qui pourrait encore être insuffisant, c'est la mutualisation — des équipements ou ressources qui pourraient être partagés mais ne le sont pas — et la gestion des données numériques — des archives qui s'accumulent sans purge régulière." },
          haut: { label: "Réflexes installés", titre: "Vous préservez activement vos ressources — matérielles, numériques, partagées.", resume: "Vous préservez activement les ressources — mutualisation, commandes groupées, données, maintenance.", desc: "Vous prolongez la durée de vie de vos équipements et signalez les pannes avant remplacement. Vous mutualisez ce qui peut l'être. Vous purgez régulièrement vos données inutiles. Vous participez aux commandes groupées quand c'est possible. Cette préservation active des ressources — qui suppose d'aller au-delà de la facilité du remplacement — est ce qui réduit la consommation réelle de ressources." },
        },
      },
      {
        type: "likert",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Votre contribution à la réduction des déchets s'arrête à votre périmètre individuel.", resume: "Vous ne cherchez pas encore à valoriser les matériaux en fin de vie ni à influencer les pratiques collectives.", desc: "Votre contribution à la valorisation des déchets et à l'évolution des pratiques collectives pourrait encore être limitée — ne pas connaître les filières de valorisation disponibles, ne pas participer aux initiatives collectives de réduction, ne pas chercher à influencer les pratiques de vos prestataires. Ces comportements font que votre impact reste limité à votre périmètre individuel." },
          moyen: { label: "Pratiques en développement", titre: "Vous valorisez en fin de projet — l'influence sur les pratiques collectives est encore limitée.", resume: "Vous valorisez en fin de projet — l'influence sur les pratiques collectives et les prestataires est encore limitée.", desc: "Vous traitez correctement les déchets en fin de projet. Ce qui pourrait encore être limité, c'est l'influence sur les pratiques collectives — participer aux initiatives de réduction, challenger les pratiques de vos prestataires, proposer des améliorations aux processus qui génèrent des déchets évitables." },
          haut: { label: "Réflexes installés", titre: "Vous contribuez à la réduction collective — au-delà de votre seul périmètre.", resume: "Vous contribuez à la réduction collective — valorisation fin de projet, prestataires, remontées.", desc: "Vous valorisez les matériaux en fin de projet en utilisant les filières disponibles. Vous challengez les pratiques de vos prestataires. Vous remontez les améliorations possibles dans les processus de votre organisation. Cette contribution collective — qui va au-delà de votre gestion individuelle des déchets — est ce qui crée un impact au niveau de l'organisation." },
        },
      },
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Votre engagement sur les déchets reste encore ponctuel et non ancré.", resume: "Votre engagement dans la réduction des déchets est ponctuel et non durable.", desc: "Votre engagement dans la réduction des déchets pourrait encore être ponctuel — lié à des moments de sensibilisation spécifiques — plutôt qu'ancré dans des pratiques durables. Ces comportements font que l'impact réel reste marginal : des gestes ponctuels dans des pratiques globalement inchangées ont peu d'effet cumulatif." },
          moyen: { label: "Pratiques en développement", titre: "Vos pratiques sont relativement durables — mais leur périmètre et leur contribution systémique restent insuffisants.", resume: "Vos engagements sont relativement durables — leur périmètre et votre contribution aux obstacles structurels sont insuffisants.", desc: "Vos pratiques de réduction des déchets sont relativement durables sur les domaines que vous avez intégrés. Ce qui pourrait encore manquer, c'est l'élargissement progressif et la contribution aux obstacles structurels — signaler ce qui empêche une réduction plus significative, remonter les besoins d'infrastructure." },
          haut: { label: "Réflexes installés", titre: "Votre engagement est durable, mesuré et contribue à faire évoluer le système.", resume: "Votre engagement est durable, mesuré et vous contribuez à lever les obstacles structurels.", desc: "Vos pratiques de réduction des déchets sont durables et mesurables. Vous contribuez à lever les obstacles structurels — en remontant les besoins d'infrastructure, en signalant les processus générateurs de déchets évitables. Cette combinaison d'engagement personnel durable et de contribution systémique est ce qui crée un impact au-delà de votre périmètre individuel." },
        },
      },
      {
        type: "likert",
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Le prix et la commodité guident encore vos achats — pas l'impact.", resume: "Vos décisions d'achat sont guidées par le prix et la commodité, sans critères environnementaux.", desc: "Vos décisions d'achat pourraient encore être guidées principalement par le prix et la commodité — choisir le fournisseur le moins cher sans questionner ses pratiques, renouveler les équipements selon les cycles commerciaux plutôt que selon l'état réel. Ces comportements font que les achats ne contribuent pas à réduire l'impact environnemental de votre organisation." },
          moyen: { label: "Pratiques en développement", titre: "Certains critères RSE sont intégrés — mais leur poids dans les arbitrages est encore insuffisant.", resume: "Vous intégrez certains critères RSE dans vos achats — les critères locaux, durée de vie et reconditionné sont encore insuffisants.", desc: "Vous intégrez certains critères RSE dans vos décisions d'achat. Ce qui pourrait encore être insuffisant, c'est le poids réel de ces critères dans les arbitrages — choisir un fournisseur local légèrement plus cher, opter pour du matériel reconditionné, évaluer la durée de vie totale plutôt que le prix d'achat. Ces critères exigent parfois d'accepter un surcoût apparent à court terme." },
          haut: { label: "Réflexes installés", titre: "Vos achats évaluent le coût complet — pas seulement le prix affiché.", resume: "Vos décisions d'achat intègrent systématiquement les critères environnementaux — local, durée de vie, reconditionné, RSE fournisseur.", desc: "Vos décisions d'achat évaluent le coût total sur la durée de vie, pas seulement le prix d'achat. Vous privilégiez le reconditionné et le local quand c'est possible. Vous questionnez les pratiques RSE de vos fournisseurs. Cette intégration systématique des critères environnementaux dans les achats — qui suppose d'accepter parfois un surcoût apparent — est ce qui crée un impact réel sur toute la chaîne de valeur." },
        },
      },
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "L'usage de vos ressources n'est pas encore calibré sur les besoins réels.", resume: "L'usage de vos ressources n'intègre pas encore les critères de sobriété et de durabilité.", desc: "L'usage de vos ressources pourrait encore ne pas intégrer les critères de sobriété — utiliser les équipements au maximum des performances par défaut, ne pas questionner la nécessité réelle de certains usages, ne pas traiter correctement les fins de vie. Ces comportements font que des ressources sont consommées au-delà de ce qui est nécessaire." },
          moyen: { label: "Pratiques en développement", titre: "Vous adaptez vos usages — mais l'évaluation des coûts complets et les fins de vie restent des angles morts.", resume: "Vous adaptez vos usages — l'évaluation des coûts complets et les fins de vie sont encore des angles morts.", desc: "Vous adaptez vos usages à vos besoins réels dans la plupart des cas. Ce qui pourrait encore rester des angles morts, c'est l'évaluation des coûts complets — inclure l'impact environnemental dans l'évaluation du coût total — et le traitement des fins de vie — s'assurer que les équipements en fin de vie sont traités via les filières appropriées." },
          haut: { label: "Réflexes installés", titre: "Vous calibrez vos usages sur ce dont vous avez besoin — pas sur ce qui est disponible.", resume: "Vous adaptez vos usages aux besoins réels et traitez les fins de vie correctement.", desc: "Vous calibrez vos usages sur vos besoins réels plutôt que sur les capacités maximales. Vous évaluez les coûts complets en incluant l'impact environnemental. Vous traitez les fins de vie via les filières appropriées. Cette gestion sobre et complète du cycle de vie des ressources est ce qui réduit l'impact environnemental réel de vos achats." },
        },
      },
      {
        type: "likert",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Votre relation fournisseurs est commerciale — elle ne touche pas encore les pratiques.", resume: "Votre relation avec les fournisseurs est transactionnelle — sans dimension environnementale.", desc: "Votre relation avec les fournisseurs pourrait encore être exclusivement transactionnelle — évaluer le prix et la qualité sans questionner les pratiques environnementales, ne pas utiliser la relation commerciale pour influencer les pratiques. Ces comportements font que votre organisation ne contribue pas à faire progresser les pratiques de sa chaîne d'approvisionnement." },
          moyen: { label: "Pratiques en développement", titre: "Vous dialoguez sur l'environnement avec vos fournisseurs — votre influence active reste encore limitée.", resume: "Vous dialoguez avec vos fournisseurs sur l'environnement — votre influence active est encore limitée.", desc: "Vous abordez les sujets environnementaux avec vos fournisseurs. Ce qui pourrait encore être limité, c'est l'influence active — inclure des critères RSE dans les contrats, conditionner les renouvellements à des progrès mesurables, partager vos propres pratiques pour créer une dynamique d'amélioration mutuelle." },
          haut: { label: "Réflexes installés", titre: "Vous utilisez votre relation commerciale pour faire progresser les pratiques de vos fournisseurs.", resume: "Vous utilisez activement votre relation fournisseurs pour améliorer les pratiques et inclure les critères RSE dans les contrats.", desc: "Vous incluez des critères RSE dans vos contrats fournisseurs. Vous conditionner les renouvellements à des progrès mesurables. Vous partagez vos pratiques pour créer une dynamique d'amélioration mutuelle. Cette utilisation active de la relation commerciale comme levier d'amélioration des pratiques — qui suppose d'accepter parfois une complexité supplémentaire dans la gestion des fournisseurs — est ce qui crée un impact au-delà de votre organisation." },
        },
      },
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vos achats responsables sont ponctuels — ils n'ont pas encore structuré une pratique.", resume: "Vos achats responsables sont ponctuels et ne s'inscrivent pas dans une démarche durable.", desc: "Vos achats responsables pourraient encore être ponctuels — liés à des projets spécifiques ou à des moments de sensibilisation — plutôt qu'inscrits dans une démarche structurée et durable. Ces comportements font que les progrès ne s'accumulent pas et que les bonnes pratiques ne se diffusent pas." },
          moyen: { label: "Pratiques en développement", titre: "Votre pratique est relativement durable — mais elle ne contribue pas encore à diffuser ou à faire évoluer.", resume: "Vos pratiques sont relativement durables — votre contribution systémique est encore insuffisante.", desc: "Vos pratiques d'achats responsables sont relativement durables sur les domaines que vous avez intégrés. Ce qui pourrait encore manquer, c'est la contribution systémique — documenter vos apprentissages, partager les bonnes pratiques, contribuer à l'évolution des politiques d'achat de votre organisation." },
          haut: { label: "Réflexes installés", titre: "Votre pratique est durable — et vous en faites bénéficier l'organisation.", resume: "Vos achats responsables sont durables, documentés et vous contribuez à diffuser les bonnes pratiques.", desc: "Vos pratiques d'achats responsables sont structurées et durables. Vous documentez vos apprentissages. Vous partagez les bonnes pratiques avec vos collègues. Vous contribuez à l'évolution des politiques d'achat de votre organisation. Cette combinaison de pratiques durables et de contribution à la diffusion est ce qui crée un impact systémique au-delà de votre périmètre." },
        },
      },
      {
        type: "likert",
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous demandez à votre équipe une exemplarité que vous n'incarnez pas encore.", resume: "Votre exemplarité et votre posture de management de la transition environnementale sont encore peu développées.", desc: "Votre management de la transition environnementale pourrait encore manquer d'exemplarité et de posture claire — ne pas incarner vous-même les comportements que vous demandez, gérer les résistances en imposant plutôt qu'en convainquant. Ces comportements limitent votre capacité à embarquer votre équipe dans une démarche durable." },
          moyen: { label: "Pratiques en développement", titre: "Vous incarnez la transition — mais gérer les résistances et l'ancrer dans les processus reste insuffisant.", resume: "Vous incarnez la transition — la gestion des résistances et l'ancrage structurel sont encore insuffisants.", desc: "Vous incarnez la transition dans vos propres comportements. Ce qui pourrait encore être insuffisant, c'est la gestion des résistances — répondre aux sceptiques avec des arguments plutôt qu'avec des injonctions — et l'ancrage structurel — intégrer les critères environnementaux dans les processus de l'équipe pour que la démarche ne dépende pas uniquement de votre présence." },
          haut: { label: "Réflexes installés", titre: "Vous incarnez, convainquez et ancrez — vous ne vous contentez pas de demander.", resume: "Vous incarnez la transition et gérez les résistances avec une approche ancrée dans les processus collectifs.", desc: "Vous incarnez la transition dans vos comportements et vos décisions. Vous gérez les résistances avec des arguments plutôt qu'avec des injonctions. Vous ancrez la démarche dans les processus collectifs pour qu'elle ne dépende pas uniquement de votre présence. Cette combinaison d'exemplarité, de pédagogie et d'ancrage structurel est ce qui crée une dynamique durable dans votre équipe." },
        },
      },
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Votre équipe manque des conditions structurelles pour s'engager dans la transition.", resume: "Vous n'avez pas encore développé les compétences ni créé les conditions pour que la transition se fasse dans votre équipe.", desc: "Votre équipe pourrait encore manquer des compétences et des conditions nécessaires pour s'engager dans la transition — formation insuffisante, absence de temps alloué, indicateurs absents. Ces lacunes font que même les collaborateurs motivés ne disposent pas des ressources pour s'engager concrètement." },
          moyen: { label: "Pratiques en développement", titre: "Vous créez des conditions — mais la mesure et la formation sont encore perfectibles.", resume: "Vous créez des conditions pour la transition — la mesure d'impact et la formation de l'équipe sont encore perfectibles.", desc: "Vous créez les conditions pour que votre équipe s'engage dans la transition. Ce qui pourrait encore être perfectible, c'est la mesure d'impact — avoir des indicateurs concrets qui permettent à l'équipe de voir les progrès — et la formation — s'assurer que chaque membre dispose des compétences nécessaires pour agir efficacement." },
          haut: { label: "Réflexes installés", titre: "Vous avez créé les conditions pour que l'engagement de votre équipe tienne sans vous.", resume: "Vous avez créé les conditions structurelles — formation, mesure, dynamique, recrutement — pour que la transition tienne.", desc: "Vous avez développé les compétences de votre équipe sur les sujets environnementaux. Vous avez mis en place des indicateurs de mesure d'impact. Vous avez créé une dynamique collective. Vous intégrez les critères environnementaux dans le recrutement. Ces conditions structurelles — qui supposent un investissement managérial significatif — sont ce qui fait que la transition tient indépendamment des individus." },
        },
      },
      {
        type: "likert",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "La transition environnementale s'ajoute à votre management — elle n'y est pas encore intégrée.", resume: "La transition environnementale reste un sujet périphérique dans le management de votre équipe.", desc: "La transition environnementale pourrait encore rester périphérique dans votre management — traitée dans des espaces dédiés séparés du travail ordinaire, sans lien avec les objectifs de l'équipe, absente des décisions quotidiennes. Ces comportements font que la démarche est perçue comme un sujet ajouté plutôt que comme une dimension intégrée au cœur du travail." },
          moyen: { label: "Pratiques en développement", titre: "Vous intégrez l'environnement dans votre gestion — mais le cœur de métier et le reporting restent des angles morts.", resume: "Vous intégrez l'environnement dans la gestion — le cœur de métier et le reporting restent des angles morts.", desc: "Vous intégrez l'environnement dans la gestion quotidienne de votre équipe. Ce qui pourrait encore rester des angles morts, c'est l'intégration dans le cœur de métier — adapter les pratiques métier elles-mêmes, pas seulement les comportements périphériques — et le reporting — rendre compte de l'impact environnemental avec la même rigueur que les autres indicateurs." },
          haut: { label: "Réflexes installés", titre: "L'environnement est une dimension ordinaire de votre management — pas un sujet ajouté.", resume: "L'environnement est pleinement intégré dans votre gestion — cœur de métier, reporting, innovation, objectifs.", desc: "L'environnement est intégré dans les objectifs individuels et collectifs, dans le reporting, dans les processus du cœur de métier. Vous cherchez des opportunités d'innovation qui réduisent l'impact tout en créant de la valeur. Cette intégration pleine dans le management — qui va au-delà des programmes RSE dédiés — est ce qui crée une dynamique de transformation réelle." },
        },
      },
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "La culture environnementale de votre équipe repose sur l'obligation — pas sur la conviction.", resume: "La culture environnementale de votre équipe ne tient que par l'obligation et non par la conviction.", desc: "La culture environnementale de votre équipe pourrait encore reposer principalement sur l'obligation — respecter les règles existantes sans les dépasser, s'engager parce que c'est demandé plutôt que parce que c'est compris. Ces comportements font que la dynamique s'arrête aux minimums requis et ne progresse pas quand la pression externe se relâche." },
          moyen: { label: "Pratiques en développement", titre: "La culture est en construction — mais le passage de l'obligation à la conviction est encore insuffisant.", resume: "Votre culture est en construction — la conviction remplaçant l'obligation et l'ambition au-delà des minimums sont encore insuffisantes.", desc: "Votre équipe développe progressivement une culture environnementale. Ce qui pourrait encore manquer, c'est le passage de l'obligation à la conviction — que les membres de l'équipe s'engagent parce qu'ils comprennent et adhèrent — et l'ambition au-delà des minimums requis." },
          haut: { label: "Réflexes installés", titre: "Votre équipe s'engage par conviction — et célèbre ses progrès.", resume: "Votre équipe est engagée par conviction, célèbre ses progrès et vous partagez vos approches avec vos pairs.", desc: "Votre équipe s'engage par conviction, pas seulement par obligation. Elle célèbre ses progrès et se fixe des ambitions au-delà des minimums. Vous partagez vos approches avec vos pairs managers. Cette culture d'engagement authentique — qui suppose un investissement managérial pour créer la compréhension et l'adhésion — est ce qui crée une dynamique durable au-delà des contraintes." },
        },
      },
      {
        type: "likert",
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vos usages numériques n'ont pas encore été évalués sous l'angle de leur empreinte.", resume: "Vos usages numériques ne tiennent pas encore compte de leur empreinte environnementale.", desc: "Vos usages numériques pourraient encore ignorer leur empreinte environnementale — streaming en haute définition par défaut, emails avec pièces jointes lourdes envoyés à des listes larges, stockage cloud sans purge régulière. Ces comportements reflètent une intégration encore partielle de l'impact numérique comme réalité environnementale concrète." },
          moyen: { label: "Pratiques en développement", titre: "Les usages les plus évidents ont été revus — streaming, IA et stockage restent encore des angles morts.", resume: "Vous avez réduit les usages les plus visibles — streaming, IA et stockage sont encore des angles morts.", desc: "Vous avez modifié les usages numériques les plus évidents. Ce qui pourrait encore rester des angles morts, c'est le streaming — la résolution par défaut, la mise en arrière-plan — l'IA générative — dont l'impact énergétique est significatif — et le stockage — des données accumulées sans purge régulière. Ces domaines ont souvent un impact plus important que les gestes déjà intégrés." },
          haut: { label: "Réflexes installés", titre: "Votre sobriété numérique couvre le visible et les usages moins évidents.", resume: "Vos usages numériques intègrent systématiquement des critères de sobriété — streaming, mails, visio, stockage, IA.", desc: "Votre intégration de la sobriété numérique couvre les usages visibles et ceux moins évidents. Vous limitez le streaming inutile. Vous dimensionnez vos emails et pièces jointes. Vous purgez régulièrement votre stockage. Vous questionnez l'usage de l'IA générative pour les usages non essentiels. Cette sobriété numérique systématique est ce qui crée un impact réel sur votre empreinte numérique." },
        },
      },
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vos équipements sont renouvelés par habitude — pas par nécessité.", resume: "Vos équipements numériques sont renouvelés trop tôt et vos paramètres non optimisés.", desc: "Vos équipements numériques pourraient encore être renouvelés selon les cycles commerciaux plutôt que selon leur état réel — remplacer un équipement encore fonctionnel parce qu'un nouveau modèle est disponible. Ces comportements font que la consommation de ressources pour la fabrication de nouveaux équipements dépasse ce qui serait nécessaire avec une gestion sobre." },
          moyen: { label: "Pratiques en développement", titre: "Vous prolongez la durée de vie de vos équipements — les paramètres et choix d'outils sont encore perfectibles.", resume: "Vous prolongez la durée de vie de vos équipements — les paramètres et les choix d'outils sont encore perfectibles.", desc: "Vous prolongez la durée de vie de vos équipements. Ce qui pourrait encore être perfectible, c'est l'optimisation des paramètres — luminosité, mise en veille, résolution — et les choix d'outils — préférer l'outil sobre à l'outil le plus puissant pour les usages qui ne le nécessitent pas." },
          haut: { label: "Réflexes installés", titre: "Vous prolongez, optimisez et choisissez des outils proportionnés à vos besoins.", resume: "Vos équipements sont prolongés, vos paramètres optimisés et vos choix d'outils proportionnés.", desc: "Vous prolongez la durée de vie de vos équipements et signalez les pannes avant de remplacer. Vous optimisez les paramètres de mise en veille et de luminosité. Vous choisissez des outils proportionnés à vos besoins réels. Cette gestion sobre des équipements — qui suppose d'avoir évalué l'impact réel du renouvellement anticipé — est ce qui réduit significativement l'impact de vos équipements." },
        },
      },
      {
        type: "likert",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Votre sobriété numérique est individuelle — elle ne contribue pas encore au collectif.", resume: "Vous ne partagez pas encore vos pratiques et ne contribuez pas à l'évolution des outils de l'organisation.", desc: "Votre contribution à la sobriété numérique collective pourrait encore être limitée à votre périmètre individuel — sans partage de pratiques avec vos collègues, sans contribution à l'évolution des outils ou des politiques numériques de votre organisation. Ces comportements font que votre impact reste individuel." },
          moyen: { label: "Pratiques en développement", titre: "Vous partagez vos pratiques — mais votre contribution systémique reste encore insuffisante.", resume: "Vous partagez vos pratiques — la contribution systémique est encore insuffisante.", desc: "Vous partagez vos pratiques de sobriété numérique avec vos collègues. Ce qui pourrait encore être insuffisant, c'est la contribution systémique — participer à l'évolution des infrastructures numériques de l'organisation, remontée des usages inutilement consommateurs, contribution aux choix d'outils." },
          haut: { label: "Réflexes installés", titre: "Vous contribuez à la sobriété numérique de votre organisation — pas seulement à la vôtre.", resume: "Vous contribuez activement — partage, infrastructure, remontées, sobriété des services développés.", desc: "Vous partagez vos pratiques, vous contribuez aux décisions d'infrastructure numérique, vous remontez les usages inutilement consommateurs. Si vous développez des services numériques, vous intégrez la sobriété dans leur conception. Cette contribution systémique — qui va au-delà de votre usage individuel — est ce qui crée un impact à l'échelle de l'organisation." },
        },
      },
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vos gestes de sobriété numérique ne résistent pas à la durée.", resume: "Vos gestes de sobriété numérique sont ponctuels et il y a un décalage entre vos usages et vos discours.", desc: "Vos gestes de sobriété numérique pourraient encore être ponctuels, créant un décalage entre ce que vous exprimez comme convictions et vos usages réels. Ces comportements réduisent à la fois l'impact réel et la crédibilité de votre engagement — il est difficile d'embarquer des collègues dans une démarche qu'on ne pratique pas soi-même de façon cohérente." },
          moyen: { label: "Pratiques en développement", titre: "Vos gestes sont relativement durables — mais la cohérence entre discours et usages reste insuffisante.", resume: "Vos gestes sont relativement durables — la cohérence discours-usages et le suivi sont encore insuffisants.", desc: "Vos pratiques de sobriété numérique sont relativement durables. Ce qui pourrait encore manquer, c'est la cohérence complète entre vos discours et vos usages — les situations où vous utilisez des outils ou des pratiques qui contredisent ce que vous défendez par ailleurs — et le suivi de votre empreinte numérique." },
          haut: { label: "Réflexes installés", titre: "Votre sobriété numérique est durable, cohérente et vous en accompagnez les autres.", resume: "Votre sobriété numérique est durable, cohérente et vous l'accompagnez chez vos collègues.", desc: "Vos pratiques de sobriété numérique sont durables et cohérentes avec vos discours. Vous mesurez ou estimez votre empreinte numérique. Vous accompagnez vos collègues qui souhaitent réduire leur empreinte. Cette cohérence entre convictions et pratiques — qui crée la crédibilité nécessaire pour embarquer les autres — est ce qui fait de votre engagement une ressource pour la dynamique collective." },
        },
      },
      {
        type: "likert",
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "La commodité guide encore vos décisions de déplacement — pas l'impact.", resume: "Vos décisions de déplacement sont guidées par la commodité sans critères environnementaux.", desc: "Vos décisions de déplacement pourraient encore être guidées principalement par la commodité et les habitudes — prendre l'avion pour des trajets faisables en train, ne pas regrouper les déplacements, ne pas questionner la nécessité réelle d'un déplacement par rapport à une alternative à distance. Ces comportements font que l'impact de vos déplacements dépasse ce qui serait nécessaire." },
          moyen: { label: "Pratiques en développement", titre: "Le mode principal est choisi avec soin — les critères de regroupement et de dernier kilomètre restent insuffisants.", resume: "Vous privilégiez le train sur l'avion — d'autres critères comme le regroupement et le dernier kilomètre sont encore insuffisants.", desc: "Vous choisissez le train sur l'avion pour les trajets où c'est possible. Ce qui pourrait encore être insuffisant, c'est le regroupement des déplacements — optimiser les tournées pour éviter les allers-retours — et le dernier kilomètre — choisir des modes sobres pour les trajets locaux lors de déplacements." },
          haut: { label: "Réflexes installés", titre: "Chaque décision de déplacement intègre son impact — mode, regroupement, dernier kilomètre.", resume: "Vos décisions de déplacement intègrent systématiquement les critères environnementaux — mode, regroupement, dernier kilomètre.", desc: "Vos décisions de déplacement évaluent systématiquement la nécessité du déplacement, le mode le moins impactant, le regroupement possible avec d'autres besoins, le dernier kilomètre. Cette intégration systématique des critères environnementaux dans les décisions de déplacement — qui suppose parfois d'accepter des contraintes supplémentaires — est ce qui crée un impact significatif sur l'un des postes les plus importants de l'empreinte professionnelle." },
        },
      },
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Votre mobilité quotidienne n'a pas encore été réévaluée sous l'angle de l'impact.", resume: "Votre mobilité domicile-bureau n'a pas encore été réévaluée avec des critères environnementaux.", desc: "Votre mobilité domicile-bureau pourrait encore reposer sur des habitudes non réévaluées — continuer à utiliser la voiture individuelle sans avoir évalué les alternatives réelles disponibles. Ces comportements reflètent une intégration encore partielle des critères environnementaux dans les choix de mobilité quotidienne, qui représente pourtant une part significative de l'empreinte carbone totale." },
          moyen: { label: "Pratiques en développement", titre: "Vous avez évalué des alternatives — leur adoption est encore partielle.", resume: "Vous avez évalué des alternatives pour le domicile-bureau — leur adoption est encore partielle.", desc: "Vous avez évalué les alternatives disponibles pour votre trajet domicile-bureau. Ce qui pourrait encore être partiel, c'est l'adoption de ces alternatives — les contraintes réelles existent, mais certaines pourraient être surmontées avec les incitations disponibles ou une organisation légèrement différente." },
          haut: { label: "Réflexes installés", titre: "Votre mobilité domicile-bureau est réévaluée et ajustée.", resume: "Votre mobilité domicile-bureau a été réévaluée et vous utilisez les incitations disponibles.", desc: "Vous avez réévalué votre mobilité domicile-bureau et adopté les alternatives disponibles — transports en commun, vélo, covoiturage, télétravail. Vous utilisez les incitations disponibles dans votre organisation. Cette réévaluation active de la mobilité quotidienne — qui représente souvent le poste le plus important de l'empreinte carbone individuelle — est ce qui crée un impact substantiel dans la durée." },
        },
      },
      {
        type: "likert",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous ne questionnez pas encore les habitudes de déplacement autour de vous.", resume: "Vous ne questionnez pas les habitudes de déplacement et ne proposez pas d'alternatives.", desc: "Votre contribution à l'évolution des habitudes de déplacement collectives pourrait encore être limitée — ne pas questionner l'organisation d'une réunion qui nécessite des déplacements évitables, ne pas proposer des alternatives à distance, ne pas partager vos retours d'expérience sur les modes de déplacement sobres." },
          moyen: { label: "Pratiques en développement", titre: "Vous questionnez dans votre périmètre — votre contribution systémique reste encore limitée.", resume: "Vous questionnez les déplacements dans votre périmètre — la contribution systémique est encore limitée.", desc: "Vous questionnez les décisions de déplacement dans votre périmètre direct. Ce qui pourrait encore être limité, c'est la contribution systémique — proposer des alternatives dans les décisions collectives, partager vos retours d'expérience sur les modes sobres, contribuer à l'évolution des politiques de déplacement de votre organisation." },
          haut: { label: "Réflexes installés", titre: "Vous questionnez, proposez des alternatives et partagez vos retours.", resume: "Vous questionnez les habitudes de déplacement, proposez des alternatives et partagez vos retours d'expérience.", desc: "Vous proposez des alternatives de déplacement dans les décisions collectives. Vous partagez vos retours d'expérience sur les modes sobres. Vous contribuez à l'évolution des politiques de déplacement. Cette contribution systémique — qui va au-delà de vos propres décisions de déplacement — est ce qui crée un impact à l'échelle de votre organisation." },
        },
      },
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vos pratiques de sobriété dans les déplacements ne tiennent pas dans la durée.", resume: "Vos pratiques de réduction des déplacements sont ponctuelles et sans ancrage durable.", desc: "Vos pratiques de réduction des déplacements pourraient encore être ponctuelles — liées à des périodes de sensibilisation ou à des contraintes externes — plutôt qu'ancrées dans des habitudes durables. Ces comportements font que l'impact réel reste limité et que les apprentissages des périodes de forte contrainte se perdent." },
          moyen: { label: "Pratiques en développement", titre: "Vos pratiques sont relativement durables — l'ancrage des apprentissages et la mesure restent insuffisants.", resume: "Vos pratiques sont relativement durables — l'ancrage des apprentissages et la mesure sont encore insuffisants.", desc: "Vos pratiques de réduction des déplacements sont relativement durables. Ce qui pourrait encore manquer, c'est l'ancrage des apprentissages — maintenir les alternatives découvertes pendant les périodes de contrainte — et la mesure — suivre l'évolution de votre empreinte déplacement pour rendre les progrès visibles." },
          haut: { label: "Réflexes installés", titre: "Vos pratiques sont durables — et vous maintenez les acquis des périodes de contrainte.", resume: "Vos pratiques sont durables, ancrées et vous maintenez les apprentissages de la période de forte visioconférence.", desc: "Vos pratiques de sobriété dans les déplacements sont durables et ancrées. Vous avez maintenu les apprentissages des périodes de forte visioconférence. Vous mesurez ou estimez l'évolution de votre empreinte déplacement. Cette durabilité et cet ancrage des apprentissages — qui suppose d'avoir résisté au retour aux habitudes d'avant — est ce qui crée un impact cumulatif significatif." },
        },
      },
      {
        type: "likert",
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "La performance commerciale guide encore vos achats — les pratiques RSE des fournisseurs pas encore.", resume: "Les critères RSE sont absents ou marginaux dans vos décisions d'achat.", desc: "Vos décisions d'achat pourraient encore ignorer les critères RSE — évaluer les fournisseurs uniquement sur le prix, la qualité et les délais, sans questionner leurs pratiques environnementales et sociales. Ces comportements font que votre organisation contribue involontairement à des pratiques qu'elle souhaite ne pas soutenir." },
          moyen: { label: "Pratiques en développement", titre: "Des critères RSE sont présents — mais leur poids et l'évaluation scope 3 sont encore insuffisants.", resume: "Vous intégrez des critères RSE dans vos achats — leur poids et l'évaluation scope 3 sont encore insuffisants.", desc: "Vous intégrez des critères RSE dans vos décisions d'achat. Ce qui pourrait encore être insuffisant, c'est le poids réel de ces critères dans les arbitrages finaux — accepter de choisir un fournisseur RSE plus cher, exclure des fournisseurs non conformes — et l'évaluation du scope 3 — les émissions indirectes liées à votre chaîne d'approvisionnement." },
          haut: { label: "Réflexes installés", titre: "Les pratiques RSE de vos fournisseurs sont un critère réel dans vos achats — pas un vernis.", resume: "Les critères RSE ont un poids réel dans vos décisions d'achat — scope 3, clauses contractuelles, due diligence.", desc: "Les critères RSE influencent réellement vos décisions d'achat, y compris quand cela implique un surcoût ou l'exclusion d'un fournisseur. Vous intégrez le scope 3 dans votre évaluation. Vous incluez des clauses RSE dans vos contrats. Vous réalisez une due diligence sur les pratiques de vos fournisseurs. Cette intégration substantielle des critères RSE dans les achats est ce qui crée un impact réel sur toute la chaîne de valeur." },
        },
      },
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vos fournisseurs sont évalués sur leur performance commerciale — pas leurs pratiques RSE.", resume: "La gestion de votre portefeuille fournisseurs n'intègre pas de dimension RSE.", desc: "La gestion de votre portefeuille fournisseurs pourrait encore être exclusivement focalisée sur la performance commerciale — sans suivi des pratiques RSE, sans dialogue sur les enjeux environnementaux et sociaux, sans plan de progrès. Ces comportements font que votre influence sur les pratiques de votre chaîne d'approvisionnement n'est pas utilisée." },
          moyen: { label: "Pratiques en développement", titre: "Vous suivez les pratiques RSE de vos fournisseurs — mais le dialogue proactif et le partage restent limités.", resume: "Vous suivez vos fournisseurs sur les pratiques RSE — le dialogue proactif et le partage de pratiques sont encore limités.", desc: "Vous suivez les pratiques RSE de vos fournisseurs. Ce qui pourrait encore être limité, c'est le dialogue proactif — aller au-delà de la collecte d'informations pour co-construire des plans de progrès — et le partage de pratiques — partager vos propres approches pour créer une dynamique d'amélioration mutuelle." },
          haut: { label: "Réflexes installés", titre: "Vous gérez activement la progression RSE de votre portefeuille fournisseurs.", resume: "Vous gérez activement votre portefeuille fournisseurs sur les pratiques RSE — dialogue, partage, co-innovation.", desc: "Vous dialoguez proactivement avec vos fournisseurs sur leurs pratiques RSE. Vous co-construisez des plans de progrès. Vous partagez vos propres pratiques. Vous explorez des opportunités de co-innovation environnementale. Cette gestion active et collaborative de la dimension RSE du portefeuille fournisseurs est ce qui crée un impact systémique sur votre chaîne d'approvisionnement." },
        },
      },
      {
        type: "likert",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "L'impact RSE de vos achats n'est pas encore visible ni mesuré.", resume: "La contribution des achats aux objectifs RSE n'est pas mesurée ni pilotée.", desc: "La contribution de vos achats aux objectifs RSE de votre organisation pourrait encore ne pas être mesurée — sans indicateurs de suivi, sans objectifs de progrès, sans reporting. Ces comportements font qu'il est impossible de savoir si les efforts réalisés créent un impact réel et d'identifier les domaines où des améliorations supplémentaires seraient prioritaires." },
          moyen: { label: "Pratiques en développement", titre: "Vous mesurez partiellement — le reporting complet et la formation de l'équipe sont encore perfectibles.", resume: "Vous mesurez partiellement la contribution RSE des achats — le reporting et la formation de l'équipe sont encore perfectibles.", desc: "Vous mesurez partiellement la contribution RSE de vos achats. Ce qui pourrait encore être perfectible, c'est la complétude du reporting — couvrir l'ensemble des critères RSE, pas seulement les plus faciles à mesurer — et la formation de l'équipe — s'assurer que tous les membres disposent des compétences pour intégrer les critères RSE dans leurs décisions." },
          haut: { label: "Réflexes installés", titre: "Vous pilotez la contribution RSE de vos achats — avec des indicateurs, des objectifs et un reporting.", resume: "La contribution RSE des achats est mesurée, pilotée et communiquée à votre direction.", desc: "Vous mesurez la contribution RSE de vos achats avec des indicateurs complets. Vous pilotez des objectifs de progrès. Vous communiquez les résultats à votre direction. Vous formez votre équipe. Cette mesure et ce pilotage rigoureux — qui créent la visibilité nécessaire pour prendre des décisions éclairées — sont ce qui fait que les achats RSE produisent un impact réel et démontrable." },
        },
      },
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Votre démarche d'achats responsables est encore fragile — sans structure ni ambition.", resume: "La démarche d'achats responsables n'est pas structurée ni portée activement.", desc: "Votre démarche d'achats responsables pourrait encore être non structurée — des actions ponctuelles sans cadre cohérent, sans politique formalisée, sans ambition progressive. Ces comportements font que les progrès ne s'accumulent pas et que la démarche reste marginale." },
          moyen: { label: "Pratiques en développement", titre: "La démarche est structurée — mais l'ambition, la veille et la contribution à la politique manquent encore.", resume: "Votre démarche est structurée — l'ambition, la veille et la contribution à la politique sont encore insuffisantes.", desc: "Votre démarche d'achats responsables est structurée. Ce qui pourrait encore être insuffisant, c'est l'ambition progressive — se fixer des objectifs au-delà des minimums réglementaires — la veille sur les pratiques du secteur — s'inspirer des meilleures pratiques disponibles — et la contribution à la politique — influencer activement la politique d'achats RSE de votre organisation." },
          haut: { label: "Réflexes installés", titre: "Votre démarche d'achats responsables est ambitieuse, évolutive et vous en faites bénéficier l'organisation.", resume: "Votre démarche d'achats responsables est ambitieuse, structurée et vous contribuez à la faire progresser.", desc: "Votre démarche d'achats responsables est ambitieuse, structurée et en progression continue. Vous faites une veille active sur les pratiques du secteur. Vous contribuez à l'évolution de la politique d'achats RSE de votre organisation. Vous partagez vos apprentissages avec vos pairs. Cette ambition et cette contribution systémique sont ce qui fait progresser les pratiques au-delà de votre périmètre direct." },
        },
      },
      {
        type: "likert",
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous êtes sensibilisé·e — mais votre engagement n'est pas encore organisé.", resume: "Votre engagement est encore peu structuré — vous ne savez pas par où commencer ni comment situer votre niveau.", desc: "Votre engagement dans la transition environnementale pourrait encore manquer de structure — ne pas savoir par où commencer, se sentir dépassé par l'ampleur des enjeux, ne pas avoir de méthode pour situer son niveau et progresser. Ces comportements font que la motivation réelle ne se traduit pas en actions concrètes et durables." },
          moyen: { label: "Pratiques en développement", titre: "Vous êtes engagé·e sur les bases — mais la progression vers les gestes plus significatifs est encore insuffisante.", resume: "Vous êtes engagé·e sur les bases — la progression vers des gestes plus challengeants et la durabilité sont encore insuffisantes.", desc: "Vous êtes engagé·e sur les gestes de base. Ce qui pourrait encore être insuffisant, c'est la progression vers des gestes plus significatifs — ceux qui demandent plus d'effort ou qui touchent à des habitudes plus ancrées — et la durabilité de l'engagement dans le temps." },
          haut: { label: "Réflexes installés", titre: "Votre engagement est structuré et progresse — vers des gestes de plus en plus significatifs.", resume: "Votre engagement est structuré, situé et progresse régulièrement vers des gestes plus significatifs.", desc: "Votre engagement est structuré — vous savez où vous en êtes et vous vous fixez des objectifs de progression. Vous avancez régulièrement vers des gestes plus significatifs. Vous maintenez votre engagement dans la durée sans vous épuiser. Cette approche structurée et progressive — qui suppose d'avoir accepté que l'engagement est une progression et non un état final — est ce qui crée un impact cumulatif réel." },
        },
      },
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous restez dans le périmètre des gestes faciles — les contraignants restent encore inexplorés.", resume: "Vous vous limitez aux gestes les plus faciles et vous découragez quand les résultats ne sont pas visibles.", desc: "Votre engagement pourrait encore être limité aux gestes les plus faciles — ceux qui ne demandent ni effort supplémentaire, ni changement d'habitude significatif, ni acceptation de contraintes. Ces comportements font que l'impact reste marginal par rapport au potentiel réel de votre engagement." },
          moyen: { label: "Pratiques en développement", titre: "Vos gestes sont réguliers — mais la priorisation par impact et la gestion des blocages systémiques restent perfectibles.", resume: "Vous maintenez des gestes réguliers — la priorisation par impact et la gestion des blocages systémiques sont encore perfectibles.", desc: "Vous maintenez des gestes réguliers dans la durée. Ce qui pourrait encore être perfectible, c'est la priorisation par impact — concentrer vos efforts sur les gestes qui ont le plus d'effet réel — et la gestion des blocages systémiques — distinguer ce qui dépend de vous de ce qui dépend des conditions extérieures, et remonter les seconds." },
          haut: { label: "Réflexes installés", titre: "Vous maintenez vos gestes grâce à des routines durables et vous priorisez par impact réel.", resume: "Vous maintenez vos gestes grâce à des routines durables, vous priorisez par impact et vous remontez les blocages.", desc: "Vous maintenez vos gestes grâce à des routines durables qui résistent aux périodes de pression. Vous priorisez par impact réel plutôt que par facilité. Vous distinguez les blocages personnels des blocages systémiques et vous remontez les seconds. Cette combinaison de durabilité, de priorisation et de contribution systémique est ce qui crée un engagement efficace dans la durée." },
        },
      },
      {
        type: "likert",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Les obstacles et le scepticisme de votre entourage freinent encore votre engagement.", resume: "Vous êtes facilement découragé·e par les obstacles, le scepticisme de vos collègues ou la pression.", desc: "Votre engagement pourrait encore être fragilisé par les obstacles externes — le scepticisme de collègues, les périodes de forte pression professionnelle, les situations où les efforts semblent inutiles face à l'ampleur des enjeux. Ces comportements font que l'engagement est intermittent plutôt que durable." },
          moyen: { label: "Pratiques en développement", titre: "Vous résistez au scepticisme ordinaire — les périodes difficiles et les pressions fortes restent des angles morts.", resume: "Vous résistez au scepticisme ordinaire — la gestion des périodes difficiles et de la pression sont encore des angles morts.", desc: "Vous résistez au scepticisme ordinaire sans vous laisser déstabiliser. Ce qui pourrait encore créer des angles morts, c'est la gestion des périodes difficiles — les moments où la charge professionnelle est très forte — et la pression plus intense — le supérieur sceptique, l'environnement qui ne soutient pas la démarche." },
          haut: { label: "Réflexes installés", titre: "Votre engagement tient face à tous les freins — sans vous épuiser à convaincre.", resume: "Vous résistez à tous les freins — scepticisme, périodes difficiles, pression — sans vous épuiser.", desc: "Vous résistez au scepticisme, aux périodes de forte pression et aux environnements peu soutenants sans vous épuiser. Vous avez développé des ressources pour maintenir votre engagement dans les conditions difficiles. Cette résilience de l'engagement — qui suppose d'avoir traité la question de la motivation personnelle et de la gestion des obstacles — est ce qui fait que votre engagement est durable." },
        },
      },
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Votre engagement reste encore solitaire — vos collègues n'en bénéficient pas.", resume: "Vous n'embarquez pas encore vos collègues ou le faites de façon contreproductive.", desc: "Votre façon d'embarquer vos collègues dans la transition pourrait encore être inexistante ou contreproductive — ne pas partager vos pratiques par crainte d'être perçu·e comme moralisateur, ou au contraire adopter une posture moralisatrice qui crée des résistances. Ces comportements font que votre engagement n'essaime pas." },
          moyen: { label: "Pratiques en développement", titre: "Vous partagez vos pratiques — mais embarquer sans moraliser est encore à travailler.", resume: "Vous partagez vos pratiques — votre approche pour embarquer sans moraliser est encore perfectible.", desc: "Vous partagez vos pratiques avec vos collègues. Ce qui pourrait encore être perfectible, c'est l'approche — partager sans moraliser, partir de l'exemple plutôt que de l'injonction, s'adapter aux motivations et aux contraintes de chacun. Ces nuances font la différence entre un partage qui crée l'envie et un partage qui crée la résistance." },
          haut: { label: "Réflexes installés", titre: "Vous embarquez vos collègues — par l'exemple et sans pression.", resume: "Vous embarquez sans moraliser, en partageant l'exemple et en participant aux initiatives collectives.", desc: "Vous partagez vos pratiques par l'exemple sans moraliser. Vous vous adaptez aux motivations et aux contraintes de vos collègues. Vous participez aux initiatives collectives. Cette façon d'embarquer — qui suppose d'avoir accepté que chacun progresse à son rythme — est ce qui crée une dynamique collective durable." },
        },
      },
      {
        type: "likert",
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Votre animation RSE est contrainte à des espaces dédiés — elle ne s'intègre pas encore au travail.", resume: "Votre animation RSE est formelle et peu convaincante — sans exemplarité ni intégration naturelle dans le travail.", desc: "Votre animation RSE pourrait encore être principalement formelle — des communications obligatoires, des actions ponctuelles sans conviction visible, une exemplarité insuffisante dans vos propres comportements. Ces comportements créent un décalage entre ce que vous demandez à votre équipe et ce que vous faites vous-même, ce qui réduit l'efficacité de l'animation." },
          moyen: { label: "Pratiques en développement", titre: "Vous animez avec conviction — mais l'intégration naturelle et la gestion de la diversité d'engagement restent insuffisantes.", resume: "Vous animez avec conviction et exemplarité — l'intégration naturelle et la gestion de la diversité d'engagement sont encore insuffisantes.", desc: "Vous animez avec conviction et exemplarité. Ce qui pourrait encore être insuffisant, c'est l'intégration naturelle de la RSE dans le travail ordinaire — plutôt que dans des espaces dédiés séparés — et la gestion de la diversité d'engagement — s'adapter aux personnes peu convaincues sans les forcer, capitaliser sur les plus engagées." },
          haut: { label: "Réflexes installés", titre: "Votre animation RSE est convaincante et naturellement intégrée au travail ordinaire.", resume: "Vous animez avec conviction authentique, exemplarité et intégration naturelle dans le travail ordinaire.", desc: "Vous incarnez la démarche RSE dans vos propres comportements. Vous intégrez la RSE naturellement dans le travail ordinaire plutôt que dans des espaces dédiés séparés. Vous gérez la diversité d'engagement de votre équipe — sans forcer les peu convaincus, en capitalisant sur les plus engagés. Cette animation authentique et intégrée est ce qui crée une dynamique durable dans l'équipe." },
        },
      },
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "L'engagement RSE collectif de votre équipe n'est pas encore activement construit.", resume: "L'engagement collectif de votre équipe n'est pas activement construit ni mesuré.", desc: "L'engagement collectif de votre équipe dans la démarche RSE pourrait encore reposer sur les initiatives individuelles sans construction active — pas d'espaces collectifs dédiés, pas de projets communs, pas de mesure de l'engagement. Ces comportements font que la dynamique dépend des individus les plus motivés plutôt que d'une culture collective." },
          moyen: { label: "Pratiques en développement", titre: "Vous créez des espaces collectifs — mais la mesure et l'ancrage des pratiques sont encore perfectibles.", resume: "Vous créez des espaces et des projets collectifs — la mesure et l'ancrage des pratiques sont encore perfectibles.", desc: "Vous créez des espaces et des projets collectifs pour l'engagement RSE de votre équipe. Ce qui pourrait encore être perfectible, c'est la mesure de l'engagement — avoir des indicateurs qui rendent les progrès visibles — et l'ancrage des pratiques — s'assurer que les nouvelles pratiques s'installent durablement plutôt que de s'essouffler après les moments collectifs." },
          haut: { label: "Réflexes installés", titre: "Vous construisez activement un engagement collectif — partagé, mesuré, célébré.", resume: "Vous construisez activement l'engagement collectif — espaces, projets, mesure, célébration, obstacles.", desc: "Vous créez des espaces collectifs réguliers pour partager et progresser. Vous lancez des projets qui mobilisent l'équipe. Vous mesurez et célébrez les progrès. Vous identifiez et traitez les obstacles systémiques. Cette construction active de l'engagement collectif — qui suppose un investissement managérial régulier — est ce qui crée une culture RSE qui tient indépendamment des individus." },
        },
      },
      {
        type: "likert",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "La performance prime encore systématiquement sur l'impact RSE dans vos arbitrages.", resume: "Face aux arbitrages entre performance et impact, la performance l'emporte systématiquement.", desc: "Vos arbitrages pourraient encore placer systématiquement la performance à court terme au-dessus de l'impact RSE — sacrifier les objectifs environnementaux quand il y a un arbitrage, ne pas défendre les investissements RSE sous pression budgétaire. Ces comportements créent un signal clair sur ce qui est vraiment prioritaire, qui annule l'effet de votre animation." },
          moyen: { label: "Pratiques en développement", titre: "Vous cherchez à concilier — mais la résilience face aux pressions fortes est encore insuffisante.", resume: "Vous cherchez à concilier — la résilience face aux urgences et aux pressions de direction est encore insuffisante.", desc: "Vous cherchez à concilier performance et impact RSE dans vos arbitrages. Ce qui pourrait encore être insuffisant, c'est la résilience de ces arbitrages dans les situations difficiles — les urgences opérationnelles qui remettent en cause les engagements RSE, la pression de la direction pour prioriser la performance financière." },
          haut: { label: "Réflexes installés", titre: "Vous tenez vos arbitrages RSE même sous pression — et vous nommez les dilemmes réels.", resume: "Vous maintenez les arbitrages RSE même sous pression et vous êtes transparent sur les dilemmes.", desc: "Vous maintenez vos arbitrages RSE même sous pression opérationnelle ou hiérarchique. Vous êtes transparent sur les dilemmes réels — quand la performance et l'impact RSE sont vraiment en tension. Cette tenue des arbitrages et cette transparence sur les dilemmes — qui crée la confiance nécessaire pour embarquer l'équipe — sont ce qui distingue une animation RSE crédible d'une animation de façade." },
        },
      },
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "La dynamique RSE de votre équipe ne tient que par les moments forts et votre présence.", resume: "La dynamique RSE de votre équipe est fragile — dépend des moments forts et de votre présence.", desc: "La dynamique RSE de votre équipe pourrait encore être fragile — s'essouffler entre les moments collectifs forts, dépendre de votre présence et de votre énergie pour exister. Ces comportements font que la dynamique n'est pas encore autonome et ne peut pas progresser par elle-même." },
          moyen: { label: "Pratiques en développement", titre: "La dynamique est relativement stable — mais l'ancrage dans les pratiques quotidiennes et l'ambition progressive manquent.", resume: "Votre dynamique est relativement stable — l'ancrage, les pairs et l'ambition progressive sont encore insuffisants.", desc: "La dynamique RSE de votre équipe est relativement stable. Ce qui pourrait encore être insuffisant, c'est l'ancrage dans les pratiques quotidiennes — que la démarche continue entre les moments collectifs — la création de pairs relais — des membres de l'équipe qui portent la dynamique avec vous — et l'ambition progressive — se fixer des objectifs de progrès au-delà des acquis." },
          haut: { label: "Réflexes installés", titre: "La dynamique RSE de votre équipe est ancrée, ambitieuse et ne dépend plus uniquement de vous.", resume: "Votre dynamique RSE est ancrée, ambitieuse et vous la faites progresser avec vos pairs.", desc: "La dynamique RSE de votre équipe est ancrée dans les pratiques quotidiennes. Elle progresse vers des objectifs ambitieux. Vous la faites progresser avec vos pairs managers. Vous avez créé des relais dans l'équipe. Cette dynamique ancrée et ambitieuse — qui ne dépend plus uniquement de votre présence — est ce qui fait qu'une culture RSE d'équipe est réelle et durable." },
        },
      },
      {
        type: "likert",
