    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous ne déclarez pas les conflits d'intérêts que vous identifiez — vous comptez sur votre propre objectivité", desc: "Participer à un jury alors que votre beau-frère est candidat en pensant pouvoir rester objectif, prendre une décision et signaler ensuite, ne pas déclaer parce que les liens pris isolément semblent mineurs : ces comportements font reposer la prévention des conflits d'intérêts sur votre seul jugement. Or l'impartialité réelle ne suffit pas — c'est l'apparence d'impartialité qui est aussi en jeu." },
          moyen: { label: "Pratiques en développement", titre: "Vous déclarez les situations évidentes mais les zones grises et les accumulations de liens mineurs créent encore des hésitations", desc: "Vous vous retirez des situations évidentes et vous signalez les conflits clairement identifiés. Mais évaluer si une accumulation de liens mineurs constitue un conflit déclarable, re-déclarer une situation passée dans un nouveau contexte, traiter l'apparence de conflit au même niveau que le conflit réel : ces situations moins tranchées créent encore des hésitations. L'enjeu est d'appliquer le même réflexe aux zones grises qu'aux cas évidents." },
          haut: { label: "Réflexes installés", titre: "Vous déclarez systématiquement — situations évidentes, zones grises, accumulations, apparences — avant même d'être certain·e", desc: "Vous vous retirez du jury dès que vous identifiez un lien, sans attendre d'être sûr·e que c'est problématique. Vous évaluez l'accumulation de liens mineurs. Vous demandez une validation formelle écrite quand on vous demande de continuer. Vous signalez rétroactivement une situation découverte après la décision. Vous vérifiez vos obligations post-emploi avant d'accepter une mission. Cette systématicité de la déclaration — qui suppose d'accepter d'agir sans certitude complète — est ce qui protège réellement l'organisation." },
        },
      },
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous percevez les conflits d'intérêts comme un problème réservé à la conformité, pas comme votre responsabilité personnelle", desc: "Penser que la conformité est le seul acteur concerné, attendre qu'une formation vous dise ce qui est déclarable, accepter un rôle externe sans vérification préalable : ces comportements délèguent à l'organisation une responsabilité qui est d'abord individuelle. Chaque collaborateur est le premier garant de sa propre intégrité." },
          moyen: { label: "Pratiques en développement", titre: "Vous connaissez vos obligations mais votre appropriation de la responsabilité personnelle n'est pas encore complète", desc: "Vous vérifiez avant d'accepter des rôles externes et vous connaissez le cadre général. Mais chercher activement à comprendre le cadre de votre organisation quand ce n'est pas clair, corriger un collègue qui minimise l'impact d'un conflit non déclaré, reconnaître que l'absence de déclarations peut signaler un problème de culture plutôt que d'intégrité : votre appropriation de la responsabilité individuelle est encore perfectible." },
          haut: { label: "Réflexes installés", titre: "Vous avez pleinement intégré que la gestion des conflits d'intérêts est une responsabilité personnelle, pas seulement organisationnelle", desc: "Vous vérifiez avant d'accepter des rôles externes. Vous cherchez activement à connaître le cadre de votre organisation. Vous rappellez qu'un conflit non déclaré est un manquement indépendamment de son impact réel. Vous éduquez les nouveaux collaborateurs dans votre propre onboarding. Vous expliquez à votre collègue pourquoi sa situation constitue un conflit d'intérêts plutôt que de le gérer à sa place. Cette appropriation complète de la responsabilité individuelle est ce qui fait qu'une culture éthique tient dans la durée." },
        },
      },
      {
        type: "choix",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Dans les situations complexes, vous attendez la certitude ou l'urgence avant de déclarer", desc: "Prendre la décision d'abord en cas d'urgence et signaler après, ne pas re-déclarer une situation passée dans un nouveau contexte, ne pas signaler rétroactivement une situation identifiée après coup : ces comportements créent des angles morts précisément dans les situations où les risques sont les plus élevés." },
          moyen: { label: "Pratiques en développement", titre: "Vous déclarez dans les situations ordinaires mais la pression du temps et la pression hiérarchique créent encore des failles", desc: "Vous signalez en temps normal et vous demandez une validation formelle écrite quand on vous demande de continuer malgré un conflit déclaré. Mais maintenir vos obligations en situation d'urgence opérationnelle, résister à une pression hiérarchique implicite qui décourage les déclarations, signaler rétroactivement une situation découverte après la décision : ces situations de pression créent encore des failles." },
          haut: { label: "Réflexes installés", titre: "Vous déclarez dans toutes les situations — urgences, pressions hiérarchiques, situations passées découvertes après coup", desc: "Vous signalez immédiatement même quand ça retarde une décision urgente. Vous maintenez vos obligations malgré la pression hiérarchique implicite. Vous remontez cette pression à la conformité. Vous re-déclarez une situation passée dans un nouveau contexte. Vous tenez le registre rigoureusement comme outil de protection. Cette tenue dans les situations de pression — qui suppose d'accepter d'être en désaccord avec la hiérarchie — est ce qui distingue une culture éthique d'une culture de façade." },
        },
      },
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "La culture de déclaration dans votre équipe n'est pas activement portée", desc: "Ne pas valoriser explicitement un collaborateur qui déclare, décourager les déclarations 'pour ne pas créer de complications', tenir le registre a minima, ne pas former les nouveaux arrivants dans votre propre onboarding : ces comportements signalent implicitement que les déclarations ne sont pas les bienvenues." },
          moyen: { label: "Pratiques en développement", titre: "Vous maintenez une culture de déclaration mais votre posture d'exemplarité en tant que manager est encore insuffisante", desc: "Vous valorisez les déclarations de votre équipe et vous transmettez le cadre aux nouveaux. Mais appliquer un niveau d'exigence plus élevé à vous-même qu'à votre équipe, reconsidérer une situation que vous estimerez mineure plutôt que de la gérer seul·e, tenir le registre rigoureusement comme outil de protection : votre exemplarité managériale est encore insuffisante." },
          haut: { label: "Réflexes installés", titre: "Vous construisez activement la culture de déclaration dans votre équipe par l'exemplarité et l'encouragement", desc: "Vous appliquez un niveau d'exigence plus élevé à vous-même qu'à votre équipe. Vous valorisez explicitement chaque déclaration pour construire la culture. Vous répondez positivement même aux déclarations que vous estimez inutiles. Vous intervenez quand la pression hiérarchique décourage les déclarations. Vous transmettez le cadre concrètement aux nouveaux. Cette exemplarité active — qui commence par soi-même avant de demander aux autres — est ce qui crée une équipe où déclarer est un réflexe naturel." },
        },
      },
      {
        type: "likert",
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous utilisez le seuil monétaire comme seul critère d'acceptabilité, sans évaluer le contexte et la dépendance", desc: "Accepter une bouteille de vin sous seuil sans considérer que vous êtes en négociation active, ne pas remettre en question la progression d'un partenaire qui offre de plus en plus, accepter un cadeau post-décision comme un simple remerciement : ces comportements appliquent les règles formellement sans en saisir l'esprit. Le seuil monétaire est un plancher, pas un plafond." },
          moyen: { label: "Pratiques en développement", titre: "Vous évaluez le contexte au-delà du seuil monétaire mais les cas d'accumulation progressive et les avantages indirects créent encore des angles morts", desc: "Vous évaluez le risque de dépendance et vous vérifiez les règles de votre organisation. Mais évaluer une accumulation de cadeaux sous seuil sur l'année, traiter un cadeau offert à votre famille comme un cadeau offert à vous-même, évaluer un cadeau post-décision pour ce qu'il signifie réellement : ces situations créent encore des angles morts." },
          haut: { label: "Réflexes installés", titre: "Vous évaluez les cadeaux et invitations dans leur contexte global — montant, relation, contexte décisionnel, accumulation, bénéficiaire réel", desc: "Vous refusez ou déclarez la bouteille de Noël parce que vous êtes en négociation active. Vous évaluez l'accumulation annuelle et pas seulement chaque cadeau isolément. Vous traitez un cadeau fait à votre famille comme un cadeau fait à vous. Vous refusez un cadeau post-décision et le signalez. Vous vérifiez vos obligations post-emploi. Cette évaluation globale du contexte — qui suppose de dépasser la lecture littérale des seuils — est ce qui donne son sens à la politique de l'organisation." },
        },
      },
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous n'identifiez pas le moment où les cadeaux et invitations commencent à influencer votre jugement", desc: "Ne pas remarquer que vous inclinez à accorder le bénéfice du doute à un partenaire qui vous invite régulièrement, ne pas prendre de recul sur l'accumulation des avantages reçus, se sentir obligé·e de lui accorder quelque chose en retour : ces comportements laissent la dépendance relationnelle s'installer invisiblement. La dépendance n'a pas besoin de corruption déclarée pour être réelle." },
          moyen: { label: "Pratiques en développement", titre: "Vous identifiez l'influence des cadeaux dans les situations évidentes mais la dépendance progressive reste un angle mort", desc: "Vous prenez du recul quand une situation d'influence évidente se présente. Mais identifier progressivement que vous inclinez à accorder le bénéfice du doute à un partenaire, reconnaître que la réciprocité ressentie n'est pas légitime, évaluer régulièrement l'ensemble des avantages reçus d'un partenaire : ces formes subtiles de dépendance sont encore des angles morts." },
          haut: { label: "Réflexes installés", titre: "Vous identifiez et nommez le moment où les avantages reçus commencent à influencer votre jugement", desc: "Vous reconnaissez que vous inclinez à accorder le bénéfice du doute à un partenaire qui vous invite et vous déclarez la situation. Vous refusez une demande déraisonnable même après de nombreuses invitations. Vous prenez régulièrement du recul sur l'ensemble des avantages reçus. Vous appliquez le test : 'serais-je à l'aise si mon responsable voyait ça ?'. Cette conscience active de l'influence — qui suppose de douter de son propre jugement — est ce qui maintient l'objectivité dans la durée." },
        },
      },
      {
        type: "likert",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Dans les situations limites, vous cherchez des justifications pour accepter plutôt que des raisons de décliner ou de déclarer", desc: "S'aligner sur la norme sectorielle quand elle dépasse les règles de l'organisation, accepter au motif que les enjeux commerciaux le justifient, maintenir un refus jusqu'au deuxième insistance avant de céder : ces comportements montrent que le cadre est suivi par défaut, pas par conviction. L'intégrité se teste précisément dans les situations où l'exception semble raisonnable." },
          moyen: { label: "Pratiques en développement", titre: "Vous appliquez les règles dans les situations ordinaires mais les pressions commerciales et les justifications culturelles créent encore des failles", desc: "Vous appliquez les règles dans les situations standard. Mais ne pas céder à l'insistance culturelle d'un partenaire, maintenir votre évaluation indépendamment des enjeux commerciaux avec un client stratégique, consulter la conformité quand votre organisation n'a pas de règle explicite : ces situations de pression créent encore des failles." },
          haut: { label: "Réflexes installés", titre: "Vous appliquez les règles dans toutes les situations — pressions commerciales, insistances culturelles, situations sans règle explicite", desc: "Vous maintenez votre refus face à l'insistance culturelle en expliquant vos règles. Vous soumettez à validation malgré les enjeux commerciaux. Vous consultez la conformité quand il n'y a pas de règle explicite. Vous refusez un cadeau post-décision et le signalez. Vous payez vous-même votre participation à un congrès pour ne pas créer de dépendance. Cette application sans exception — qui suppose d'accepter de paraître rigide — est ce qui crée la confiance que les décisions sont objectives." },
        },
      },
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Votre équipe manque de clarté et de culture sur les règles applicables", desc: "Laisser chaque collaborateur interpréter les règles à sa façon, ne pas expliquer le sens du registre, s'aligner sur la pression commerciale plutôt que de rappeler les règles : ces comportements construisent une équipe où les règles ne sont respectées que quand elles sont rappelées, pas par conviction." },
          moyen: { label: "Pratiques en développement", titre: "Vous clarifiez les règles avec votre équipe mais votre exemplarité et votre résistance à la pression commerciale sont encore perfectibles", desc: "Vous clarifiez les règles et vous corrigez les erreurs d'ignorance. Mais régulariser vous-même quand vous avez dépassé les seuils devant votre équipe, expliquer le sens du registre plutôt que de le présenter comme une obligation, remonter la pression commerciale qui pousse à l'acceptation : votre exemplarité et votre résistance sont encore insuffisantes." },
          haut: { label: "Réflexes installés", titre: "Vous clarifiez, exemplifiez et résistez à la pression commerciale pour que les règles soient comprises et suivies par conviction", desc: "Vous clarifiez concrètement les règles avec votre équipe sans attendre la conformité. Vous régularisez vos propres écarts devant votre équipe. Vous expliquez le sens du registre. Vous remontez la pression commerciale plutôt que de vous aligner. Vous faites respecter la politique interne même plus restrictive que la loi. Vous formez dès l'onboarding sans attendre. Cette culture par l'exemple — qui commence par soi-même et refuse de normaliser les exceptions — est ce qui fait que les règles sont comprises et suivies par conviction." },
        },
      },
      {
        type: "likert",
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous attendez d'avoir des preuves ou la certitude avant de signaler — vous instrumentalisez l'évaluation", desc: "Attendre des preuves avant de signaler un doute, ne pas signaler parce que la personne traverse une période difficile, laisser une pratique probablement illégale parce que tout le monde la normalise, ne pas signaler une situation de sécurité parce qu'on craint une fausse alerte : ces comportements font peser sur vous une responsabilité d'instruction qui n't est pas la vôtre. Votre rôle est de signaler, pas de démontrer." },
          moyen: { label: "Pratiques en développement", titre: "Vous signalez dans les situations évidentes mais le doute, la peur de nuire et la normalisation créent encore des hésitations", desc: "Vous signalez sans attendre d'avoir des preuves et vous cherchez les protections disponibles avant de renoncer. Mais identifier que la normalisation progressive vous a peut-être rendu·e aveugle à des pratiques irrégulières anciennes, signaler un risque de sécurité non certain, expliquer à votre collègue que vous ne pouvez pas vous engager à la confidentialité absolue : ces situations créent encore des hésitations." },
          haut: { label: "Réflexes installés", titre: "Vous signalez vos doutes dès qu'ils dépassent un seuil de vraisemblance — sans attendre la certitude ni les preuves", desc: "Vous signalez votre doute dès qu'il atteint un niveau de vraisemblance suffisant — sans attendre les preuves. Vous expliquez à votre collègue que vous ne pouvez pas garantir la confidentialité absolue. Vous signalez les risques de sécurité par principe de précaution. Vous questionnez vos propres perceptions pour éviter la normalisation. Vous vous renseignez sur les protections disponibles plutôt que de renoncer. Ce réflexe de signalement précoce — qui suppose d'accepter l'inconfort de signaler sans certitude — est ce qui permet de traiter les problèmes avant qu'ils deviennent incontrôlables." },
        },
      },
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous ne connaissez pas les voies et les formes de signalement adaptées à chaque situation", desc: "Passer toujours par la voie hiérarchique même quand elle est impliquée, ne pas documenter avant de signaler, ne pas faire de suivi après un signalement, ne pas signaler à l'écrit : ces comportements réduisent l'efficacité et la protection que le signalement aurait pu apporter." },
          moyen: { label: "Pratiques en développement", titre: "Vous connaissez les voies principales mais votre documentation, traçabilité et suivi post-signalement sont encore perfectibles", desc: "Vous évaluez la bonne voie selon le contexte et vous utilisez les voies alternatives quand la hiérarchie est impliquée. Mais documenter systématiquement avant de signaler, choisir l'écrit sur l'oral pour la traçabilité, faire le suivi du signalement, envisager une voie externe si l'interne reste sans réponse : votre rigueur de processus est encore perfectible." },
          haut: { label: "Réflexes installés", titre: "Votre signalement est documenté, tracé, adressé au bon canal et suivi", desc: "Vous documentez les faits avant de signaler. Vous choisissez le canal adapté à la nature de la situation. Vous contournez la voie hiérarchique quand elle est impliquée. Vous rédigez un signalement factuel sans interprétation des motivations. Vous suivez le traitement et demandez une confirmation de réception. Vous envisagez la voie externe si l'interne reste sans réponse. Cette rigueur de processus — qui suppose d'investir du soin dans la forme autant que dans le fond — est ce qui rend les signalements crédibles et efficaces." },
        },
      },
      {
        type: "choix",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Des freins — loyauté, peur, pression, normalisation — bloquent votre passage à l'acte", desc: "Renoncer par loyauté envers un collègue apprécié, s'aligner sur la pression collective, ne pas signaler parce que vous pensez que ça ne changera rien, vous sentir coupable des conséquences subies par la personne signalée : ces freins sont normaux mais ne justifient pas l'absence de signalement." },
          moyen: { label: "Pratiques en développement", titre: "Vous résistez aux freins ordinaires mais la pression hiérarchique directe et la normalisation ancienne créent encore des angles morts", desc: "Vous résistez à la pression des collègues et à la loyauté envers des personnes appréciées. Mais signaler malgré une instruction hiérarchique directe de ne pas le faire, reconnaître que la normalisation progressive vous a peut-être biaisé·e, maintenir votre décision après que les conséquences se révèlent difficiles pour la personne signalée : ces situations de pression maximale créent encore des angles morts." },
          haut: { label: "Réflexes installés", titre: "Vous résistez à tous les freins — loyauté, pression, normalisation, pression hiérarchique directe", desc: "Vous signalez malgré votre attachement pour la personne concernée. Vous résistez à la pression collective de vos collègues. Vous signalez malgré l'instruction hiérarchique de ne pas le faire — et vous la documentez. Vous maintenez que votre rôle était de signaler même quand les conséquences sont difficiles pour la personne signalée. Vous questionnez vos habitudes pour détecter la normalisation. Cette résistance à tous les freins — qui suppose d'assumer seul·e une décision que votre entourage désapprouve — est ce qui distingue l'intégrité de la conformité de façade." },
        },
      },
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "L'environnement que vous créez ne favorise pas encore le signalement", desc: "Questionner d'abord la certitude du signalant plutôt que l'accueillir, ne pas tenir informé le collaborateur qui a signalé, ne pas agir face aux représailles subtiles, supposer que l'absence d'alertes signifie l'absence de problèmes : ces comportements créent un environnement où signaler n'est pas sûr." },
          moyen: { label: "Pratiques en développement", titre: "Vous accueillez les signalements mais la protection des signalants et la culture active de l'alerte sont encore insuffisantes", desc: "Vous accueillez les signalements avec écoute et vous remerciez les fausses alertes. Mais intervenir immédiatement sur les représailles subtiles post-signalement, chercher activement si des freins au signalement existent dans votre équipe, tenir informé le collaborateur de l'avancement du traitement : ces comportements de protection active des signalants sont encore insuffisants." },
          haut: { label: "Réflexes installés", titre: "Vous créez activement un environnement où signaler est sûr et attendu", desc: "Vous accueillez les signalements sans questionner d'abord la certitude. Vous tenez le signalant informé. Vous intervenez immédiatement sur les représailles même subtiles. Vous cherchez activement les freins au signalement dans votre équipe. Vous remerciez les fausses alertes. Vous informez votre équipe des voies disponibles. Vous prenez les sujets éthiques au sérieux en réunion. Cette construction active de la sécurité psychologique autour du signalement — qui commence par la réaction aux premières alertes — est ce qui fait qu'une équipe signale." },
        },
      },
      {
        type: "likert",
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Votre posture face aux dilemmes de votre équipe est soit de trancher seul soit d'éviter le sujet", desc: "Répondre à la demande du client parce que c'est légal sans explorer les enjeux éthiques avec votre collaborateur, gérer vous-même les cas difficiles pour protéger l'équipe sans les former, tolérer des comportements limites de vos meilleurs éléments, ne pas créer d'espace pour que les questions éthiques soient soulevées sans jugement : ces comportements privent votre équipe du développement de son propre jugement éthique." },
          moyen: { label: "Pratiques en développement", titre: "Vous abordez les dilemmes éthiques avec votre équipe mais vous n'avez pas encore développé leur autonomie de jugement", desc: "Vous explorez les enjeux éthiques avec votre équipe et vous refusez les raccourcis en l'expliquant. Mais donner des repères concrets pour les zones grises du quotidien, créer des espaces pour que les questions soient soulevées sans jugement, prendre au sérieux le refus d'un collaborateur d'exécuter une instruction problématique : votre développement du jugement éthique collectif est encore insuffisant." },
          haut: { label: "Réflexes installés", titre: "Vous développez le jugement éthique de votre équipe plutôt que de gérer les dilemmes à leur place", desc: "Vous explorez les enjeux éthiques avec votre collaborateur avant de décider. Vous refusez les raccourcis en expliquant pourquoi l'objectif ne justifie pas les moyens. Vous créez des espaces pour que les questions soient soulevées. Vous donnez des repères concrets pour les zones grises. Vous prenez au sérieux le refus d'un collaborateur. Vous prenez la décision la plus prudente éthiquement sous pression de temps. Ce développement du jugement collectif — qui suppose de parfois ralentir pour former plutôt que décider — est ce qui crée une équipe capable de naviguer dans les zones grises." },
        },
      },
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "La culture éthique de votre équipe se construit par défaut, pas par choix", desc: "Laisser une pratique normalisée se maintenir sans la questionner, ne pas évaluer les moyens utilisés pour atteindre les résultats, ne pas chercher à comprendre pourquoi de bons éléments partent, associer des partenaires douteux sans évaluation préalable : ces comportements laissent la culture se construire par défaut, souvent vers le bas." },
          moyen: { label: "Pratiques en développement", titre: "Votre culture éthique est présente mais sa cohérence — traitement équitable, remontée des incitations — est encore perfectible", desc: "Vous évaluez les partenaires, vous questionnez les pratiques normalisées et vous associez résultats et moyens dans les évaluations. Mais traiter les comportements limites de vos meilleurs éléments avec la même rigueur, remonter les structures d'incitation problématiques, chercher les raisons réelles des bons départs : quelques failles dans la cohérence de votre culture." },
          haut: { label: "Réflexes installés", titre: "Votre culture éthique est cohérente — traitement équitable, remontée des incitations, évaluation des moyens", desc: "Vous évaluez les partenaires avant d'associer. Vous approfondissez vos doutes sur les moyens même quand les résultats sont bons. Vous traitez les comportements limites de tous vos collaborateurs de la même façon. Vous remontez les structures d'incitation qui créent des risques. Vous cherchez les vraies raisons des bons départs. Vous évaluez moyens et résultats ensemble. Cette cohérence — qui refuse les exceptions pour les meilleurs éléments et questionne les systèmes qui créent des risques — est ce qui fait qu'une culture éthique résiste à la pression." },
        },
      },
      {
        type: "likert",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Face aux dilemmes managériaux, la pression de résultats et de hiérarchie prend souvent le dessus", desc: "Accepter un raccourci éthique sous pression de résultats, appliquer une instruction problématique sans l'exprimer, tolérer des exceptions pour les éléments à forte valeur, ne pas remonter les structures d'incitation qui créent des risques éthiques : ces comportements envoient un signal que les règles sont négociables." },
          moyen: { label: "Pratiques en développement", titre: "Vous résistez aux pressions ordinaires mais les situations de pression maximale créent encore des accommodements", desc: "Vous refusez les raccourcis sous pression et vous exprimez vos désaccords éthiques à la direction. Mais ne pas tolérer d'exceptions pour les meilleurs éléments, remonter explicitement que les objectifs ne peuvent pas être atteints éthiquement avec les moyens donnés, protéger votre équipe en lui parlant des risques éthiques créés par les décisions de la direction : ces situations de pression maximale créent encore des accommodements." },
          haut: { label: "Réflexes installés", titre: "Vous résistez à toutes les pressions — résultats, hiérarchie, exception pour les meilleurs éléments", desc: "Vous refusez les raccourcis et cherchez une autre voie pour atteindre l'objectif. Vous exprimez votre désaccord éthique avant d'appliquer. Vous traitez tous les collaborateurs de façon identique. Vous remontez explicitement quand les objectifs ne peuvent pas être atteints éthiquement. Vous protégez votre équipe en l'informant des risques créés par les décisions de la direction. Vous avouez vos propres erreurs éthiques. Cette tenue face à toutes les pressions — qui suppose parfois de décevoir la direction et les meilleurs éléments — est ce qui crée une culture crédible." },
        },
      },
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Les rituels et moments dédiés à l'éthique sont absents de votre management", desc: "Ne jamais aborder l'éthique en réunion hors crise, donner du feedback éthique uniquement aux moins performants, ne pas intégrer les repères éthiques dans l'onboarding, ne pas partager ses propres erreurs passées : ces comportements font de l'éthique un sujet réservé aux problèmes, pas un composant du management ordinaire." },
          moyen: { label: "Pratiques en développement", titre: "Vous créez des espaces éthiques réguliers mais leur profondeur et votre exemplarité personnelle sont encore insuffisantes", desc: "Vous abordez régulièrement l'éthique en équipe et vous soutenez les décisions courageuses de vos collaborateurs. Mais partager vos propres erreurs éthiques passées, donner un feedback éthique rigoureux à vos meilleurs éléments, intégrer les repères éthiques spécifiques dans l'onboarding, adapter votre approche quand l'équipe résiste : votre profondeur et votre exemplarité sont encore perfectibles." },
          haut: { label: "Réflexes installés", titre: "L'éthique est intégrée dans votre management ordinaire — rituels, onboarding, feedback, exemplarité personnelle", desc: "Vous abordez régulièrement l'éthique en équipe sans attendre les crises. Vous partagez vos erreurs passées. Vous soutenez publiquement les décisions courageuses. Vous montrez concrètement comment l'intégrité crée de la valeur. Vous intégrez les repères éthiques dans l'onboarding. Vous donnez du feedback éthique aux meilleurs éléments. Vous cherchez à comprendre la résistance de votre équipe plutôt que de forcer. Cette intégration de l'éthique dans le management ordinaire — comme dimension normale du pilotage et non comme sujet à part — est ce qui transforme les règles en culture." },
        },
      },
      {
        type: "likert",
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous distinguez mal la corruption directe de ses formes indirectes et déguisées", desc: "Accepter un paiement de facilitation parce que c'est courant dans le pays, payer une commission à un consultant proche du client sans vérifier, ne pas documenter un refus de sollicitation, ne pas vérifier la réputation d'un intermédiaire avant de signer : ces comportements laissent des angles morts sur les formes indirectes de corruption. La loi Sapin II et les législations anticorruption couvrent bien au-delà des pots-de-vin directs." },
          moyen: { label: "Pratiques en développement", titre: "Vous refusez les formes directes de corruption mais les formes indirectes et déguisées créent encore des angles morts", desc: "Vous refusez les paiements directs et vous signalez les sollicitations. Mais vérifier systématiquement les intermédiaires avant de signer, traiter une faveur non monétaire comme une forme de corruption, documenter les refus, mettre fin au contrat d'un sous-traitant corruptif : ces formes indirectes sont encore des angles morts." },
          haut: { label: "Réflexes installés", titre: "Vous identifiez et refusez toutes les formes de corruption — directes, indirectes, déguisées — et vous les documentez", desc: "Vous refusez et signalez les paiements de facilitation même dans des pays où c'est courant. Vous refusez les commissions à des consultants proches des clients. Vous documentez les refus. Vous vérifiez les intermédiaires avant de signer. Vous mettez fin aux contrats de sous-traitants corruptifs. Vous refusez les faveurs non monétaires. Vous respectez les règles de votre pays d'origine même à l'étranger. Cette rigueur sur toutes les formes de corruption — qui suppose de renoncer à des opportunités commerciales — est ce qui protège réellement l'organisation." },
        },
      },
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous contournez les règles de concurrence dans certaines situations en les considérant comme des exceptions raisonnables", desc: "Partager des informations sur vos prix lors d'une conversation informelle avec un concurrent, écouter sans quitter une réunion où des informations sensibles sont échangées, appliquer une instruction d'alignement tarifaire reçue de la hiérarchie, recruter un concurrent sans baliser les informations confidentielles : ces comportements créent des risques d'entente anticoncurrentielle." },
          moyen: { label: "Pratiques en développement", titre: "Vous connaissez les principales règles de concurrence mais les situations ambiguës créent encore des hésitations", desc: "Vous mettez fin aux conversations sur les prix avec les concurrents et vous quittez les réunions problématiques. Mais appliquer une instruction d'alignement tarifaire reçue de la hiérarchie, évaluer si vos pratiques constituent un abus de position dominante, former votre équipe aux risques spécifiques à votre activité : ces aspects des règles de concurrence créent encore des hésitations." },
          haut: { label: "Réflexes installés", titre: "Vous respectez les règles de concurrence dans toutes les situations, y compris sous instruction hiérarchique contraire", desc: "Vous mettez fin aux conversations sur les prix avec les concurrents. Vous quittez les réunions où des informations sensibles sont échangées en notant votre départ. Vous refusez d'appliquer une instruction d'alignement tarifaire et vous la signalez. Vous balisez les informations confidentielles lors du recrutement d'anciens concurrents. Vous contactez le juridique immédiatement lors d'une investigation. Vous formez votre équipe sans attendre la conformité. Cette rigueur anticoncurrentielle — qui suppose de refuser des instructions hiérarchiques — est ce qui évite des sanctions qui peuvent être catastrophiques." },
        },
      },
      {
        type: "likert",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Dans les zones grises, vous vous appuyez sur la légalité formelle plutôt que sur l'évaluation du risque de perception", desc: "Valider un sponsoring d'un client public sans évaluer le risque de perception, s'appuyer sur une relation personnelle avec un décideur pour accélérer des processus, accepter l'utilisation d'une villa de partenaire, laisser votre sous-traitant payer des pots-de-vin : ces comportements traitent les zones grises comme des espaces de liberté plutôt que de risque." },
          moyen: { label: "Pratiques en développement", titre: "Vous évaluez le risque de perception dans les situations claires mais les pressions commerciales créent encore des accommodements dans les zones grises", desc: "Vous évaluez les risques au-delà de la légalité dans les situations évidentes. Mais clarifier avec la conformité une relation personnelle avec un décideur public, refuser une villa de partenaire, évaluer un sponsoring d'un client public, ne pas laisser un sous-traitant agir en votre nom avec des pratiques contraires à votre politique : les pressions commerciales créent encore des accommodements." },
          haut: { label: "Réflexes installés", titre: "Vous évaluez systématiquement le risque de perception dans les zones grises, indépendamment des pressions commerciales", desc: "Vous évaluez le risque de perception des sponsorings de clients publics. Vous clarifiez avec la conformité vos relations personnelles avec des décideurs. Vous refusez l'utilisation d'une villa de partenaire. Vous refusez la remise non standard même en fin de trimestre si elle n'est pas objectivement justifiable. Vous évaluez les dons politiques au-delà de la légalité locale. Vous signalez vos suspicions sur un collaborateur avec les éléments dont vous disposez. Cette évaluation systématique du risque de perception — qui suppose d'accepter des désavantages commerciaux — est ce qui construit la réputation d'intégrité." },
        },
      },
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "La culture anticorruption de votre organisation est appliquée en surface sans être incarnée", desc: "Laisser le programme anticorruption exister sur le papier sans l'opérationnaliser, s'aligner sur les comportements récompensés plutôt que sur les valeurs déclarées, reconsidérer sa position face aux pratiques des concurrents, ne pas protéger l'évaluation d'un collaborateur qui a refusé un contrat corruptif : ces comportements signalent que l'intégrité est conditionnelle." },
          moyen: { label: "Pratiques en développement", titre: "Vous incarnez la culture anticorruption mais votre résistance aux signaux ambigus de la direction et votre protection des collaborateurs intègres sont encore perfectibles", desc: "Vous maintenez votre ligne face aux partenaires qui invoquent la concurrence. Mais demander des clarifications explicites quand la direction envoie des signaux ambigus, protéger l'évaluation d'un collaborateur qui a refusé un contrat corruptif, signaler le décalage entre valeurs déclarées et comportements récompensés : votre résistance interne est encore perfectible." },
          haut: { label: "Réflexes installés", titre: "Vous incarnez et construisez la culture anticorruption avec cohérence — programme opérationnel, protection des intègres, signaux clairs", desc: "Vous rendez le programme anticorruption concret dans votre équipe. Vous signalement le décalage entre valeurs déclarées et comportements récompensés. Vous demandez des clarifications quand la direction envoie des signaux ambigus. Vous protégez l'évaluation d'un collaborateur qui a refusé un contrat corruptif. Vous maintenez votre ligne face aux allégations sur les concurrents. Vous mettez fin immédiatement aux relations avec les tiers non conformes. Cette cohérence entre paroles et actes — qui commence par protéger ceux qui résistent — est ce qui transforme un programme anticorruption en culture." },
        },
      },
      {
        type: "likert",
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous partagez des informations confidentielles sans évaluer systématiquement si vous en avez le droit", desc: "Partager les conditions commerciales d'un client à un autre, discuter de dossiers sensibles dans des lieux publics, partager des informations internes sur LinkedIn, répondre directement à un journaliste sans passer par la communication : ces comportements traitent la confidentialité comme une contrainte formelle plutôt qu'une responsabilité réelle." },
          moyen: { label: "Pratiques en développement", titre: "Vous évitez les partages évidents mais les situations moins directes créent encore des angles morts", desc: "Vous ne partagez pas d'informations confidentielles directement demandées. Mais discussions dans les espaces semi-publics, partage d'informations internes sur les réseaux sociaux, réponse à un journaliste sans passer par la communication, consultation de dossiers non liés à votre mission : ces situations moins directes créent encore des angles morts." },
          haut: { label: "Réflexes installés", titre: "Vous évaluez systématiquement la légitimité de chaque partage d'information, dans tous les contextes", desc: "Vous refusez de partager les conditions d'un client à un autre. Vous remettez à plus tard les conversations sensibles dans les ascenseurs. Vous retirez un post LinkedIn avec des informations internes. Vous maintenez la confidentialité sur votre ancien employeur. Vous ne consultez que les dossiers liés à vos missions. Vous dirigez les journalistes vers la communication. Vous parlez à votre famille en termes généraux. Cette évaluation systématique de la légitimité du partage — dans tous les contextes, même informels — est ce qui protège réellement la confidentialité." },
        },
      },
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous traitez les données personnelles sans rigueur sur la minimisation, la durée et la sécurité", desc: "Collecter des données 'au cas où', ne pas chiffrer les transferts, conserver des données au-delà des durées légales, attendre avant de signaler une violation, utiliser des données pour une nouvelle finalité sans vérifier le consentement : ces comportements exposent l'organisation à des risques légaux et réputationnels sérieux." },
          moyen: { label: "Pratiques en développement", titre: "Vous respectez les principales règles sur les données personnelles mais la rigueur sur les situations complexes est encore perfectible", desc: "Vous respectez les durées de conservation et vous signalez les violations. Mais minimiser la collecte aux données nécessaires, chiffrer les transferts, vérifier le consentement pour de nouvelles finalités, traiter les droits dans les délais légaux même contraignants : ces aspects de la rigueur sur les données sont encore perfectibles." },
          haut: { label: "Réflexes installés", titre: "Votre gestion des données personnelles est rigoureuse — minimisation, sécurité, droits, violations", desc: "Vous ne collectez que les données nécessaires. Vous chiffrez les transferts. Vous respectez les durées de conservation. Vous signalez immédiatement les violations. Vous vérifiez le consentement avant une nouvelle utilisation. Vous traitez les droits dans les délais légaux. Vous vérifiez les garanties des prestataires. Cette rigueur complète sur les données personnelles — qui suppose d'accepter des contraintes opérationnelles — est ce qui respecte les droits des personnes et protège l'organisation." },
        },
      },
      {
        type: "likert",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Votre gestion du secret professionnel manque de rigueur sur les outils, les supports et les situations limites", desc: "Utiliser des méthodes de son ancien employeur sans vérification, stocker des informations confidentielles sur des outils personnels non approuvés, partager des informations de projets en cours lors de conférences, lire des informations reçues par erreur sans les signaler : ces comportements laissent des brèches dans la protection du secret professionnel." },
          moyen: { label: "Pratiques en développement", titre: "Vous gérez correctement les situations ordinaires mais les situations limites sur les supports et les outils créent encore des failles", desc: "Vous vérifiez vos obligations post-emploi et vous ne stockez pas sur des outils non approuvés. Mais vérifier si une méthode est couverte par un accord de confidentialité, contacter le juridique avant de répondre à une demande judiciaire, évaluer si une information concurrentielle reçue par hasard peut être utilisée, signaler immédiatement les informations reçues par erreur : ces situations limites créent encore des failles." },
          haut: { label: "Réflexes installés", titre: "Votre gestion du secret professionnel couvre les supports, les outils, les situations limites et les informations reçues par erreur", desc: "Vous vérifiez les accords de confidentialité avant d'utiliser des méthodes de votre ancien employeur. Vous ne stockez pas sur des outils personnels. Vous contactez le juridique avant de répondre à une demande judiciaire. Vous ne partagez que le nécessaire lors des conférences. Vous signalez immédiatement les informations reçues par erreur. Vous sécurisez vos notes. Cette rigueur sur tous les supports et toutes les situations — qui suppose de résister à la commodité — est ce qui maintient l'intégrité du secret professionnel." },
        },
      },
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "La culture de confidentialité dans votre équipe est laissée à l'initiative individuelle", desc: "Ne pas former l'équipe sans attendre la conformité, ne pas vérifier les accès des collaborateurs qui partent, donner un accès complet à un prestataire par facilité, gérer ses propres erreurs discrètement : ces comportements font reposer la confidentialité sur la bonne volonté individuelle plutôt que sur une culture collective." },
          moyen: { label: "Pratiques en développement", titre: "Vous sensibilisez votre équipe mais votre réaction aux incidents et votre rigueur sur les accès sont encore perfectibles", desc: "Vous sensibilisez votre équipe sans attendre la conformité. Mais traiter les incidents mineurs comme des occasions d'apprentissage collectif, mettre en place une classification des documents, vérifier les accès à tous les départs, auto-signaler vos propres erreurs de confidentialité : votre rigueur opérationnelle est encore perfectible." },
          haut: { label: "Réflexes installés", titre: "Vous construisez une culture de confidentialité dans votre équipe par la sensibilisation, les processus et l'exemplarité", desc: "Vous sensibilisez votre équipe régulièrement. Vous traitez les incidents mineurs comme des apprentissages. Vous mettez en place une classification des documents. Vous vérifiez les accès à chaque départ. Vous ne donnez aux prestataires que les accès nécessaires. Vous signalez vos propres erreurs. Vous vous assurez qu'un accord de confidentialité est en place avant de remettre des documents sensibles. Cette culture collective — qui commence par l'exemplarité sur ses propres erreurs — est ce qui fait que la confidentialité est un réflexe partagé." },
        },
      },
      {
        type: "likert",
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous ne reconnaissez pas systématiquement les situations qui méritent un arrêt pour réflexion éthique", desc: "Continuer sous pression de l'urgence quand une procédure est contournée, appliquer une pratique ambiguë parce que tout le monde la fait, se convaincre avec de bonnes raisons de faire quelque chose qui semble intuitivement problématique : ces comportements laissent passer les dilemmes sans les traiter. La rationalisation est souvent le signal que quelque chose ne va pas." },
          moyen: { label: "Pratiques en développement", titre: "Vous reconnaissez les dilemmes évidents mais les zones grises, la rationalisation et les conflits de valeurs créent encore des angles morts", desc: "Vous vous arrêtez face aux dilemmes évidents et vous prenez la décision la plus prudente sous pression de temps. Mais reconnaître la rationalisation comme signal d'alarme, identifier un conflit de valeurs et chercher une voie qui les respecte toutes les deux, prendre au sérieux un inconfort persistant après une décision : ces dimensions de la détection fine des dilemmes sont encore insuffisantes." },
          haut: { label: "Réflexes installés", titre: "Vous reconnaissez les dilemmes avant qu'ils éclatent — zones grises, rationalisations, conflits de valeurs, inconfort persistant", desc: "Vous vous arrêtez quand une procédure est contournée même sous pression d'urgence. Vous clarifiez le statut d'une pratique ambiguë. Vous traitez la rationalisation comme un signal d'alarme. Vous identifiez les conflits de valeurs et cherchez une voie qui les respecte. Vous prenez la décision la plus prudente sous pression de temps. Vous prenez au sérieux un inconfort persistant après une décision. Cette détection précoce des dilemmes — qui suppose d'accepter de ralentir quand tout pousse à avancer — est ce qui permet de les traiter avant qu'ils deviennent des problèmes." },
        },
      },
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Votre analyse des dilemmes est partielle — parties prenantes incomplètes, biais non traités, apprentissage absent", desc: "Ne regarder que les parties prenantes directes, ne pas identifier ses biais systématiques dans les analyses, ne pas analyser les mauvaises décisions éthiques pour comprendre pourquoi on les a prises, n'avoir aucun cadre personnel explicite : ces comportements produisent des analyses incomplètes et ne permettent pas de progresser." },
          moyen: { label: "Pratiques en développement", titre: "Vous analysez de façon structurée mais l'élargissement aux parties prenantes indirectes et le travail sur vos biais sont encore insuffisants", desc: "Vous appliquez des tests pratiques et vous pensez au long terme. Mais élargir systématiquement aux parties prenantes indirectes, identifier vos biais d'analyse récurrents, analyser vos mauvaises décisions pour comprendre ce qui vous y a conduit : votre profondeur analytique est encore perfectible." },
          haut: { label: "Réflexes installés", titre: "Votre analyse est rigoureuse et honnête — parties prenantes complètes, biais traités, apprentissage des erreurs", desc: "Vous élargissez votre analyse aux parties prenantes indirectes. Vous appliquez des tests pratiques comme le test de la transparence. Vous pondérez le précédent que vous créez. Vous identifiez vos biais d'analyse récurrents. Vous utilisez les ressources disponibles. Vous analysez vos mauvaises décisions pour comprendre ce qui vous y a conduit. Vous construisez un cadre personnel explicite. Cette analyse rigoureuse et honnête — qui inclut le travail sur ses propres angles morts — est ce qui améliore la qualité des décisions dans la durée." },
        },
      },
      {
        type: "likert",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Sous pression — hiérarchique, groupe, client — vous accommodez votre position éthique", desc: "Se rallier à l'opinion du groupe pour ne pas s'isoler, céder face à un client qui menace de partir, exécuter une instruction éthiquement problématique sans exprimer son désaccord : ces comportements montrent que l'éthique n'est pas une conviction mais une position de confort." },
          moyen: { label: "Pratiques en développement", titre: "Vous résistez aux pressions ordinaires mais les pressions maximales — hiérarchique directe, client stratégique — créent encore des failles", desc: "Vous exprimez votre désaccord éthique même sous pression et vous ne vous ralliez pas à l'opinion du groupe. Mais maintenir votre position face à un client stratégique qui menace de partir, demander un délai plutôt que de décider sans analyse correcte, prendre la décision éthiquement correcte même quand elle déçoit quelqu'un d'important : les pressions maximales créent encore des failles." },
          haut: { label: "Réflexes installés", titre: "Vous résistez à toutes les pressions — hiérarchique, groupe, client, urgence — en maintenant votre analyse", desc: "Vous exprimez votre désaccord éthique avant d'exécuter. Vous n'accommodez pas votre position face à la pression du groupe. Vous maintenez votre position face à un client stratégique. Vous demandez un délai pour analyser correctement. Vous prenez la décision éthiquement correcte même quand elle déçoit. Vous formulez clairement vos préoccupations avant de vous retirer d'un projet. Cette résistance à toutes les pressions — qui suppose d'accepter des conséquences personnelles — est ce qui distingue le jugement éthique de la conformité de surface." },
        },
      },
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Votre jugement éthique ne fait pas l'objet d'un développement actif", desc: "Ne jamais réfléchir à la dimension éthique des décisions passées, ne pas participer aux formations, ne pas avoir de référent pour les dilemmes difficiles, se comporter différemment selon que l'on est observé ou non : ces comportements laissent le jugement éthique stagner." },
          moyen: { label: "Pratiques en développement", titre: "Vous développez activement votre jugement mais votre réflexivité systématique et la définition de vos lignes sont encore insuffisantes", desc: "Vous cherchez un référent pour les dilemmes difficiles et vous participez aux formations. Mais prendre régulièrement du recul sur vos décisions passées, définir pour vous-même les lignes que vous refuseriez de franchir, aligner complètement vos comportements observés et non observés, réfléchir à l'évolution de votre jugement éthique : ces dimensions du développement actif sont encore insuffisantes." },
          haut: { label: "Réflexes installés", titre: "Vous développez activement votre jugement éthique — réflexivité, lignes définies, cohérence observé/non observé", desc: "Vous réfléchissez régulièrement à la dimension éthique de vos décisions passées. Vous participez aux formations avec une attente réelle. Vous construisez des relations de confiance pour discuter de vos dilemmes. Vous partagez vos dilemmes résolus pour développer le jugement de vos pairs. Vous avez défini pour vous-même les lignes que vous refuseriez de franchir. Votre comportement est cohérent observé ou non. Vous réfléchissez à l'évolution de votre jugement. Ce développement actif et continu du jugement éthique — qui n'attend pas les problèmes pour se construire — est ce qui fait la différence entre quelqu'un qui applique des règles et quelqu'un qui a un caractère." },
        },
      },
      {
        type: "likert",
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vos reportings sont orientés pour rassurer plutôt que pour informer — données sélectives, contexte trompeur, prévisions optimistes", desc: "Mettre en avant les indicateurs favorables en omettant les autres, ajuster les prévisions selon la demande de la direction, changer de méthode sans le mentionner, contextualiser des bons résultats sans mentionner les facteurs externes : ces comportements produisent des reportings qui donnent une image fausse de la réalité. Les décisions prises sur leur base sont compromises." },
          moyen: { label: "Pratiques en développement", titre: "Vos reportings sont généralement honnêtes mais la pression de la direction et la contextualisation favorable créent encore des accomodements", desc: "Vous mentionnez les changements de méthode et vous ne sélectionnez pas les indicateurs. Mais résister à une demande directe de revoir les prévisions à la hausse, contextualiser honnêtement vos bons résultats liés à des facteurs externes, ne pas produire des prévisions optimistes même quand ça rassure la direction : la pression externe crée encore des accommodements." },
          haut: { label: "Réflexes installés", titre: "Vos reportings sont honnêtes dans tous les contextes — données complètes, méthodes transparentes, prévisions réalistes", desc: "Vous présentez les résultats complets avec analyse honnête. Vous maintenez vos projections réalistes même quand on vous demande de les revoir. Vous corrigez immédiatement une erreur signalée. Vous mentionnez explicitement les changements de méthode. Vous contextualisez les bons résultats liés à des facteurs externes. Vous présentez clairement les données manquantes. Cette honnêteté systématique dans les reportings — qui suppose d'accepter de donner des nouvelles décevantes — est ce qui permet à l'organisation de prendre des décisions basées sur la réalité." },
        },
      },
      {
        type: "choix",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vos engagements sont pris sans rigueur et les manquements sont minimisés plutôt qu'assumés", desc: "Promettre plus que ce qu'on peut livrer, ne pas signaler rapidement un retard anticipé, minimiser sa responsabilité quand un engagement n'est pas tenu, n'appliquer la fiabilité qu'avec les interlocuteurs importants : ces comportements érodent progressivement la confiance qu'on vous accorde." },
          moyen: { label: "Pratiques en développement", titre: "Vous respectez vos engagements importants mais la rigueur sur les petits engagements et la renégociation formelle sont encore perfectibles", desc: "Vous signalez les retards anticipés et vous notez vos engagements. Mais appliquer la même fiabilité avec tous les interlocuteurs, renégocier formellement quand les circonstances changent plutôt qu'ignorer l'engagement, assumer pleinement votre responsabilité quand un engagement n'est pas tenu sans chercher d'atténuation : votre rigueur est encore perfectible." },
          haut: { label: "Réflexes installés", titre: "Vos engagements sont pris avec rigueur et les manquements sont assumés pleinement et rapidement", desc: "Vous signalez immédiatement dès que vous réalisez qu'un engagement ne peut pas être tenu. Vous n'engagez que ce que vous pouvez livrer. Vous notez vos engagements verbaux. Vous renégociez formellement quand les circonstances changent. Vous assumez pleinement votre responsabilité sans minimiser. Vous appliquez la même fiabilité avec tous vos interlocuteurs. Cette rigueur sur les engagements — qui suppose d'accepter d'être parfois décevant pour rester honnête — est ce qui construit une réputation de fiabilité." },
        },
      },
      {
        type: "likert",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Les mauvaises nouvelles sont retardées, minimisées ou absentes de vos communications", desc: "Préparer une présentation qui minimise les écarts, reporter l'annonce des mauvaises nouvelles, ne mentionner que les facteurs externes quand les objectifs sont manqués, attendre qu'on pose la question directement : ces comportements privent l'organisation des informations dont elle a besoin pour corriger." },
          moyen: { label: "Pratiques en développement", titre: "Vous annoncez les mauvaises nouvelles dans les situations ordinaires mais les cultures pénalisantes et les responsabilités personnelles créent encore des hésitations", desc: "Vous annoncez les mauvaises nouvelles honnêtement dans les situations ordinaires. Mais annoncer dès juillet que les objectifs de fin d'année ne seront pas atteints, mentionner vos propres erreurs managériales dans l'analyse, maintenir l'honnêteté dans une culture organisationnelle qui pénalise les mauvaises nouvelles : ces situations plus difficiles créent encore des hésitations." },
          haut: { label: "Réflexes installés", titre: "Vous annoncez les mauvaises nouvelles tôt, honnêtement et en incluant votre propre responsabilité", desc: "Vous présentez les mauvaises nouvelles dès que vous les connaissez. Vous incluez vos propres erreurs managériales dans l'analyse. Vous reconnaissez clairement les erreurs qui pénalisent les clients. Vous annoncez dès juillet que les objectifs de fin d'année ne seront pas atteints. Vous maintenez l'honnêteté même dans une culture qui pénalise les mauvaises nouvelles. Vous créez un environnement où votre équipe ose vous annoncer les mauvaises nouvelles tôt. Cette capacité à annoncer et recevoir les mauvaises nouvelles — qui suppose de traiter l'honnêteté comme une valeur plus importante que l'image — est ce qui permet de corriger avant qu'il soit trop tard." },
        },
      },
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "La culture d'intégrité de votre équipe n'est pas portée explicitement", desc: "Laisser les reportings optimistes de l'équipe sans les challenger, ne pas valoriser l'honnêteté des reportings courageux, transmettre les reportings sans les challenger, se comporter différemment de ses propres standards : ces comportements signalent implicitement que l'honnêteté n'est pas attendue." },
          moyen: { label: "Pratiques en développement", titre: "Vous portez des standards d'honnêteté mais votre propre exemplarité et la protection de l'équipe face aux pressions sont encore insuffisantes", desc: "Vous challengez les reportings optimistes et vous valorisez l'honnêteté courageuse. Mais aligner votre propre reporting sur les standards que vous demandez à votre équipe, protéger votre équipe de la pression externe à embellir et la remonter, intégrer la fiabilité dans l'évaluation formelle : votre exemplarité et votre protection de l'équipe sont encore insuffisantes." },
          haut: { label: "Réflexes installés", titre: "Vous construisez activement une culture d'intégrité — standards explicites, exemplarité, protection de l'équipe", desc: "Vous challengez et alignez votre propre reporting sur vos standards. Vous valorisez explicitement l'honnêteté courageuse. Vous intégrez la fiabilité dans l'évaluation. Vous protégez votre équipe de la pression à embellir et vous remontez cette pression. Vous challengez les reportings trop optimistes avant de les transmettre. Vous rectifiez la communication même quand c'est douloureux après deux ans de reportings optimistes. Cette culture d'intégrité construite activement — qui commence par son propre exemplarité et protège ceux qui sont honnêtes — est ce qui fait qu'une organisation peut se fier à ce qu'elle se dit sur elle-même." },
        },
      },
      {
        type: "likert",
