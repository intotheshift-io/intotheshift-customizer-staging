    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Dans les situations complexes, vous attendez encore la certitude pour agir.", resume: "Dans les situations complexes, vous attendez la certitude ou l'urgence avant de déclarer.", desc: "Dans les situations complexes, votre réflexe pourrait encore être d'attendre — attendre d'être certain·e que le conflit est réel, attendre que la situation devienne urgente, attendre que quelqu'un d'autre soulève le problème. Ces comportements font que des situations qui auraient pu être gérées tôt et simplement ne le sont pas, au risque que la situation évolue défavorablement." },
          moyen: { label: "Pratiques en développement", titre: "Vous déclarez dans les situations ordinaires — la pression du temps et la hiérarchie créent encore des failles.", resume: "Vous déclarez dans les situations ordinaires — la pression du temps et la pression hiérarchique créent encore des failles.", desc: "Vous déclarez dans les situations ordinaires. Ce qui pourrait encore créer des failles, c'est la pression du temps — la décision urgente qui n'attend pas la déclaration formelle — et la pression hiérarchique — la situation où votre supérieur semble attendre que vous traitiez le sujet vous-même. Ces pressions sont précisément celles que la rigueur de déclaration doit traverser." },
          haut: { label: "Réflexes installés", titre: "Vous déclarez même sous pression — y compris rétroactivement quand c'est nécessaire.", resume: "Vous déclarez dans toutes les situations — urgences, pressions hiérarchiques, situations passées découvertes après coup.", desc: "Vous déclarez même sous pression de temps et même quand la hiérarchie semble attendre une décision rapide. Vous déclarez rétroactivement quand vous découvrez après coup une situation qui aurait dû l'être. Cette rigueur sans exception — qui suppose d'accepter parfois de ralentir une décision pour permettre la déclaration — est ce qui maintient l'intégrité des processus dans toutes les situations." },
        },
      },
      {
        type: "likert",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vous ne savez pas encore comment et à qui signaler selon les situations.", resume: "Vous ne connaissez pas les voies et les formes de signalement adaptées à chaque situation.", desc: "Votre connaissance des voies de signalement disponibles pourrait encore être insuffisante — ne pas savoir à qui s'adresser selon la nature de la situation, ne pas connaître les dispositifs formels disponibles dans votre organisation. Cette méconnaissance fait que même une intention de signaler ne se traduit pas nécessairement en signalement efficace." },
          moyen: { label: "Pratiques en développement", titre: "Vous connaissez les voies principales — documentation, traçabilité et suivi sont encore perfectibles.", resume: "Vous connaissez les voies principales — documentation, traçabilité et suivi post-signalement sont encore perfectibles.", desc: "Vous connaissez les principales voies de signalement. Ce qui pourrait encore être perfectible, c'est la documentation — conserver une trace de ce que vous avez observé et de quand — la traçabilité du signalement lui-même — s'assurer qu'il y a une trace de votre démarche — et le suivi post-signalement — savoir comment vérifier que votre signalement a été pris en charge." },
          haut: { label: "Réflexes installés", titre: "Votre signalement est complet — documenté, tracé, bien ciblé et suivi.", resume: "Votre signalement est documenté, tracé, adressé au bon canal et suivi.", desc: "Vous documentez ce que vous observez avant de signaler. Vous adressez le signalement au canal le plus adapté à la nature de la situation. Vous conservez une trace de votre démarche. Vous effectuez un suivi pour vous assurer que le signalement a été pris en charge. Cette rigueur dans la forme du signalement — qui suppose d'avoir travaillé sur les voies disponibles hors urgence — est ce qui fait que le signalement atteint son objectif." },
        },
      },
      {
        type: "choix",
    ...
    0: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Face aux dilemmes éthiques, vous tranchez seul·e ou évitez — sans développer le jugement de l'équipe.", resume: "Votre posture face aux dilemmes de votre équipe est soit de trancher seul soit d'éviter le sujet.", desc: "Votre gestion des dilemmes éthiques dans votre équipe pourrait encore osciller entre deux postures — trancher vous-même sans créer d'espace de réflexion, ou éviter le sujet parce qu'il est inconfortable. Ces deux postures ont le même effet : elles ne développent pas la capacité de jugement éthique de votre équipe, qui reste dépendante de vous ou de l'absence de conflit apparent." },
          moyen: { label: "Pratiques en développement", titre: "Vous abordez les dilemmes avec votre équipe — mais sans encore développer son autonomie de jugement.", resume: "Vous abordez les dilemmes éthiques avec votre équipe — vous n'avez pas encore développé leur autonomie de jugement.", desc: "Vous abordez les dilemmes éthiques avec votre équipe. Ce qui pourrait encore manquer, c'est le développement de l'autonomie de jugement — créer les occasions où votre équipe analyse et délibère elle-même, plutôt que d'attendre votre position avant de se former une opinion. Cette autonomie de jugement est ce qui fait qu'une équipe se comporte de façon éthique indépendamment de votre présence." },
          haut: { label: "Réflexes installés", titre: "Vous développez le jugement éthique de votre équipe — vous ne le substituez pas.", resume: "Vous développez le jugement éthique de votre équipe plutôt que de gérer les dilemmes à leur place.", desc: "Vous créez des occasions où votre équipe analyse les dilemmes éthiques et délibère. Vous posez des questions plutôt que de donner des positions. Vous acceptez que le processus de délibération soit aussi important que la décision finale. Cette posture de développement du jugement éthique — qui suppose d'investir du temps dans la délibération collective plutôt que dans la décision rapide — est ce qui crée une équipe capable de naviguer les dilemmes éthiques de façon autonome." },
        },
      },
      {
        type: "choix",
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "La pression de résultats ou de hiérarchie redéfinit encore vos positions éthiques.", resume: "Face aux dilemmes managériaux, la pression de résultats et de hiérarchie prend souvent le dessus.", desc: "Face aux dilemmes managériaux, votre position éthique pourrait encore céder sous la pression — de résultats à atteindre, de hiérarchie qui attend une décision dans une direction particulière. Ces cédages créent un signal puissant pour votre équipe sur le caractère conditionnel des standards éthiques que vous affichez." },
          moyen: { label: "Pratiques en développement", titre: "Vous résistez aux pressions ordinaires — les pressions maximales créent encore des accommodements.", resume: "Vous résistez aux pressions ordinaires — les situations de pression maximale créent encore des accommodements.", desc: "Vous résistez aux pressions ordinaires. Ce qui pourrait encore créer des accommodements, c'est la pression maximale — l'objectif de fin de trimestre, la demande directe d'un dirigeant, la situation avec un client stratégique. Ces situations de pression maximale sont précisément celles où la résistance est la plus difficile et la plus importante." },
          haut: { label: "Réflexes installés", titre: "Vous résistez à toutes les pressions — et vous nommez les dilemmes au lieu de les absorber.", resume: "Vous résistez à toutes les pressions — résultats, hiérarchie, exception pour les meilleurs éléments.", desc: "Vous résistez à la pression des résultats, à la pression hiérarchique et aux demandes d'exception pour les meilleurs éléments. Vous nommez les dilemmes plutôt que de les absorber silencieusement. Vous remontez les situations où les standards éthiques et les attentes de résultats sont en tension. Cette résistance sans accommodation — qui suppose d'accepter parfois des tensions avec la hiérarchie — est ce qui crée la crédibilité d'une culture éthique réelle." },
        },
      },
      {
        type: "likert",
    ...
    3: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "La culture anticorruption est affichée dans votre organisation — pas encore incarnée.", resume: "La culture anticorruption de votre organisation est appliquée en surface sans être incarnée.", desc: "La culture anticorruption de votre organisation pourrait encore être appliquée en surface — les formations suivies, les déclarations signées — sans être réellement incarnée dans les décisions et comportements quotidiens. Cette application de surface crée une exposition réelle : les règles sont connues mais pas intégrées, ce qui fait que les situations difficiles se gèrent par défaut plutôt que par principe." },
          moyen: { label: "Pratiques en développement", titre: "Vous incarnez la culture anticorruption — mais votre résistance aux signaux ambigus et la protection des intègres sont encore perfectibles.", resume: "Vous incarnez la culture anticorruption — votre résistance aux signaux ambigus de la direction et votre protection des collaborateurs intègres sont encore perfectibles.", desc: "Vous incarnez la culture anticorruption dans vos comportements. Ce qui pourrait encore être perfectible, c'est la résistance aux signaux ambigus de la direction — les situations où la direction envoie implicitement le signal que les règles sont flexibles — et la protection visible des collaborateurs qui refusent des pratiques problématiques." },
          haut: { label: "Réflexes installés", titre: "Vous incarnez, défendez et construisez une culture anticorruption opérationnelle.", resume: "Vous incarnez et construisez la culture anticorruption avec cohérence — programme opérationnel, protection des intègres, signaux clairs.", desc: "Vous incarnez la culture anticorruption dans vos comportements. Vous participez activement au programme anticorruption. Vous protégez visiblement les collaborateurs qui refusent des pratiques problématiques. Vous envoyez des signaux clairs sur ce qui est et n'est pas acceptable. Cette construction active et cohérente — qui va au-delà de la conformité formelle — est ce qui crée une culture anticorruption réelle." },
        },
      },
      {
        type: "likert",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Votre analyse des dilemmes est encore partielle — biais non traités, parties prenantes incomplètes.", resume: "Votre analyse des dilemmes est partielle — parties prenantes incomplètes, biais non traités, apprentissage absent.", desc: "Votre analyse des dilemmes éthiques pourrait encore être partielle — se concentrer sur les parties prenantes directes sans considérer les parties prenantes indirectes, analyser sans questionner vos propres biais, ne pas tirer d'apprentissages des dilemmes résolus pour améliorer votre jugement futur. Ces lacunes font que votre analyse atteint une certaine profondeur sans atteindre la rigueur complète." },
    ...
    2: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Votre position éthique cède encore sous pression — hiérarchique, groupe, client.", resume: "Sous pression — hiérarchique, groupe, client — vous accommodez votre position éthique.", desc: "Votre position éthique pourrait encore céder sous pression — la hiérarchie qui attend une décision dans une direction, le groupe qui converge vers une position que vous ne partagez pas, le client stratégique dont la demande crée un dilemme. Ces cédages font que votre position éthique est conditionnelle aux circonstances plutôt qu'ancrée dans des principes." },
          moyen: { label: "Pratiques en développement", titre: "Les pressions ordinaires ne vous affectent plus — les maximales révèlent encore vos limites.", resume: "Vous résistez aux pressions ordinaires — les pressions maximales créent encore des failles.", desc: "Vous résistez aux pressions ordinaires sans accommoder votre position. Ce qui pourrait encore créer des failles, c'est la pression maximale — l'instruction directe d'un dirigeant, la demande d'un client stratégique, la pression d'un groupe unanime. Ces situations de pression maximale sont celles où la résistance est la plus difficile et la plus importante." },
          haut: { label: "Réflexes installés", titre: "Votre position éthique résiste à toutes les pressions — et vous cherchez des appuis pour la tenir.", resume: "Vous résistez à toutes les pressions — hiérarchique, groupe, client, urgence — en maintenant votre analyse.", desc: "Vous résistez à toutes les pressions — hiérarchique, de groupe, commerciale, temporelle. Vous nommez les dilemmes plutôt que de les absorber. Vous cherchez des soutiens — pairs, responsable éthique, conformité — quand la pression est forte. Cette résistance maintenue dans toutes les situations de pression — qui suppose d'avoir clarifié vos lignes non franchissables — est ce qui crée un jugement éthique réellement fiable." },
        },
      },
      {
        type: "likert",
    ...
    1: [
      {
        ...
        profiles: {
          bas: { label: "Repères à consolider", titre: "Vos engagements sont pris pour satisfaire — pas pour être tenus.", resume: "Vos engagements sont pris sans rigueur et les manquements sont minimisés plutôt qu'assumés.", desc: "Votre gestion des engagements pourrait encore manquer de rigueur à l'entrée — prendre des engagements que vous savez difficiles à tenir pour éviter une conversation difficile — et d'honnêteté à la sortie — minimiser les manquements, les attribuer à des facteurs extérieurs, les présenter comme des retards temporaires. Ces comportements dégradent progressivement la confiance dans vos engagements." },
          moyen: { label: "Pratiques en développement", titre: "Vos engagements importants sont tenus — la rigueur sur les petits engagements et la renégociation formelle sont encore perfectibles.", resume: "Vous respectez vos engagements importants — la rigueur sur les petits engagements et la renégociation formelle sont encore perfectibles.", desc: "Vous respectez vos engagements importants. Ce qui pourrait encore être perfectible, c'est la rigueur sur les petits engagements — les délais de réponse, les suivis promis — et la renégociation formelle quand un engagement ne peut pas être tenu — prévenir tôt et proposer une alternative plutôt que d'espérer que ça passe inaperçu." },
          haut: { label: "Réflexes installés", titre: "Vos engagements sont pris avec rigueur — et les manquements sont assumés complètement.", resume: "Vos engagements sont pris avec rigueur et les manquements sont assumés pleinement et rapidement.", desc: "Vous prenez des engagements que vous avez évalué comme tenables. Quand vous ne pouvez pas tenir, vous prévenez tôt, vous assumez pleinement le manquement sans le minimiser, vous proposez une voie de sortie. Cette rigueur à l'entrée et cette honnêteté à la sortie — qui supposent d'accepter des conversations difficiles plutôt que de les éviter — sont ce qui crée une réputation de fiabilité réelle." },
        },
      },
      {
        type: "likert",
